...
const contactEmail = process.env.NEXT_PUBLIC_EMAIL ?? 'hello@jennykim.design';
	...
	return (
		<>
			...
			<section className='w-full bg-neutral-50'>
				<div className='max-w-content mx-auto px-16 max-md:px-8 max-sm:px-6 pt-20 pb-12 max-md:pb-16 max-sm:pb-12'>
					...
					<div className='relative'>
						...
						/>
						<h1 className='relative font-manrope font-[800] text-[28px] md:text-[36px] lg:text-[48px] leading-[1.1] tracking-tightest text-blue-900 max-w-[800px]'>
					...
					<p className='mt-8 font-inter text-base leading-[1.6] text-blue-800 max-w-[768px]'>
						I&apos;m a product-focused frontend engineer based in NYC with 5+ years building
						performant, accessible interfaces at the intersection of design systems and complex
						data. I care about the craft of UI — the typography, the spacing, the
				...
				<div className='max-w-content mx-auto px-16 max-md:px-8 max-sm:px-6 py-24 max-md:py-16 max-sm:py-12'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
						{skillCategories.map((cat) => (
							<div key={cat.name} className='border-l-2 border-neutral-200 pl-6'>
				...
				<div className='max-w-content mx-auto px-16 max-md:px-8 max-sm:px-6 py-24 max-md:py-16 max-sm:py-12'>
					<div className='flex flex-col lg:flex-row gap-16'>
						...
						<div className='flex-1 flex flex-col gap-12'>
							{values.map((v) => (
								<div key={v.num} className='border-l-2 border-neutral-200 pl-6'>
									<span className='font-manrope font-bold text-[32px] text-neutral-200'>
										{v.num}
									</span>
									<h3 className='font-manrope font-bold text-[18px] leading-[1.2] uppercase tracking-snug text-blue-900 mt-2'>
										{v.title}
									</h3>
									<p className='font-inter text-base leading-[1.6] text-blue-900/70 mt-2'>
										{v.body}
									</p>
								</div>
							))}
			...
			<section className='w-full bg-blue-900'>
				<div className='max-w-content mx-auto px-16 max-md:px-8 max-sm:px-6 py-24 max-md:py-16 max-sm:py-12'>
					<h2 className='font-manrope font-bold text-[40px] leading-[1.2] tracking-tighter text-white'>
						Let&apos;s build something.
					</h2>
					<p className='font-inter text-base leading-[1.6] text-white/70 mt-4 max-w-[560px]'>
						Open to freelance, full-time, and collaborative projects. If you&apos;re working on
						something meaningful and need a frontend engineer who sweats the details, let&apos;s
						talk.
					</p>
					<div className='flex flex-col sm:flex-row gap-4 mt-8'>
						<a
							href={`mailto:${contactEmail}`}
							className='bg-blue-500 text-white font-inter font-bold text-sm px-6 py-3 text-center transition-opacity duration-200 hover:opacity-90'
						>
							Send an email
						</a>
						<a
							href='/resume'
							className='text-white underline font-inter font-bold text-sm px-6 py-3 text-center transition-opacity duration-200 hover:opacity-80'
						>
							View resume →
						</a>
					</div>
