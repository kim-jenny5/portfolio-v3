const e = {
	...
	'activity.event.archive':
		'archived the <strong>{{releaseTitle}}</strong> release',
	...
	'activity.event.edit':
		'set release time to <ScheduleTarget></ScheduleTarget>',
	'activity.event.edit-time-asap': 'immediately',
	'activity.event.edit-time-undecided': 'never',
	'activity.event.publish':
		'published the <strong>{{releaseTitle}}</strong> release',
	'activity.event.schedule': 'marked as scheduled',
	'activity.event.unarchive':
		'unarchived the <strong>{{releaseTitle}}</strong> release',
	...
	'archive-dialog.confirm-archive-description_one':
		'This will archive 1 document version.',
	...
	'delete-dialog.confirm-delete-description_one':
		'This will delete 1 document version.',
	'delete-dialog.confirm-delete-description_other':
		'This will delete {{count}} document versions.',
	...
	'permissions.error.discard-version':
		'You do not have permission to discard this version',
	...
	'permissions.error.archive':
		'You do not have permission to archive this release',
	'permissions.error.delete':
		'You do not have permission to delete this release',
	'permissions.error.duplicate':
		'You do not have permission to duplicate this release',
	'permissions.error.unarchive':
		'You do not have permission to unarchive this release',
	'presence.tooltip.one':
		'{{displayName}} is editing this document in the "{{releaseTitle}}" release right now',
	'presence.tooltip.other':
	...
	'publish-dialog.validation.no-permission':
	...
	'revert-dialog.confirm-revert.title':
		"Are you sure you want to revert the '{{title}}' release?",
	'revert-dialog.confirm-revert.stage-revert-checkbox-label':
		'Immediately revert the release',
	...
	'revert-release.description':
		'Revert changes to document versions in "{{title}}".',
	'schedule-button.tooltip': 'Are you sure you want to unschedule the release?',
	'schedule-action.validation.no-documents':
		'There are no documents to schedule',
	'schedule-button-tooltip.validation.no-permission':
	...
	'schedule-button-tooltip.already-scheduled':
		'This release is already scheduled',
	...
	'unschedule-dialog.confirm-title':
		'Are you sure you want to unschedule the release?',
	...
	'schedule-unpublish-dialog.description':
		'Select when this document should be unpublished.',
	...
	'summary.validating-documents':
		'Validating documents: {{validatedCount}} of {{totalCount}}',
	'summary.validated-documents':
		'{{validatedCount}} of {{totalCount}} documents validated',
	'summary.all-documents-validated':
		'All documents validated, no conflicts found',
	'summary.all-documents-errors-found':
		'All documents validated, conflicts found',
	...
	'toast.archive.error':
		"Failed to archive '<strong>{{title}}</strong>': {{error}}",
	'toast.create-version.error': 'Failed to add document to release: {{error}}',
	'toast.delete.error':
		"Failed to delete '<strong>{{title}}</strong>': {{error}}",
	'toast.delete.success':
		"The '<strong>{{title}}</strong>' release was successfully deleted",
	'toast.duplicate.error':
		"Failed to duplicate '<strong>{{title}}</strong>': {{error}}",
	'toast.duplicate.success':
		"The '<strong>{{title}}</strong>' release was duplicated. <Link/>",
	'toast.duplicate.success-link': 'View duplicated release',
	'toast.publish.error':
		"Failed to publish '<strong>{{title}}</strong>': {{error}}",
	'toast.schedule.error':
		"Failed to schedule '<strong>{{title}}</strong>': {{error}}",
	'toast.schedule.success':
		"The '<strong>{{title}}</strong>' release was scheduled.",
	'toast.unschedule.error':
		"Failed to unscheduled '<strong>{{title}}</strong>': {{error}}",
	'toast.unarchive.error':
		"Failed to unarchive '<strong>{{title}}</strong>': {{error}}",
	'type-picker.tooltip.scheduled':
		'The release is scheduled, unschedule it to change type',
	'toast.revert.error': 'Failed to revert release: {{error}}',
	'toast.immediate-revert.success':
		"The '{{title}}' release was successfully reverted",
	'toast.revert-stage.success':
		"Revert release for '{{title}}' was successfully created. <Link/>",
	'toast.revert-stage.success-link': 'View revert release',
	'unpublish.already-unpublished': 'This document is already unpublished.',
	'unpublish.no-published-version':
		'There is no published version of this document.',
	'unpublish-dialog.header':
		'Are you sure you want to unpublish this document when releasing?',
	...
	'toast.confirm-active-scheduled-drafts.error':
		'Failed to schedule drafts: {{error}}',
};
export { e as default };
