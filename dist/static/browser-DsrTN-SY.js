import { g as Ue } from './sanity-Bacdz4Bt.js';
function Ge(G, K) {
				...
				(function (y) {
					...
					if (
						...
						h == null &&
							le != null &&
							(h = function () {
								return new le('Microsoft.XMLHTTP');
							}),
						Object.create == null &&
					...
					pe.prototype.decode = function (e) {
						function r(d, u, i) {
							if (i === 1) return d >= 128 >> u && d << u <= 2047;
							if (i === 2)
								return (
									(d >= 2048 >> u && d << u <= 55295) ||
									(d >= 57344 >> u && d << u <= 65535)
								);
							if (i === 3) return d >= 65536 >> u && d << u <= 1114111;
							throw new Error();
						}
						function n(d, u) {
							if (d === 6) return u >> 6 > 15 ? 3 : u > 31 ? 2 : 1;
							if (d === 12) return u > 15 ? 3 : 2;
							if (d === 18) return 3;
							throw new Error();
						}
						for (
					...
					var Ne = function () {
						try {
							return (
								new Y().decode(new he().encode('test'), { stream: !0 }) ===
								'test'
							);
						} catch (e) {
							console.debug(
					...
					((j.prototype.open = function (e, r) {
						...
						this._abort = function (i) {
							(n._sendTimeout !== 0 &&
								(_(n._sendTimeout), (n._sendTimeout = 0)),
								(o === 1 || o === 2 || o === 3) &&
									((o = 4),
									(t.onload = R),
									(t.onerror = R),
						...
						(j.prototype.getResponseHeader = function (e) {
...
`),
					...
					((ge.prototype.get = function (e) {
						return this._map[ye(e)];
					}),
						h != null &&
							h.HEADERS_RECEIVED == null &&
							(h.HEADERS_RECEIVED = 2));
					function Ee() {}
					Ee.prototype.open = function (e, r, n, t, o, a, s) {
						e.open('GET', o);
						var c = 0;
					...
					function me() {}
					me.prototype.open = function (e, r, n, t, o, a, s) {
						var c = null,
							f = new te(),
							d = f.signal,
							u = new Y();
												...
												c.read()
													.then(function (C) {
														if (C.done) l(void 0);
															...
															var E = u.decode(C.value, { stream: !0 });
															(n(E), z());
														}
													})
													.catch(function (C) {
					...
					((V.prototype.dispatchEvent = function (e) {
						e.target = this;
						...
						(V.prototype.addEventListener = function (e, r) {
							e = String(e);
						...
						(V.prototype.removeEventListener = function (e, r) {
							e = String(e);
							var n = this._listeners,
								t = n[e];
							if (t != null) {
					...
					function Ce(e, r) {
						(P.call(this, e),
							(this.data = r.data),
							(this.lastEventId = r.lastEventId));
					}
					...
					var ne = -1,
						...
						be = 2,
						Ie = 3,
						He = /^text\/event\-stream(;.*)?$/i,
						Le = 1e3,
						je = 18e6,
						ie = function (e, r) {
							var n = e == null ? r : parseInt(e, 10);
							return (n !== n && (n = r), se(n));
						},
						se = function (e) {
							return Math.min(Math.max(e, Le), je);
						},
						X = function (e, r, n) {
							try {
					...
					function Me() {
						return (h != null && 'withCredentials' in h.prototype) || ce == null
							? new h()
							: new ce();
					}
					var Pe = J != null && ve != null && 'body' in ve.prototype;
					function qe(e, r, n) {
						r = String(r);
						var t = !!n.withCredentials,
							o = n.lastEventIdQueryParameterName || 'lastEventId',
							a = se(1e3),
							s = ie(n.heartbeatTimeout, 45e3),
							c = '',
							f = a,
							d = !1,
							u = 0,
							i = n.headers || {},
							l = n.Transport,
							D = Pe && l == null ? void 0 : new j(l != null ? new l() : Me()),
							z =
							...
							Be = function (p) {
								if (x === q) {
									for (var v = -1, S = 0; S < p.length; S += 1) {
										var b = p.charCodeAt(S);
										(b === 10 || b === 13) && (v = S);
									}
									var m = (v !== -1 ? ee : '') + p.slice(0, v + 1);
									((ee = (v === -1 ? ee : '') + p.slice(v + 1)),
										p !== '' && ((d = Date.now()), (u += p.length)));
									for (var g = 0; g < m.length; g += 1) {
										var b = m.charCodeAt(g);
										if (w === ae && b === 10) w = L;
										else if ((w === ae && (w = L), b === 13 || b === 10)) {
											if (w !== L) {
												w === oe && (M = g + 1);
												var O = m.slice(fe, M - 1),
													N = m.slice(
														M + (M < g && m.charCodeAt(M) === 32 ? 1 : 0),
														g,
													);
												O === 'data'
													? ((B += `
`),
							...
							Re = function (p) {
								if (x === q || x === H) {
									((x = ne),
										...
										(f = se(Math.min(a * 16, f * 2))),
										(e.readyState = H));
									var v = new Se('error', { error: p });
									(e.dispatchEvent(v),
										X(e, e.onerror, v),
							...
							Q = function () {
								if (((E = 0), x !== ne)) {
									if (!d && C != null)
										...
										var p = Math.max((d || Date.now()) + s - Date.now(), 1);
										((d = !1),
											(E = T(function () {
												Q();
											}, p)));
					...
					((A.prototype = Object.create(V.prototype)),
						(A.prototype.CONNECTING = H),
						(A.prototype.OPEN = q),
						(A.prototype.CLOSED = W),
					...
					var _e = Z;
					(h != null &&
						(Z == null || !('withCredentials' in Z.prototype)) &&
						(_e = A),
						(function (e) {
							{
								var r = e(K);
								r !== void 0 && (G.exports = r);
							}
						})(function (e) {
							((e.EventSourcePolyfill = A),
								(e.NativeEventSource = Z),
								(e.EventSource = _e));
						}));
				})(
					typeof globalThis > 'u'
...
var ue, xe;
function ze() {
	return (xe || ((xe = 1), (ue = We().EventSourcePolyfill)), ue);
}
var De = ze();
const Qe = Ue(De),
	Ke = Ge({ __proto__: null, default: Qe }, [De]);
export { Ke as b };
