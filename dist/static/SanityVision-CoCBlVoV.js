...
var pg = Object.defineProperty,
	...
	xc = (n, e, t) =>
		e in n
			? pg(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
			: (n[e] = t),
	bc = (n, e) => {
		for (var t in e || (e = {})) Og.call(e, t) && xc(n, t, e[t]);
		if (yc) for (var t of yc(e)) mg.call(e, t) && xc(n, t, e[t]);
		return n;
	};
const Sc = function (n) {
		const {
	...
	gg = function (n) {
		const {
			...
			c = [l, a, e].filter(Boolean).join(' ');
		return b.jsx('span', {
			role: 'separator',
			className: c,
			style: u,
			onMouseDown: (h) => r(h.nativeEvent),
			onTouchStart: (h) => {
				(h.preventDefault(), o(h.nativeEvent));
			},
			onTouchEnd: (h) => {
				(h.preventDefault(), s(h.nativeEvent));
			},
			onClick: (h) => {
				t && (h.preventDefault(), t(h.nativeEvent));
			},
			onDoubleClick: (h) => {
				i && (h.preventDefault(), i(h.nativeEvent));
			},
		});
	};
var yg = Object.defineProperty,
	...
	ba = (n, e, t) =>
		e in n
			? yg(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
			: (n[e] = t),
	mt = (n, e) => {
		for (var t in e || (e = {})) Sg.call(e, t) && ba(n, t, e[t]);
		if (Dc) for (var t of Dc(e)) Dg.call(e, t) && ba(n, t, e[t]);
		return n;
	},
	lo = (n, e) => xg(n, bg(e)),
	Us = (n, e, t) => ba(n, typeof e != 'symbol' ? e + '' : e, t);
const Nf = {
		display: 'flex',
		flex: 1,
		height: '100%',
	...
	wg = lo(mt({}, Nf), { flexDirection: 'row', left: 0, right: 0 }),
	vg = lo(mt({}, Nf), {
		bottom: 0,
	...
	Al = {},
	Gf = class or extends I.Component {
		constructor(e) {
			(super(e),
				Us(this, 'pane1', null),
				Us(this, 'pane2', null),
				Us(this, 'splitPane', null),
		...
		componentDidMount() {
			(document.addEventListener('mouseup', this.onMouseUp),
				...
				this.setState(or.getSizeUpdate(this.props, this.state)));
		}
		static getDerivedStateFromProps(e, t) {
			return or.getSizeUpdate(e, t);
		}
		...
		onTouchStart(e) {
			...
			if (t) {
				wc(document, window);
				const s =
					r === 'vertical' ? e.touches[0].clientX : e.touches[0].clientY;
				(typeof i == 'function' && i(),
					this.setState({ active: !0, position: s }));
			}
		}
		onMouseMove(e) {
		...
		onTouchMove(e) {
			...
			const { position: t = 0 } = this.state,
				{
					maxSize: i,
					minSize: r = or.defaultProps.minSize,
					onChange: s,
					split: o = or.defaultProps.split,
					step: l,
				} = this.props;
			wc(document, window);
			const a = this.props.primary === 'first',
				u = a ? this.pane1 : this.pane2,
				c = a ? this.pane2 : this.pane1;
			if (!u || !c || !u.getBoundingClientRect) return;
			const h = u,
				f = c,
				d = h.getBoundingClientRect().width,
				p = h.getBoundingClientRect().height,
			...
			let S = a ? g : -g;
			const w = parseInt(window.getComputedStyle(h).order),
			...
			(r && C < r
				...
				: x !== void 0 && C > x
					? (C = x)
					: this.setState({ position: E, resized: !0 }),
				s && s(C));
			const B = a
				? { pane1Size: C, pane2Size: void 0 }
				: { pane2Size: C, pane1Size: void 0 };
			this.setState(mt({ draggedSize: C }, B));
		}
		onMouseUp() {
			if (!this.state.active || !this.props.allowResize) return;
			const { onDragFinished: e } = this.props,
				{ draggedSize: t } = this.state;
			(typeof t < 'u' && typeof e == 'function' && e(t),
		...
		static getSizeUpdate(e, t) {
			...
			const r =
					e.size !== void 0
						? e.size
						: vc(e.defaultSize, e.minSize, e.maxSize, t.draggedSize),
				s =
					e.primary === 'first'
						? { pane1Size: r, pane2Size: void 0 }
						: { pane2Size: r, pane1Size: void 0 };
			return lo(mt(mt({}, s), typeof e.size > 'u' ? {} : { draggedSize: r }), {
		...
		render() {
			const {
				...
				x = p === 'vertical' ? wg : vg,
				C = O ? mt(mt({}, x), O) : x,
				E = ['SplitPane', i, p, S].filter(Boolean).join(' '),
				B = Qc(mt(mt({}, u), c), Al),
				v = Qc(mt(mt({}, u), h), Al),
				D = ['Pane1', o, l].join(' '),
				P = ['Pane2', o, a].join(' ');
...
function Qg(n) {
	return I.Children.toArray(n).filter((e) => e);
}
function Cg(n) {
...
(() => {
	...
	for (let e = 0, t = 0; e < n.length; e++)
		(e % 2 ? Uf : Sa).push((t = t + n[e]));
})();
function kg(n) {
	if (n < 768) return !1;
	for (let e = 0, t = Sa.length; ; ) {
		let i = (e + t) >> 1;
		if (n < Sa[i]) t = i;
		else if (n >= Uf[i]) e = i + 1;
		else return !0;
		if (e == t) return !1;
	}
}
...
const kc = 8205;
function Ag(n, e, t = !0, i = !0) {
	return (t ? Hf : Pg)(n, e, i);
}
function Hf(n, e, t) {
	if (e == n.length) return e;
	e && Kf(n.charCodeAt(e)) && Jf(n.charCodeAt(e - 1)) && e--;
	let i = $l(n, e);
	for (e += Ac(i); e < n.length; ) {
		let r = $l(n, e);
		if (i == kc || r == kc || (t && kg(r))) ((e += Ac(r)), (i = r));
		else if (Cc(r)) {
			let s = 0,
				o = e - 2;
			for (; o >= 0 && Cc($l(n, o)); ) (s++, (o -= 2));
			if (s % 2 == 0) break;
			e += 2;
		} else break;
	}
...
function $l(n, e) {
	...
	if (!Jf(t) || e + 1 == n.length) return t;
	let i = n.charCodeAt(e + 1);
	return Kf(i) ? ((t - 55296) << 10) + (i - 56320) + 65536 : t;
}
function Kf(n) {
...
class Oe {
	...
	replace(e, t, i) {
		...
		return (
			...
			Lt.from(r, this.length - (t - e) + i.length)
		);
	}
	append(e) {
...
class Ee extends Oe {
	...
	lineInner(e, t, i, r) {
		for (let s = 0; ; s++) {
			let o = this.text[s],
				l = r + o.length;
			if ((t ? i : l) >= e) return new Eg(r, l, i, o);
			((r = l + 1), i++);
		}
	}
	decompose(e, t, i, r) {
		...
		if (r & 1) {
			let o = i.pop(),
				l = Hs(s.text, o.text.slice(), 0, s.length);
	...
	replace(e, t, i) {
		...
		[e, t] = Bn(this, e, t);
		let r = Hs(this.text, Hs(i.text, Pc(this.text, 0, e)), t),
			s = this.length + i.length - (t - e);
		return r.length <= 32 ? new Ee(r, s) : Lt.from(Ee.split(r, []), s);
	}
	sliceString(
		e,
		t = this.length,
...
class Lt extends Oe {
	...
	replace(e, t, i) {
		if ((([e, t] = Bn(this, e, t)), i.lines < this.lines))
			for (let r = 0, s = 0; r < this.children.length; r++) {
				...
				if (e >= s && t <= l) {
					...
					if (a.lines < u >> 4 && a.lines > u >> 6) {
						...
						return ((c[r] = a), new Lt(c, this.length - (t - e) + i.length));
					}
...
`,
	...
	static from(e, t = e.reduce((i, r) => i + r.length + 1, -1)) {
		...
		function h(d) {
			let p;
			if (d.lines > s && d instanceof Lt) for (let O of d.children) h(O);
			else
				d.lines > o && (a > o || !a)
					? (f(), l.push(d))
					: d instanceof Ee &&
						  a &&
						  (p = c[c.length - 1]) instanceof Ee &&
						  d.lines + p.lines <= 32
						? ((a += d.lines),
							(u += d.length + 1),
							(c[c.length - 1] = new Ee(
		...
		function f() {
			a != 0 &&
				(l.push(c.length == 1 ? c[0] : Lt.from(c, u)),
				(u = -1),
				(a = c.length = 0));
		}
		for (let d of e) h(d);
		return (f(), l.length == 1 ? l[0] : new Lt(l, t));
	}
}
Oe.empty = new Ee([''], 0);
function $g(n) {
...
class fr {
	constructor(e, t = 1) {
		((this.dir = t),
			...
			(this.nodes = [e]),
			(this.offsets = [
				t > 0 ? 1 : (e instanceof Ee ? e.text.length : e.children.length) << 1,
			]));
	}
	nextInner(e, t) {
				...
				e > a.length
					...
					: (t < 0 && this.offsets[i]--,
						...
						this.offsets.push(
							t > 0
								? 1
								: (a instanceof Ee ? a.text.length : a.children.length) << 1,
						));
			}
		}
	}
...
typeof Symbol < 'u' &&
	...
	(fr.prototype[Symbol.iterator] =
		ed.prototype[Symbol.iterator] =
...
class Yt {
	...
	composeDesc(e) {
		return this.empty ? e : e.empty ? this : id(this, e);
	}
	mapDesc(e, t = !1) {
		return e.empty ? this : va(this, e, t);
	}
		...
		for (let o = 0; o < this.sections.length; ) {
			...
			if (a < 0) {
				...
				if (
					i != He.Simple &&
					u >= e &&
					((i == He.TrackDel && r < e && u > e) ||
						(i == He.TrackBefore && r < e) ||
						(i == He.TrackAfter && u > e))
				)
					return null;
				if (u > e || (u == e && t < 0 && !l))
...
class Re extends Yt {
	...
	apply(e) {
		...
		return (
			wa(this, (t, i, r, s, o) => (e = e.replace(r, r + (i - t), o)), !1),
			e
		);
	}
	mapDesc(e, t = !1) {
	...
	invert(e) {
		...
		for (let r = 0, s = 0; r < t.length; r += 2) {
			...
			if (l >= 0) {
				...
				i.push(o ? e.slice(s, s + o) : Oe.empty);
			}
			s += o;
		}
		return new Re(t, i);
	...
	compose(e) {
		return this.empty ? e : e.empty ? this : id(this, e, !0);
	}
	map(e, t = !1) {
		return e.empty ? this : va(this, e, t, !0);
	}
	iterChanges(e, t = !1) {
		wa(this, e, t);
	}
	...
	filter(e) {
		...
		e: for (let o = 0, l = 0; ; ) {
			...
			for (; l < a || (l == a && s.len == 0); ) {
				...
				(Ie(t, c, h), h > 0 && bi(i, t, s.text), s.forward(c), (l += c));
			}
			let u = e[o++];
			for (; l < u; ) {
				if (s.done) break e;
				...
				(Ie(t, c, -1),
					Ie(r, c, s.ins == -1 ? -1 : s.off == 0 ? s.ins : 0),
					s.forward(c),
					(l += c));
			}
		}
		return { changes: new Re(t, i), filtered: Yt.create(r) };
	}
	toJSON() {
		let e = [];
		for (let t = 0; t < this.sections.length; t += 2) {
	...
	static of(e, t, i) {
		...
		function u(c) {
			if (Array.isArray(c)) for (let h of c) u(h);
				...
				if (h > f || h < 0 || f > t)
					throw new RangeError(
						`Invalid change range ${h} to ${f} (in doc of length ${t})`,
					);
				let p = d
						? typeof d == 'string'
							? Oe.of(d.split(i || Da))
		...
		for (let r = 0; r < e.length; r++) {
			...
			if (typeof s == 'number') t.push(s, -1);
				...
				if (s.length == 1) t.push(s[0], 0);
					...
					for (; i.length < r; ) i.push(Oe.empty);
					((i[r] = Oe.of(s.slice(1))), t.push(s[0], i[r].length));
				}
			}
		}
		return new Re(t, i);
...
function va(n, e, t, i = !1) {
	...
	for (let a = -1; ; ) {
		...
		if (o.ins == -1 && l.ins == -1) {
			...
			(Ie(r, u, -1), o.forward(u), l.forward(u));
		} else if (
			l.ins >= 0 &&
			(o.ins < 0 ||
				a == o.i ||
			...
			for (Ie(r, l.ins, -1); u; ) {
				...
				(o.ins >= 0 &&
					a < o.i &&
					o.len <= c &&
					(Ie(r, 0, o.ins), s && bi(s, r, o.text), (a = o.i)),
					o.forward(c),
					(u -= c));
			}
			l.next();
			...
			(Ie(r, u, a < o.i ? o.ins : 0),
				s && a < o.i && bi(s, r, o.text),
				(a = o.i),
				o.forward(o.len - c));
		} else {
			if (o.done && l.done) return s ? Re.createSet(r, s) : Yt.create(r);
			throw new Error('Mismatched change set lengths');
		}
	}
}
function id(n, e, t = !1) {
	let i = [],
		...
		o = new wr(e);
	for (let l = !1; ; ) {
		if (s.done && o.done) return r ? Re.createSet(i, r) : Yt.create(i);
		if (s.ins == 0) (Ie(i, s.len, 0, l), s.next());
		else if (o.len == 0 && !o.done)
			(Ie(i, 0, o.ins, l), r && bi(r, i, o.text), o.next());
		else {
			if (s.done || o.done) throw new Error('Mismatched change set lengths');
			{
				...
				if (s.ins == -1) {
					...
					(Ie(i, a, c, l), r && c && bi(r, i, o.text));
				} else
					o.ins == -1
						? (Ie(i, s.off ? 0 : s.len, a, l), r && bi(r, i, s.textBit(a)))
						: (Ie(i, s.off ? 0 : s.len, o.off ? 0 : o.ins, l),
							r && !o.off && bi(r, i, o.text));
...
class zi {
	...
	map(e, t = -1) {
		...
		return (
			...
			i == this.from && r == this.to ? this : new zi(i, r, this.flags)
		);
	}
	extend(e, t = e, i = 0) {
		if (e <= this.anchor && t >= this.anchor)
			return T.range(e, t, void 0, void 0, i);
	...
	static normalized(e, t = 0) {
		...
		for (let r = 1; r < e.length; r++) {
			...
			if (s.empty ? s.from <= o.to : s.from < o.to) {
				...
				(r <= t && t--,
					e.splice(--r, 2, s.anchor > s.head ? T.range(a, l) : T.range(l, a)));
			}
		}
		return new T(e, t);
	}
...
class L {
	...
	static define(e = {}) {
		return new L(
			...
			e.compare || (e.combine ? (t, i) => t === i : Cu),
			!!e.static,
			e.enables,
		);
	}
	...
	dynamicSlot(e) {
		...
		for (let h of this.dependencies)
			h == 'doc'
				...
				: h == 'selection'
					? (u = !0)
					: (((t = e[h.id]) !== null && t !== void 0 ? t : 1) & 1) == 0 &&
						c.push(e[h.id]);
		return {
			create(h) {
			...
			update(h, f) {
				if (
					(a && f.docChanged) ||
					(u && (f.docChanged || f.selection)) ||
					Qa(h, c)
				) {
					let d = i(h);
					if (l ? !$c(d, h.values[o], r) : !r(d, h.values[o]))
					...
					if (
						this.dependencies.every((m) =>
							m instanceof L
								? f.facet(m) === h.facet(m)
								: m instanceof Ve
									? f.field(m, !1) == h.field(m, !1)
									: !0,
						) ||
						(l ? $c((d = i(h)), O, r) : r((d = i(h)), O))
					)
...
function Mg(n, e, t) {
	...
	function l(a) {
		...
		for (let c = 0; c < i.length; c++) {
			let h = uo(a, i[c]);
			if (r[c] == 2) for (let f of h) u.push(f);
			else u.push(h);
		}
		return e.combine(u);
	}
	return {
		...
		reconfigure(a, u) {
			let c = Qa(a, i),
				h = u.config.facets[e.id],
				f = u.facet(e);
			if (h && !c && Cu(t, h)) return ((a.values[o] = f), 0);
			let d = l(a);
			return e.compare(d, f) ? ((a.values[o] = f), 0) : ((a.values[o] = d), 1);
		},
	};
}
const Qs = L.define({ static: !0 });
class Ve {
	constructor(e, t, i, r, s) {
		((this.id = e),
			(this.createF = t),
	...
	create(e) {
		let t = e.facet(Qs).find((i) => i.field == this);
	...
	init(e) {
		return [this, Qs.of({ field: this, create: e })];
	}
	get extension() {
		return this;
	}
}
const ji = { lowest: 4, low: 3, default: 2, high: 1, highest: 0 };
function tr(n) {
	return (e) => new rd(e, n);
}
const Ki = {
	highest: tr(ji.highest),
	high: tr(ji.high),
	default: tr(ji.default),
	low: tr(ji.low),
	lowest: tr(ji.lowest),
};
class rd {
...
class jo {
	...
	reconfigure(e) {
		return jo.reconfigure.of({ compartment: this, extension: e });
	}
	get(e) {
...
class ao {
	...
	static resolve(e, t, i) {
		let r = [],
			...
			o = new Map();
		for (let f of Rg(e, t, o))
			f instanceof Ve
				? r.push(f)
				: (s[f.facet.id] || (s[f.facet.id] = [])).push(f);
		...
		for (let f in s) {
			...
			if (d.every((m) => m.type == 0))
				if (((l[p.id] = (a.length << 1) | 1), Cu(O, d))) a.push(i.facet(p));
				else {
				...
				((l[p.id] = u.length << 1), u.push((m) => Mg(m, p, d)));
			}
		}
		let h = u.map((f) => f(l));
		return new ao(e, o, h, l, a, s);
	}
}
function Rg(n, e, t) {
	let i = [[], [], [], [], []],
	...
	function s(o, l) {
		...
		if (a != null) {
			if (a <= l) return;
			let u = i[a].indexOf(o);
			(u > -1 && i[a].splice(u, 1), o instanceof Ca && t.delete(o.compartment));
		}
		...
		} else if (o instanceof rd) s(o.inner, o.prec);
		else if (o instanceof Ve) (i[l].push(o), o.provides && s(o.provides, l));
		else if (o instanceof Ks)
			(i[l].push(o), o.facet.extensions && s(o.facet.extensions, ji.default));
		else {
			let u = o.extension;
			if (!u)
				throw new Error(
	...
	return (s(n, ji.default), i.reduce((o, l) => o.concat(l)));
}
function dr(n, e) {
	if (e & 1) return 2;
	let t = e >> 1,
...
const sd = L.define(),
	ka = L.define({ combine: (n) => n.some((e) => e), static: !0 }),
	od = L.define({ combine: (n) => (n.length ? n[0] : void 0), static: !0 }),
	ld = L.define(),
	ad = L.define(),
	ud = L.define(),
	cd = L.define({ combine: (n) => (n.length ? n[0] : !1) });
class Gt {
	constructor(e, t) {
...
class Be {
	constructor(e, t, i, r, s, o) {
		((this.startState = e),
			...
			(this._state = null),
			i && nd(i, t.newLength),
			s.some((l) => l.type == Be.time) ||
				(this.annotations = s.concat(Be.time.of(Date.now()))));
	}
	static create(e, t, i, r, s, o) {
		return new Be(e, t, i, r, s, o);
	}
	get newDoc() {
...
Be.time = Gt.define();
Be.userEvent = Gt.define();
Be.addToHistory = Gt.define();
Be.remote = Gt.define();
function _g(n, e) {
	let t = [];
	for (let i = 0, r = 0; ; ) {
...
function Aa(n, e, t) {
	let i = e.selection,
		r = Pn(e.annotations);
	return (
		e.userEvent && (r = r.concat(Be.userEvent.of(e.userEvent))),
		{
			changes:
				e.changes instanceof Re
					? e.changes
					: Re.of(e.changes || [], t, n.facet(od)),
...
function fd(n, e, t) {
	let i = Aa(n, e.length ? e[0] : {}, n.doc.length);
	e.length && e[0].filter === !1 && (t = !1);
	for (let s = 1; s < e.length; s++) {
		e[s].filter === !1 && (t = !1);
		let o = !!e[s].sequential;
		i = hd(i, Aa(n, e[s], o ? i.changes.newLength : n.doc.length), o);
	}
	let r = Be.create(
		n,
		i.changes,
...
function Xg(n) {
	let e = n.startState,
		t = !0;
	for (let r of e.facet(ld)) {
		let s = r(n);
		if (s === !1) {
			t = !1;
			break;
		}
		Array.isArray(s) && (t = t === !0 ? s : _g(t, s));
	}
	if (t !== !0) {
		let r, s;
		if (t === !1) ((s = n.changes.invertedDesc), (r = Re.empty(e.doc.length)));
		else {
	...
	for (let r = i.length - 1; r >= 0; r--) {
		...
		s instanceof Be
			? (n = s)
			: Array.isArray(s) && s.length == 1 && s[0] instanceof Be
				? (n = s[0])
				: (n = fd(e, Pn(s), !1));
	}
	return n;
...
function jg(n) {
	...
	for (let r = t.length - 1; r >= 0; r--) {
		...
		s &&
			...
			(i = hd(i, Aa(e, s, n.changes.newLength), !0));
	}
	return i == n
		? n
		: Be.create(
...
const Lg = [];
function Pn(n) {
	return n == null ? Lg : Array.isArray(n) ? n : [n];
}
var ve = (function (n) {
	return (
		(n[(n.Word = 0)] = 'Word'),
...
let Pa;
try {
	Pa = new RegExp('[\\p{Alphabetic}\\p{Number}_]', 'u');
} catch {}
function Wg(n) {
	if (Pa) return Pa.test(n);
	for (let e = 0; e < n.length; e++) {
		let t = n[e];
		if (
			/\w/.test(t) ||
			(t > '' && (t.toUpperCase() != t.toLowerCase() || zg.test(t)))
		)
			return !0;
	}
	return !1;
...
class fe {
	constructor(e, t, i, r, s, o) {
		((this.config = e),
			...
			(this.computeSlot = s),
			o && (o._state = this));
		for (let l = 0; l < this.config.dynamicSlots.length; l++) dr(this, l << 1);
	...
	applyTransaction(e) {
		...
		for (let l of e.effects)
			l.is(jo.reconfigure)
				? (t &&
						((r = new Map()),
						t.compartments.forEach((a, u) => r.set(u, a)),
						(t = null)),
					r.set(l.value.compartment, l.value.extension))
				: l.is(re.reconfigure)
					? ((t = null), (i = l.value))
					: l.is(re.appendConfig) && ((t = null), (i = Pn(i).concat(l.value)));
		let s;
		t
			? (s = e.startState.values.slice())
			: ((t = ao.resolve(i, r, this)),
				(s = new fe(
					t,
					this.doc,
					this.selection,
		...
		new fe(t, e.newDoc, o, s, (l, a) => a.update(l, e), e);
	}
	replaceSelection(e) {
		return (
	...
	changeByRange(e) {
		...
		for (let l = 1; l < t.ranges.length; l++) {
			let a = e(t.ranges[l]),
				...
				c = u.map(r);
			for (let f = 0; f < l; f++) s[f] = s[f].map(c);
			let h = r.mapDesc(u, !0);
			(s.push(a.range.map(h)),
				(r = r.compose(c)),
				(o = re.mapEffects(o, c).concat(re.mapEffects(Pn(a.effects), h))));
		}
	...
	changes(e = []) {
		return e instanceof Re
			? e
			: Re.of(e, this.doc.length, this.facet(fe.lineSeparator));
	}
	toText(e) {
		return Oe.of(e.split(this.facet(fe.lineSeparator) || Da));
	}
	...
	facet(e) {
		...
		return t == null ? e.default : (dr(this, t), uo(this, t));
	}
	toJSON(e) {
	...
	static create(e = {}) {
		let t = ao.resolve(e.extensions || [], new Map()),
			i =
				e.doc instanceof Oe
					? e.doc
					: Oe.of((e.doc || '').split(t.staticFacet(fe.lineSeparator) || Da)),
			r = e.selection
	...
	get lineBreak() {
		return (
			this.facet(fe.lineSeparator) ||
			`
`
		);
	}
	get readOnly() {
		return this.facet(cd);
	}
	phrase(e, ...t) {
	...
	wordAt(e) {
		...
		return o == l ? null : T.range(o + i, l + i);
	}
}
fe.allowMultipleSelections = ka;
fe.tabSize = L.define({ combine: (n) => (n.length ? n[0] : 4) });
fe.lineSeparator = od;
fe.readOnly = cd;
fe.phrases = L.define({
	compare(n, e) {
...
fe.languageData = sd;
fe.changeFilter = ld;
fe.transactionFilter = ad;
fe.transactionExtender = ud;
jo.reconfigure = re.define();
function Ut(n, e, t = {}) {
	let i = {};
	for (let r of n)
...
class wi {
	...
	range(e, t = e) {
		return $a.create(e, t, this);
	}
}
wi.prototype.startSide = wi.prototype.endSide = 0;
wi.prototype.point = !1;
wi.prototype.mapMode = He.TrackDel;
function ku(n, e) {
...
class Au {
	...
	findIndex(e, t, i, r = 0) {
		...
		for (let o = r, l = s.length; ; ) {
			...
			let a = (o + l) >> 1,
				u =
					s[a] - e || (i ? this.value[a].endSide : this.value[a].startSide) - t;
	...
	map(e, t) {
		...
		for (let a = 0; a < this.value.length; a++) {
			...
			if (c == h) {
				...
				if (
					p == null ||
					((f = d = p),
					u.startSide != u.endSide && ((d = t.mapPos(c, u.endSide)), d < f))
				)
					continue;
			} else if (
				((f = t.mapPos(c, u.startSide)),
				(d = t.mapPos(h, u.endSide)),
		...
		return { mapped: i.length ? new Au(r, s, i, l) : null, pos: o };
	}
}
class ce {
	constructor(e, t, i, r) {
	...
	update(e) {
		...
		if ((i && (t = t.slice().sort(Ea)), this.isEmpty))
			return t.length ? ce.of(t) : this;
		let l = new pd(this, null, -1).goto(0),
			a = 0,
			u = [],
			c = new hi();
				...
				c.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex])
					...
					: ((!o || r > l.to || s < l.from || o(l.from, l.to, l.value)) &&
							(c.addInner(l.from, l.to, l.value) ||
								u.push($a.create(l.from, l.to, l.value))),
						l.next());
	...
	iter(e = 0) {
		return vr.from([this]).goto(e);
	}
	get isEmpty() {
		return this.nextLayer == this;
	}
	static iter(e, t = 0) {
		return vr.from(e).goto(t);
	}
	static compare(e, t, i, r, s = -1) {
		let o = e.filter((h) => h.maxPoint > 0 || (!h.isEmpty && h.maxPoint >= s)),
			l = t.filter((h) => h.maxPoint > 0 || (!h.isEmpty && h.maxPoint >= s)),
			a = Ec(o, l, i),
			u = new ir(o, a, s),
			c = new ir(l, a, s);
		(i.iterGaps((h, f, d) => Tc(u, h, c, f, d, r)),
			i.empty && i.length == 0 && Tc(u, 0, c, 0, 0, r));
	}
	static eq(e, t, i = 0, r) {
		r == null && (r = 999999999);
		...
		let l = Ec(s, o),
			a = new ir(s, l, 0).goto(i),
			u = new ir(o, l, 0).goto(i);
		for (;;) {
			if (
				a.to != u.to ||
				!Ta(a.active, u.active) ||
				(a.point && (!u.point || !ku(a.point, u.point)))
			)
				return !1;
			if (a.to > r) return !0;
			(a.next(), u.next());
					...
					h =
						o.pointFrom < t
							...
							: o.point.startSide < 0
								? c.length
								: Math.min(c.length, a);
				(r.point(l, u, o.point, c, h, o.pointRank),
	...
	static of(e, t = !1) {
		let i = new hi();
		for (let r of e instanceof $a ? [e] : t ? qg(e) : e)
			i.add(r.from, r.to, r.value);
		return i.finish();
	}
	static join(e) {
		if (!e.length) return ce.empty;
		let t = e[e.length - 1];
...
function qg(n) {
	if (n.length > 1)
		for (let e = n[0], t = 1; t < n.length; t++) {
			let i = n[t];
			if (Ea(e, i) > 0) return n.slice().sort(Ea);
			e = i;
		}
	return n;
}
...
class hi {
	finishChunk(e) {
		(this.chunks.push(new Au(this.from, this.to, this.value, this.maxPoint)),
	...
	add(e, t, i) {
		this.addInner(e, t, i) ||
			(this.nextLayer || (this.nextLayer = new hi())).add(e, t, i);
	}
	addInner(e, t, i) {
...
class vr {
	...
	static from(e, t = null, i = -1) {
		...
		for (let s = 0; s < e.length; s++)
			for (let o = e[s]; !o.isEmpty; o = o.nextLayer)
				o.maxPoint >= i && r.push(new pd(o, t, i, s));
		return r.length == 1 ? r[0] : new vr(r);
	}
	get startSide() {
		return this.value ? this.value.startSide : 0;
	}
	goto(e, t = -1e9) {
		...
		for (let i = this.heap.length >> 1; i >= 0; i--) El(this.heap, i);
...
class ir {
	...
	removeActive(e) {
		(Cs(this.active, e),
			Cs(this.activeTo, e),
			Cs(this.activeRank, e),
			(this.minActive = Zc(this.active, this.activeTo)));
	}
	addActive(e) {
		let t = 0,
		...
		for (
			...
			t++;
		(ks(this.active, t, i),
			ks(this.activeTo, t, r),
			ks(this.activeRank, t, s),
			e && ks(e, t, this.cursor.from),
			(this.minActive = Zc(this.active, this.activeTo)));
	}
	next() {
		let e = this.to,
		...
		if (
			(n.point || t.point
				? ((n.point &&
						t.point &&
						ku(n.point, t.point) &&
						Ta(n.activeForPoint(n.to), t.activeForPoint(t.to))) ||
						s.comparePoint(l, p, n.point, t.point),
					(c = !1))
				: (c && s.boundChange(l),
					p > l &&
						!Ta(n.active, t.active) &&
						s.compareRange(l, p, n.active, t.active),
					u && p < o && (h || n.openEnd(d) != t.openEnd(d)) && (c = !0)),
			d > o)
		)
			break;
...
function Ta(n, e) {
	...
	for (let t = 0; t < n.length; t++)
		if (n[t] != e[t] && !ku(n[t], e[t])) return !1;
	return !0;
}
function Cs(n, e) {
...
function Wn(n, e, t = n.length) {
	let i = 0;
	for (let r = 0; r < t && r < n.length; )
		n.charCodeAt(r) == 9 ? ((i += e - (i % e)), r++) : (i++, (r = Xe(n, r)));
	return i;
}
function Za(n, e, t, i) {
	for (let r = 0, s = 0; ; ) {
...
const Ma = 'ͼ',
	Mc = typeof Symbol > 'u' ? '__' + Ma : Symbol.for(Ma),
	Ra =
		typeof Symbol > 'u'
			? '__styleSet' + Math.floor(Math.random() * 1e8)
			: Symbol('styleSet'),
	Rc = typeof globalThis < 'u' ? globalThis : typeof window < 'u' ? window : {};
class vi {
	constructor(e, t) {
		this.rules = [];
		let { finish: i } = t || {};
...
`);
	...
	static newName() {
		let e = Rc[Mc] || 1;
		return ((Rc[Mc] = e + 1), Ma + e.toString(36));
	}
	static mount(e, t, i) {
		let r = e[Ra],
			s = i && i.nonce;
		(r ? s && r.setNonce(s) : (r = new Vg(e, s)),
...
var Qi = {
	...
	Yg = typeof navigator < 'u' && /Mac/.test(navigator.platform),
	Ng =
		typeof navigator < 'u' &&
		/MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var Le = 0; Le < 10; Le++) Qi[48 + Le] = Qi[96 + Le] = String(Le);
for (var Le = 1; Le <= 24; Le++) Qi[Le + 111] = 'F' + Le;
for (var Le = 65; Le <= 90; Le++)
	((Qi[Le] = String.fromCharCode(Le + 32)), (Qr[Le] = String.fromCharCode(Le)));
for (var Tl in Qi) Qr.hasOwnProperty(Tl) || (Qr[Tl] = Qi[Tl]);
function Gg(n) {
	var e =
			(Yg && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey) ||
			(Ng && n.shiftKey && n.key && n.key.length == 1) ||
			n.key == 'Unidentified',
		t =
			(!e && n.key) ||
			(n.shiftKey ? Qr : Qi)[n.keyCode] ||
			n.key ||
			'Unidentified';
	return (
		t == 'Esc' && (t = 'Escape'),
...
function me() {
	...
	for (; e < arguments.length; e++) Od(n, arguments[e]);
	return n;
}
function Od(n, e) {
	if (typeof e == 'string') n.appendChild(document.createTextNode(e));
		...
		else if (Array.isArray(e)) for (var t = 0; t < e.length; t++) Od(n, e[t]);
...
let Ue =
	...
	Ba = typeof document < 'u' ? document : { documentElement: { style: {} } };
const Fa = /Edge\/(\d+)/.exec(Ue.userAgent),
	md = /MSIE \d/.test(Ue.userAgent),
	_a = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Ue.userAgent),
	Lo = !!(md || _a || Fa),
	Fc = !Lo && /gecko\/(\d+)/i.test(Ue.userAgent),
	Zl = !Lo && /Chrome\/(\d+)/.exec(Ue.userAgent),
	Ug = 'webkitFontSmoothing' in Ba.documentElement.style,
	Xa = !Lo && /Apple Computer/.test(Ue.vendor),
	_c = Xa && (/Mobile\/\w+/.test(Ue.userAgent) || Ue.maxTouchPoints > 2);
var j = {
	mac: _c || /Mac/.test(Ue.platform),
	windows: /Win/.test(Ue.platform),
	linux: /Linux|X11/.test(Ue.platform),
	ie: Lo,
	ie_version: md ? Ba.documentMode || 6 : _a ? +_a[1] : Fa ? +Fa[1] : 0,
	gecko: Fc,
	gecko_version: Fc ? +(/Firefox\/(\d+)/.exec(Ue.userAgent) || [0, 0])[1] : 0,
	chrome: !!Zl,
	chrome_version: Zl ? +Zl[1] : 0,
	ios: _c,
	android: /Android\b/.test(Ue.userAgent),
	webkit_version: Ug
		? +(/\bAppleWebKit\/(\d+)/.exec(Ue.userAgent) || [0, 0])[1]
		: 0,
	safari: Xa,
	safari_version: Xa
		? +(/\bVersion\/(\d+(\.\d+)?)/.exec(Ue.userAgent) || [0, 0])[1]
		: 0,
	tabSize:
		Ba.documentElement.style.tabSize != null ? 'tab-size' : '-moz-tab-size',
};
function Pu(n, e) {
	for (let t in n)
		t == 'class' && e.class
...
class U extends wi {
	...
	static widget(e) {
		...
		return (
			...
			new Ni(e, t, t, i, e.widget || null, !1)
		);
	}
	static replace(e) {
		let t = !!e.block,
		...
		if (e.isBlockGap) ((i = -5e8), (r = 4e8));
			...
			let { start: s, end: o } = gd(e, t);
			((i = (s ? (t ? -3e8 : -1) : 5e8) - 1),
				(r = (o ? (t ? 2e8 : 1) : -6e8) + 1));
		}
		return new Ni(e, i, r, t, e.widget || null, !0);
	}
	static line(e) {
		return new jr(e);
	}
...
class Xr extends U {
	...
	eq(e) {
		return (
			this == e ||
			(e instanceof Xr && this.tagName == e.tagName && $u(this.attrs, e.attrs))
		);
	}
	range(e, t = e) {
...
class jr extends U {
	...
	eq(e) {
		return (
			...
			$u(this.spec.attributes, e.spec.attributes)
		);
	}
	range(e, t = e) {
		if (t != e)
...
jr.prototype.mapMode = He.TrackBefore;
	...
	eq(e) {
		return (
			...
			(e instanceof Cr &&
				...
				$u(this.attributes, e.attributes))
		);
	}
	static create(e) {
		return new Cr(e.tagName, e.attributes || co);
	}
	static set(e, t = !1) {
		return ce.of(e, t);
	}
}
Cr.prototype.startSide = Cr.prototype.endSide = -1;
function kr(n) {
	let e;
	return (
...
function Or(n) {
	return n.nodeType == 3
		? Pr(n, 0, n.nodeValue.length).getClientRects()
		: n.nodeType == 1
			? n.getClientRects()
			: [];
}
function mr(n, e, t, i) {
	return t ? jc(n, e, t, i, -1) || jc(n, e, t, i, 1) : !1;
}
function Ci(n) {
	...
	for (let c = n, h = !1; c && !h; )
		if (c.nodeType == 1) {
			...
			if (d) f = e0(u);
				...
				if (
					(/^(fixed|sticky)$/.test(getComputedStyle(c).position) && (h = !0),
			...
			if (r == 'nearest')
				e.top < f.top
					? ((g = e.top - (f.top + o)),
						t > 0 && e.bottom > f.bottom + g && (g = e.bottom - f.bottom + o))
					: e.bottom > f.bottom &&
						((g = e.bottom - f.bottom + o),
						t < 0 && e.top - g < f.top && (g = e.top - (f.top + o)));
			else {
			...
			if (
				(i == 'nearest'
					? e.left < f.left
						? ((m = e.left - (f.left + s)),
							t > 0 && e.right > f.right + m && (m = e.right - f.right + s))
						: e.right > f.right &&
							((m = e.right - f.right + s),
							t < 0 && e.left < f.left + m && (m = e.left - (f.left + s)))
					: (m =
							(i == 'center'
				...
				if (d) u.scrollBy(m, g);
					...
					if (g) {
						let k = c.scrollTop;
						((c.scrollTop += g / O), (w = (c.scrollTop - k) * O));
					}
					if (m) {
						let k = c.scrollLeft;
						((c.scrollLeft += m / p), (S = (c.scrollLeft - k) * p));
					}
					((e = {
						left: e.left - S,
						top: e.top - w,
...
class i0 {
	...
	setRange(e) {
		...
		this.set(
			t,
			Math.min(e.anchorOffset, t ? fi(t) : 0),
			i,
			Math.min(e.focusOffset, i ? fi(i) : 0),
		);
	}
	set(e, t, i, r) {
		((this.anchorNode = e),
...
let Xi = null;
j.safari && j.safari_version >= 26 && (Xi = !1);
function bd(n) {
...
let Lc;
function Pr(n, e, t = e) {
	let i = Lc || (Lc = document.createRange());
...
function Dd(n, e) {
	for (let t = n, i = e; ; ) {
		...
		if (t.nodeType == 1 && i > 0) {
			...
			((t = t.childNodes[i - 1]), (i = fi(t)));
		} else if (t.parentNode && !ho(t)) ((i = Ci(t)), (t = t.parentNode));
		else return null;
	}
}
function wd(n, e) {
	for (let t = n, i = e; ; ) {
		...
		} else if (t.parentNode && !ho(t)) ((i = Ci(t) + 1), (t = t.parentNode));
		else return null;
	}
}
class Et {
	...
	static before(e, t) {
		return new Et(e.parentNode, Ci(e), t);
	}
	static after(e, t) {
		return new Et(e.parentNode, Ci(e) + 1, t);
	}
}
var ye = (function (n) {
	...
	static find(e, t, i, r) {
		...
		for (let o = 0; o < e.length; o++) {
			...
			if (l.from <= t && l.to >= t) {
				...
				(s < 0 ||
					(r != 0 ? (r < 0 ? l.from < t : l.to > t) : e[s].level > l.level)) &&
					(s = o);
			}
		}
...
function a0(n, e, t, i, r) {
	for (let s = 0; s <= i.length; s++) {
		...
		for (let u = o, c = a, h = a; u < l; u++) {
			let f = Qd(n.charCodeAt(u));
			(f == 512 ? (f = c) : f == 8 && h == 4 && (f = 16),
				(ge[u] = f == 4 ? 2 : f),
				f & 7 && (h = f),
				(c = f));
		}
		for (let u = o, c = a, h = a; u < l; u++) {
			let f = ge[u];
			if (f == 128)
				u < l - 1 && c == ge[u + 1] && c & 24 ? (f = ge[u] = c) : (ge[u] = 256);
			else if (f == 64) {
				let d = u + 1;
				for (; d < l && ge[d] == 64; ) d++;
				let p = (u && c == 8) || (d < t && ge[d] == 8) ? (h == 1 ? 1 : 8) : 256;
				for (let O = u; O < d; O++) ge[O] = p;
				u = d - 1;
			} else f == 8 && h == 1 && (ge[u] = 1);
			((c = f), f & 7 && (h = f));
		}
...
function u0(n, e, t, i, r) {
	...
	for (let o = 0, l = 0, a = 0; o <= i.length; o++) {
		...
		for (let h = u, f, d, p; h < c; h++)
			if ((d = La[(f = n.charCodeAt(h))]))
				if (d < 0) {
					for (let O = l - 3; O >= 0; O -= 3)
						if (Ft[O + 1] == -d) {
							let m = Ft[O + 2],
								g = m & 2 ? r : m & 4 ? (m & 1 ? s : r) : 0;
							(g && (ge[h] = ge[Ft[O]] = g), (l = O));
							break;
						}
				} else {
					if (Ft.length == 189) break;
					((Ft[l++] = h), (Ft[l++] = f), (Ft[l++] = a));
				}
			else if ((p = ge[h]) == 2 || p == 1) {
				let O = p == r;
				a = O ? 0 : 1;
		...
		for (let a = o; a < l; ) {
			...
			if (u == 256) {
				...
				let h = s == 1,
					f = (c < e ? ge[c] : i) == 1,
					d = h == f ? (h ? 1 : 2) : i;
				for (let p = c, O = r, m = O ? t[O - 1].to : n; p > a; )
					(p == m && ((p = t[--O].from), (m = O ? t[O - 1].to : n)),
						(ge[--p] = d));
				a = c;
			} else ((s = u), a++);
		}
...
function za(n, e, t, i, r, s, o) {
	...
	if (i % 2 == r % 2)
			...
			e: for (;;)
				if (u < s.length && p == s[u].from) {
					...
					if ((u++, f)) f.push(O);
						...
						O.from > a && o.push(new It(a, O.from, d));
						let m = (O.direction == Gi) != !(d % 2);
						(Wa(n, m ? i + 1 : i, r, O.inner, O.from, O.to, o), (a = O.to));
					}
					p = O.to;
				} else {
					if (p == t || (c ? ge[p] != l : ge[p] == l)) break;
					p++;
				}
			(f ? za(n, a, p, i + 1, r, f, o) : a < p && o.push(new It(a, p, d)),
				(a = p));
		}
	else
		for (let a = t, u = s.length; a > e; ) {
			...
			e: for (;;)
				if (u && p == s[u - 1].to) {
					...
					if (f) f.push(O);
						...
						O.to < a && o.push(new It(O.to, a, d));
						let m = (O.direction == Gi) != !(d % 2);
						(Wa(n, m ? i + 1 : i, r, O.inner, O.from, O.to, o), (a = O.from));
					}
					p = O.from;
				} else {
			...
			(f ? za(n, p, a, i + 1, r, f, o) : p < a && o.push(new It(p, a, d)),
				(a = p));
		}
}
function Wa(n, e, t, i, r, s, o) {
	let l = e % 2 ? 2 : 1;
	(a0(n, r, s, i, l),
		u0(n, r, s, i, l),
		c0(r, s, i, l),
...
function h0(n, e, t) {
	if (!n) return [new It(0, 0, e == Eu ? 1 : 0)];
	if (e == Gi && !t.length && !l0.test(n)) return kd(n.length);
	if (t.length) for (; n.length > ge.length; ) ge[ge.length] = 256;
	let i = [],
		r = e == Gi ? 0 : 1;
	return (Wa(n, r, r, t, 0, n.length, i), i);
}
function kd(n) {
	return [new It(0, n, 0)];
}
let Ad = '';
function f0(n, e, t, i, r) {
	var s;
	let o = i.head - n.from,
		l = It.find(
			e,
	...
	let c = Xe(n.text, o, a.forward(r, t));
	((c < a.from || c > a.to) && (c = u),
		(Ad = n.text.slice(Math.min(o, c), Math.max(o, c))));
	let h = l == (r ? e.length - 1 : 0) ? null : e[l + (r ? 1 : -1)];
	return h && c == u && h.level + (r ? 0 : 1) < a.level
		? T.cursor(h.side(!r, t) + n.from, h.forward(r, t) ? 1 : -1, h.level)
		: T.cursor(c + n.from, a.forward(r, t) ? -1 : 1, a.level);
}
function d0(n, e, t) {
	for (let i = e; i < t; i++) {
		let r = Qd(n.charCodeAt(i));
		if (r == 1) return Gi;
		if (r == 2 || r == 4) return Eu;
	}
	return Gi;
}
const Pd = L.define(),
	...
	Tu = L.define(),
	Zu = L.define(),
	Rd = L.define({ combine: (n) => n.some((e) => e) }),
	Bd = L.define({ combine: (n) => n.some((e) => e) }),
	Fd = L.define();
class Tn {
...
const As = re.define({ map: (n, e) => n.map(e) }),
	_d = re.define();
function rt(n, e, t) {
	let i = n.facet(Td);
	i.length
...
const oi = L.define({ combine: (n) => (n.length ? n[0] : !0) });
let p0 = 0;
const Qn = L.define({
	combine(n) {
		return n.filter((e, t) => {
	...
	constructor(e, t, i, r, s) {
		((this.id = e),
			...
			(this.extension = this.baseExtensions.concat(
				Qn.of({ plugin: this, arg: void 0 }),
			)));
	}
	of(e) {
		return this.baseExtensions.concat(Qn.of({ plugin: this, arg: e }));
	}
	static define(e, t) {
		const {
			eventHandlers: i,
...
class yt {
	...
	static extendWithRanges(e, t) {
		...
		let i = [];
		for (let r = 0, s = 0, o = 0; ; ) {
			let l = r < e.length ? e[r].fromB : 1e9,
				a = s < t.length ? t[s] : 1e9,
				u = Math.min(l, a);
			if (u == 1e9) break;
			let c = u + o,
				h = u,
			...
			for (;;)
				if (s < t.length && t[s] <= h) {
					let d = t[s + 1];
					((s += 2), (h = Math.max(h, d)));
					for (let p = r; p < e.length && e[p].fromB <= h; p++)
						o = e[p].toA - e[p].toB;
					f = Math.max(f, d + o);
...
class fo {
	constructor(e, t, i) {
		...
		let r = [];
		(this.changes.iterChangedRanges((s, o, l, a) => r.push(new yt(s, o, l, a))),
...
class Ce {
	...
	domPosFor(e, t) {
		...
		return new Et(this.parent.dom, i + (r ? 1 : 0), e == 0 || e == this.length);
	}
	markDirty(e) {
		((this.flags &= -3),
			e && (this.flags |= 4),
	...
	sync(e) {
		...
		for (let l of this.children) {
			if (
				...
				s && r != l.dom && (s.written = !0),
				l.dom.parentNode == t)
			)
				for (; r && r != l.dom; ) r = Wc(r);
	...
	blockTiles(e) {
		for (let t = [], i = this, r = 0, s = 0; ; )
			if (r == i.children.length) {
				...
				let o = i.children[r++];
				if (o instanceof ui) (t.push(r), (i = o), (r = 0));
				else {
					let l = s + o.length,
						a = e(o, s);
		...
		if (
			(this.blockTiles((l, a) => {
				...
				if (e >= a && e <= u) {
					...
					((a < e || (e == u && (t < -1 ? l.length : l.covers(1)))) &&
						(!i || (!l.isWidget() && i.isWidget())) &&
						((i = l), (r = e - a)),
						(u > e || (e == a && (t > 1 ? l.length : l.covers(-1)))) &&
							(!s || (!l.isWidget() && s.isWidget())) &&
							((s = l), (o = e - a)));
				}
			}),
			!i && !s)
...
class ui extends Wo {
	...
	static of(e, t) {
		let i = new ui(t || document.createElement(e.tagName), e);
...
class Fn extends Wo {
	...
	static start(e, t, i) {
		let r = new Fn(t || document.createElement('div'), e);
	...
	resolveInline(e, t, i) {
		...
		function a(c, h) {
			for (let f = 0, d = 0; f < c.children.length && d <= h; f++) {
				...
				(O >= h &&
					(p.isComposite()
						? a(p, h - d)
						: (!o || (o.isHidden && (t > 0 || (i && g0(o, p))))) &&
							  (O > h || p.flags & 32)
							? ((o = p), (l = h - d))
							: (d < h || (p.flags & 16 && !p.isHidden)) &&
								((r = p), (s = h - d))),
					(d = O));
			}
		}
		a(this, e);
		let u = (t < 0 ? r : o) || r || o;
		return u ? { tile: u, offset: u == r ? s : l } : null;
	}
	coordsIn(e, t) {
		let i = this.resolveInline(e, t, !0);
		return i ? i.tile.coordsIn(Math.max(0, i.offset), t) : m0(this);
	}
	domIn(e, t) {
		...
		if (i) {
			...
			if (this.dom.contains(r.dom))
				return r.isText()
					? new Et(r.dom, Math.min(r.dom.nodeValue.length, s))
					: r.domPosFor(s, r.flags & 16 ? 1 : r.flags & 32 ? -1 : t);
			let o = i.tile.parent,
				l = !1;
			for (let a of o.children) {
				if (l) return new Et(a.dom, 0);
				a == i.tile && (l = !0);
			}
		}
		return new Et(this.dom, 0);
	}
}
function m0(n) {
...
class Wi extends Ce {
	...
	coordsIn(e, t) {
		...
		let r = e,
			...
			o = 0;
		(e == 0 && t < 0) || (e == i && t >= 0)
			? j.chrome || j.gecko || (e ? (r--, (o = 1)) : s < i && (s++, (o = -1)))
			: t < 0
				? r--
				: s < i && s++;
		let l = Pr(this.dom, r, s).getClientRects();
...
class Ui extends Ce {
	...
	coordsInWidget(e, t, i) {
			...
			);
		{
			...
			for (
				...
				(o = s[a]), !(e > 0 ? a == 0 : a == s.length - 1 || o.top < o.bottom);
				a += l ? -1 : 1
			);
			return Ar(o, !l);
		}
	...
	get overrideDOMText() {
		if (!this.length) return Oe.empty;
		let { root: e } = this;
		if (!e) return Oe.empty;
	...
	static of(e, t, i, r, s) {
		return (
			s || ((s = e.toDOM(t)), e.editable || (s.contentEditable = 'false')),
			new Ui(s, i, e, r)
		);
	}
}
...
class b0 {
		...
		if (l && l.isText() && !(l.flags & 8) && l.length + e.length < 512) {
			...
			o.append(
				r ||
					Wi.of(
						e,
						(s = this.cache.find(Wi)) === null || s === void 0 ? void 0 : s.dom,
					),
			);
	...
	addComposition(e, t) {
		let i = this.curLine;
		i.dom != t.line.dom &&
			(i.setDOM(this.cache.reused.has(t.line) ? Rl(t.line.dom) : t.line.dom),
			this.cache.reused.set(t.line, 2));
		let r = i;
		for (let l = t.marks.length - 1; l >= 0; l--) {
			let a = t.marks[l],
				u = r.lastChild;
			if (u instanceof nt && u.mark.eq(a.mark))
				(u.dom != a.dom && u.setDOM(Rl(a.dom)), (r = u));
			else {
				if (this.cache.reused.get(a)) {
					let h = Ce.get(a.dom);
					h && h.setDOM(Rl(a.dom));
				}
				let c = nt.of(a.mark, a.dom);
				(r.append(c), (r = c));
			}
	...
	addInlineWidget(e, t, i) {
		...
		(!r && !(e.flags & 16) && s.append(this.getBuffer(1)),
			s.append(e),
			(this.pos += e.length),
			(this.afterWidget = e));
	}
	...
	addLineStart(e, t) {
		...
		let r = Fn.start(
			e,
			t ||
				((i = this.cache.find(Fn)) === null || i === void 0 ? void 0 : i.dom),
			!!t,
		);
	...
	ensureMarks(e, t) {
		...
		for (let s = e.length - 1; s >= 0; s--) {
			let o = e[s],
				l;
			if (t > 0 && (l = r.lastChild) && l instanceof nt && l.mark.eq(o))
				((r = l), t--);
			else {
				let a = nt.of(
					o,
					(i = this.cache.find(nt, (u) => u.mark.eq(o))) === null ||
						i === void 0
						? void 0
						: i.dom,
				);
	...
	endLine() {
		if (this.curLine) {
			...
			((!e ||
				...
				(e.dom.nodeName != 'BR' &&
					e.isWidget() &&
					!(j.ios && Ic(this.curLine, !0)))) &&
				this.curLine.append(
					this.cache.findWidget(Bl, 0, 32) || new Ui(Bl.toDOM(), 0, Bl, 32),
				),
	...
	updateBlockWrappers() {
		...
		for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next())
			if (e.to >= this.pos) {
				let t = new x0(e.from, e.to, e.value, e.rank),
	...
	getBlockPos() {
		...
		for (let i of this.wrappers) {
			let r = t.lastChild;
			if (i.from < this.pos && r instanceof ui && r.wrapper.eq(i.wrapper))
				t = r;
			else {
				let s = ui.of(
					i.wrapper,
					(e = this.cache.find(ui, (o) => o.wrapper.eq(i.wrapper))) === null ||
						e === void 0
						? void 0
						: e.dom,
				);
...
const Oo = [Ui, Fn, Wi, nt, po, ui, Io];
for (let n = 0; n < Oo.length; n++) Oo[n].bucket = n;
class D0 {
	constructor(e) {
		((this.view = e),
			(this.buckets = Oo.map(() => [])),
				...
				if (
					...
					(o == 0
						...
						: l.widget.constructor == e.constructor &&
							e.updateDOM(l.dom, this.view, l.widget))
				)
					return (
						r.splice(s, 1),
						...
						l.widget == e && l.length == t && (l.flags & 497) == i
							...
							: (this.reused.set(l, 2),
								new Ui(l.dom, t, e, (l.flags & -498) | i))
					);
			}
	}
	reuse(e) {
...
class w0 {
	constructor(e, t, i, r, s) {
		((this.view = e),
			...
			(this.openMarks = 0),
			(this.cache = new D0(e)),
			(this.text = new S0(e.state.doc)),
			(this.builder = new b0(this.cache, new Io(e, e.contentDOM), ce.iter(i))),
	...
	run(e, t) {
		...
		for (let r = 0, s = 0, o = 0; ; ) {
			...
			(t && l.fromA <= t.range.fromA && l.toA >= t.range.toA
				...
				: (this.forward(l.fromA, l.toA), this.emit(s, l.toB)),
				(s = l.toB),
				(r = l.toA));
		}
		...
		(this.old.advance(e, i ? 1 : -1, {
					...
					if (this.openWidget) this.builder.continueWidget(a - l);
						...
						let u =
							a > 0 || l < o.length
								...
								: this.cache.reuse(o);
						u.flags & 256
							? ((u.flags &= -2), this.builder.addBlockWidget(u))
							: (this.builder.ensureLine(null),
								this.builder.addInlineWidget(u, r, s),
								(s = r.length));
					}
				else if (o.isText())
					(this.builder.ensureLine(null),
						!l && a == o.length && !this.cache.reused.has(o)
							...
							: (this.cache.add(o),
								this.builder.addText(o.text.slice(l, a), r, s)),
						(s = r.length));
				else if (o.isLine())
					((o.flags &= -2),
						this.cache.reused.set(o, 1),
						this.builder.addLine(o));
				else if (o instanceof po) this.cache.add(o);
				else if (o instanceof nt)
					(this.builder.ensureLine(null),
						this.builder.addMark(o, r, s),
						this.cache.reused.set(o, 1),
						(s = r.length));
				else return !1;
				this.openWidget = !1;
			...
			enter: (o) => {
				(o.isLine()
					...
					: (this.cache.add(o), o instanceof nt && r.unshift(o.mark)),
					(this.openWidget = !1));
			},
			leave: (o) => {
				o.isLine()
					? r.length && (r.length = s = 0)
					: o instanceof nt && (r.shift(), (s = Math.min(s, r.length)));
			},
			break: () => {
	...
	emit(e, t) {
		let i = null,
			r = this.builder,
			s = 0,
			o = ce.spans(this.decorations, e, t, {
				point: (l, a, u, c, h, f) => {
					if (u instanceof Ni) {
						...
						if (((s = c.length), h > c.length)) r.continueWidget(a - l);
						else {
							let d = u.widget || (u.block ? _n.block : _n.inline),
								p = v0(u),
								O =
									this.cache.findWidget(d, a - l, p) ||
									Ui.of(d, this.view, a - l, p);
							u.block
								? (u.startSide > 0 && r.addLineStartIfNotCovered(i),
									r.addBlockWidget(O))
								: (r.ensureLine(i), r.addInlineWidget(O, c, h));
						}
						i = null;
					} else i = Q0(i, u);
				...
				span: (l, a, u, c) => {
					for (let h = l; h < a; ) {
						...
						(f == null
							? (r.addLineStartIfNotCovered(i), r.addBreak(), h++)
							: (r.ensureLine(i),
								r.addText(f, u, h == l ? c : u.length),
								(h += f.length)),
							(i = null));
					}
				},
			});
		(r.addLineStartIfNotCovered(i),
			(this.openWidget = o > s),
			(this.openMarks = o));
	}
	forward(e, t, i = 1) {
...
function Ic(n, e) {
	let t = (i) => {
		for (let r of i.children)
			if ((e ? r.isText() : r.length) || t(r)) return !0;
		return !1;
	};
	return t(n);
}
...
_n.inline = new _n('span');
_n.block = new _n('div');
const Bl = new (class extends Ht {
	toDOM() {
...
class qc {
	constructor(e) {
		((this.view = e),
			...
			this.updateInner([new yt(0, 0, 0, e.state.doc.length)], null));
	}
	update(e) {
		var t;
		...
		(this.minWidth > 0 &&
			i.length &&
			(i.every(
				({ fromA: c, toA: h }) => h < this.minWidthFrom || c > this.minWidthTo,
			)
		...
		this.view.inputState.composing >= 0 &&
			...
			(!((t = this.domChanged) === null || t === void 0) && t.newSel
				...
				: !R0(e.changes, this.hasComposition) &&
					!e.selectionSet &&
					(r = e.state.selection.main.head));
		let s = r > -1 ? A0(this.view, e.changes, r) : null;
		...
		this.updateDeco();
		let a = E0(o, this.decorations, e.changes);
		a.length && (i = yt.extendWithRanges(i, a));
		let u = Z0(l, this.blockWrappers, e.changes);
		return (
			u.length && (i = yt.extendWithRanges(i, u)),
			s &&
				!i.some((c) => c.fromA <= s.range.fromA && c.toA >= s.range.toA) &&
				(i = s.range.addToSet(i.slice())),
			this.tile.flags & 2 && i.length == 0
				? !1
				: (this.updateInner(i, s),
	...
	updateInner(e, t) {
		...
		i.ignore(() => {
			if (t || e.length) {
				...
				(t && Ce.get(t.text) && l.cache.reused.set(Ce.get(t.text), 2),
					(this.tile = l.run(e, t)),
					qa(o, l.cache.reused));
			}
		...
		if (
			...
			for (let s of this.tile.children)
				s.isWidget() && s.widget instanceof Fl && r.push(s.dom);
		i.updateGaps(r);
	}
	updateEditContextFormatting(e) {
		...
		for (let t of e.transactions)
			for (let i of t.effects)
				i.is(_d) && (this.editContextFormatting = i.value);
	}
	updateSelection(e = !1, t = !1) {
		...
		let { dom: i } = this.tile,
			...
			o =
				!s &&
				!(this.view.state.facet(oi) || i.tabIndex > -1) &&
				pr(i, this.view.observer.selectionRange) &&
				!(r && i.contains(r));
		if (!(s || t || o)) return;
		...
		if (
			(a.empty
				? (c = u = this.inlineDOMNearPos(a.anchor, a.assoc || 1))
				: ((c = this.inlineDOMNearPos(a.head, a.head == a.from ? 1 : -1)),
					(u = this.inlineDOMNearPos(a.anchor, a.anchor == a.from ? 1 : -1))),
			j.gecko && a.empty && !this.hasComposition && k0(u))
		) {
			let f = document.createTextNode('');
			(this.view.observer.ignore(() =>
				u.node.insertBefore(f, u.node.childNodes[u.offset] || null),
			),
				(u = c = new Et(f, 0)),
				(l = !0));
		}
		...
		((l ||
			!h.focusNode ||
			((!mr(u.node, u.offset, h.anchorNode, h.anchorOffset) ||
				!mr(c.node, c.offset, h.focusNode, h.focusOffset)) &&
				!this.suppressWidgetCursorChange(h, a))) &&
			(this.view.observer.ignore(() => {
				j.android &&
					j.chrome &&
				...
				let f = kr(this.view.root);
				if (f)
					if (a.empty) {
						if (j.gecko) {
							let d = P0(u.node, u.offset);
							if (d && d != 3) {
								let p = (d == 1 ? Dd : wd)(u.node, u.offset);
								p && (u = new Et(p.node, p.offset));
							}
						}
			...
			this.view.observer.setSelectionRange(u, c)),
			(this.impreciseAnchor = u.precise
				? null
				: new Et(h.anchorNode, h.anchorOffset)),
			(this.impreciseHead = c.precise
				? null
				: new Et(h.focusNode, h.focusOffset)));
	}
	suppressWidgetCursorChange(e, t) {
		return (
			this.hasComposition &&
			t.empty &&
			mr(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset) &&
	...
	enforceCursorAssoc() {
		...
		e.docView.posFromDOM(h.anchorNode, h.anchorOffset) != t.from &&
			i.collapse(r, s);
	}
	posFromDOM(e, t) {
		...
		if (i.isComposite()) {
			...
			for (; s && !Ce.get(s); ) s = s.nextSibling;
			...
			return i.isText() ? (e == i.dom ? r + t : r + (t ? i.length : 0)) : r;
	}
	domAtPos(e, t) {
	...
	inlineDOMNearPos(e, t) {
		let i,
			...
			a = !1;
		return (
			this.tile.blockTiles((u, c) => {
				if (u.isWidget()) {
					if (u.flags & 32 && c >= e) return !0;
					u.flags & 16 && (s = !0);
				} else {
					let h = c + u.length;
					if (
						(c <= e && ((i = u), (r = e - c), (s = h < e)),
						h >= e && !o && ((o = u), (l = e - c), (a = c > e)),
						c > e && o)
					)
						return !0;
				}
			...
			!i && !o
				...
				: (s && o ? (i = null) : a && i && (o = null),
					(i && t < 0) || !o ? i.domIn(r, t) : o.domIn(l, t))
		);
	}
	coordsAt(e, t) {
		let { tile: i, offset: r } = this.tile.resolveBlock(e, t);
		return i.isWidget()
			? i.widget instanceof Fl
				? null
				: i.coordsInWidget(r, t, !0)
			: i.coordsIn(r, t);
	}
	lineAt(e, t) {
	...
	coordsForChar(e) {
		...
		function r(s, o) {
			if (s.isComposite())
				...
				let l = Xe(s.text, o);
				if (l == o) return null;
				let a = Pr(s.dom, o, l).getClientRects();
	...
	measureVisibleLineHeights(e) {
		let t = [],
			...
			l = -1,
			a = this.view.textDirection == ye.LTR,
			u = 0,
			c = (h, f, d) => {
				for (let p = 0; p < h.children.length && !(f > r); p++) {
					let O = h.children[p],
						m = f + O.length,
						g = O.dom.getBoundingClientRect(),
						{ height: S } = g;
					if ((d && !p && (u += g.top - d.top), O instanceof ui))
						m > i && c(O, f, g);
					else if (f >= i && (u > 0 && t.push(-u), t.push(S + u), (u = 0), o)) {
						let w = O.dom.lastChild,
							k = w ? Or(w) : [];
						if (k.length) {
							let x = k[k.length - 1],
								C = a ? x.right - g.left : g.right - x.left;
							C > l &&
								((l = C),
								(this.minWidth = s),
								(this.minWidthFrom = f),
					...
					(d && p == h.children.length - 1 && (u += d.bottom - g.bottom),
						(f = m + O.breakAfter));
				}
			};
	...
	textDirectionAt(e) {
		...
		return getComputedStyle(t.dom).direction == 'rtl' ? ye.RTL : ye.LTR;
	}
	measureTextSize() {
		let e = this.tile.blockTiles((o) => {
			if (o.isLine() && o.children.length && o.length <= 20) {
				...
				for (let u of o.children) {
					if (!u.isText() || /[^ -~]/.test(u.text)) return;
					let c = Or(u.dom);
	...
	updateDeco() {
		let e = 1,
			...
			i = !1,
			r = this.view.state.facet(Ru).map((s, o) => {
				let l = typeof s == 'function';
				return (l && (i = !0), l ? s(this.view) : s);
			});
		for (
			r.length && ((this.dynamicDecorationMap[e++] = i), t.push(ce.join(r))),
				this.decorations = [
		...
		this.blockWrappers = this.view.state
			.facet(jd)
			.map((s) => (typeof s == 'function' ? s(this.view) : s));
	}
	scrollIntoView(e) {
		var t;
		if (e.isSnapshot) {
		...
		for (let c of this.view.state.facet(Fd))
			try {
				if (c(this.view, e.range, e)) return !0;
			} catch (h) {
				rt(this.view.state, h, 'scroll handler');
			}
		let { range: i } = e,
			r = this.coordsAt(
				i.head,
				(t = i.assoc) !== null && t !== void 0
					? t
					: i.empty
						? 0
						: i.head > i.anchor
		...
		let o = Bu(this.view),
			...
			{ offsetWidth: a, offsetHeight: u } = this.view.scrollDOM;
		if (
			(t0(
				this.view.scrollDOM,
				l,
				...
				Math.max(Math.min(e.yMargin, u), -u),
				this.view.textDirection == ye.LTR,
			),
...
function qa(n, e) {
	...
	if (t != 1) {
		t == null && n.destroy();
		for (let i of n.children) qa(i, e);
	}
}
function k0(n) {
	return (
...
function Id(n, e) {
	...
	let i = Dd(t.focusNode, t.focusOffset),
		r = wd(t.focusNode, t.focusOffset),
		s = i || r;
...
function A0(n, e, t) {
	...
	return { range: new yt(a.mapPos(s), a.mapPos(o), s, o), text: r };
}
function P0(n, e) {
	return n.nodeType != 1
		? 0
...
function B0(n, e, t = 1) {
	...
	return T.range(o + r.from, l + r.from);
}
function F0(n, e, t, i, r) {
	...
	return t.from + Za(o, s, n.state.tabSize);
}
function Va(n, e, t) {
...
function _0(n, e, t, i) {
	let r = Va(n, e.head, e.assoc || -1),
		s =
			!i || r.type != ze.Text || !(n.lineWrapping || r.widgetLineBreaks)
				? null
	...
	if (s) {
		let o = n.dom.getBoundingClientRect(),
			...
			a = n.posAtCoords({
				x: t == (l == ye.LTR) ? o.right - 1 : o.left + 1,
				y: (s.top + s.bottom) / 2,
			});
		if (a != null) return T.cursor(a, t ? -1 : 1);
	}
...
function j0(n, e, t, i) {
	...
	let o = e.goalColumn,
		...
		u = n.coordsAtPos(
			r,
			e.assoc || ((e.empty ? t : e.head == e.from) ? 1 : -1),
		),
		c = n.documentTop;
	if (u) (o == null && (o = u.left - a.left), (l = s < 0 ? u.top : u.bottom));
		...
		(o == null &&
			(o = Math.min(a.right - a.left, n.defaultCharacterWidth * (r - p.from))),
			(l = (s < 0 ? p.top : p.bottom) + c));
	}
	let h = a.left + o,
	...
	for (let p = 0; ; p += f) {
		let O = l + (d + p) * s,
			m = Ya(n, { x: h, y: O }, !1, s);
		if (t ? O > a.bottom : O < a.top) return T.cursor(m.pos, m.assoc);
		let g = n.coordsAtPos(m.pos, m.assoc),
			S = g ? (g.top + g.bottom) / 2 : 0;
		if (!g || (t ? S > l : S < l)) return T.cursor(m.pos, m.assoc, void 0, o);
	}
}
function gr(n, e, t) {
	for (;;) {
	...
	for (let i = 0; i < e.ranges.length; i++) {
		...
		if (r.empty) {
			...
			let o = gr(n, r.from, -1),
				l = gr(n, r.to, 1);
			(o != r.from || l != r.to) &&
				(s = T.range(r.from == r.anchor ? o : l, r.from == r.head ? o : l));
		}
...
function Ya(n, e, t, i) {
	let r = n.contentDOM.getBoundingClientRect(),
		...
		u;
	for (;;) {
		if (a < 0) return new Wt(0, 1);
		if (a > n.viewState.docHeight) return new Wt(n.state.doc.length, -1);
		if (((u = n.elementAtHeight(a)), i == null)) break;
		if (u.type == ze.Text) {
			if (i < 0 ? u.to < n.viewport.from : u.from > n.viewport.to) break;
			let f = n.docView.coordsAt(i < 0 ? u.from : u.to, i > 0 ? -1 : 1);
			if (f && (i < 0 ? f.top <= a + s : f.bottom >= a + s)) break;
		}
	...
	if (n.viewport.from >= u.to || n.viewport.to <= u.from) {
		...
		if (u.type == ze.Text) {
			let h = F0(n, r, u, o, l);
			return new Wt(h, h == u.from ? 1 : -1);
		}
	}
	if (u.type != ze.Text)
		return a < (u.top + u.bottom) / 2 ? new Wt(u.from, 1) : new Wt(u.to, -1);
	let c = n.docView.lineAt(u.from, 2);
	return (
		(!c || c.length != u.length) && (c = n.docView.lineAt(u.from, -2)),
		new L0(n, o, l, n.textDirectionAt(u.from)).scanTile(c, u.from)
	);
}
class L0 {
	constructor(e, t, i, r) {
	...
	bidiIn(e, t) {
		...
		return (
			i.length > 1 ||
			(i.length && (i[0].level != this.baseDir || i[0].to + r.from < t))
		);
	}
	scan(e, t) {
		let i = 0,
		...
		e: for (; i < r; ) {
			...
			if (O)
				for (let m = 0; m < O.length; m++) {
					let g = O[m],
						S = 0;
					if (!(g.width == 0 && O.length > 1)) {
						if (g.bottom < this.y)
							((!l || l.bottom < g.bottom) && (l = g), (S = 1));
						else if (g.top > this.y)
							((!a || a.top > g.top) && (a = g), (S = -1));
						else {
							let w =
									g.left > this.x
										? this.x - g.left
								...
								k = Math.abs(w);
							(k < c && ((u = p), (c = k), (h = g)),
								w && (S = w < 0 == (this.baseDir == ye.LTR) ? -1 : 1));
						}
						S == -1 && (!o || this.baseDirAt(e[p], 1))
							? (r = p)
							: S == 1 && (!o || this.baseDirAt(e[p + 1], -1)) && (i = p + 1);
					}
				}
		}
		if (!h) {
		...
		let f = (o ? this.dirAt(e[u], 1) : this.baseDir) == ye.LTR;
		return { i: u, after: this.x > (h.left + h.right) / 2 == f };
	}
	scanText(e, t) {
		let i = [];
		...
		let r = this.scan(i, (s) => {
			let o = i[s] - t,
				l = i[s + 1] - t;
			return Pr(e.dom, o, l).getClientRects();
		});
...
class z0 {
	constructor(e, t) {
		((this.points = e),
			(this.view = t),
			(this.text = ''),
			(this.lineSeparator = t.state.facet(fe.lineSeparator)));
	}
	append(e) {
		this.text += e;
	}
	...
	findPointInside(e, t) {
		for (let i of this.points)
			(e.nodeType == 3 ? i.node == e : e.contains(i.node)) &&
				(i.pos = this.text.length + (W0(e, i.node, i.offset) ? t : 0));
	}
}
function W0(n, e, t) {
	for (;;) {
		if (!e || t < fi(e)) return !1;
		if (e == n) return !0;
...
class q0 {
	constructor(e, t, i, r) {
		...
		if (e.state.readOnly && t > -1) this.newSel = null;
		else if (t > -1 && (this.bounds = Vd(e.docView.tile, t, i, 0))) {
			let a = s || o ? [] : Y0(e),
				u = new z0(a, e);
			(u.readRange(this.bounds.startDOM, this.bounds.endDOM),
				(this.text = u.text),
				(this.newSel = N0(a, this.bounds.from)));
		} else {
			let a = e.observer.selectionRange,
				u =
					(s && s.node == a.focusNode && s.offset == a.focusOffset) ||
					!ja(e.contentDOM, a.focusNode)
						? l.main.head
						: e.docView.posFromDOM(a.focusNode, a.focusOffset),
				c =
					(o && o.node == a.anchorNode && o.offset == a.anchorOffset) ||
					!ja(e.contentDOM, a.anchorNode)
						? l.main.anchor
			...
			if (
				...
				let f = Math.min(u, c),
					...
					O = h.to - d;
				(p == 0 || p == 1 || f == 0) &&
					(O == 0 || O == -1 || d == e.state.doc.length) &&
					((u = 0), (c = e.state.doc.length));
			}
			if (e.inputState.composing > -1 && l.ranges.length > 1)
				this.newSel = l.replaceRange(T.range(c, u));
			else if (
				e.lineWrapping &&
				c == u &&
				!(l.main.empty && l.main.head == u) &&
				e.inputState.lastTouchTime > Date.now() - 100
			) {
				let f = e.coordsAtPos(u, -1),
					d = 0;
				(f && (d = e.inputState.lastTouchY <= f.bottom ? -1 : 1),
					(this.newSel = T.create([T.cursor(u, d)])));
			} else this.newSel = T.single(c, u);
		}
	}
}
function Vd(n, e, t, i) {
	if (n.isComposite()) {
		...
		for (let a = 0, u = i, c = i; a < n.children.length; a++) {
			let h = n.children[a],
				f = u + h.length;
			if (u < e && f > t) return Vd(h, e, t, u);
			if (
				(f >= e && r == -1 && ((r = a), (s = u)),
				u > t && h.dom.parentNode == n.dom)
			) {
				((o = a), (l = c));
				break;
			}
		...
		return {
			...
			to: l < 0 ? i + n.length : l,
			startDOM:
				(r ? n.children[r - 1].dom.nextSibling : null) || n.dom.firstChild,
...
function Yd(n, e) {
	...
	if (e.bounds) {
		let { from: l, to: a } = e.bounds,
			u = s.from,
			c = null;
		(o === 8 || (j.android && e.text.length < a - l)) &&
			((u = s.to), (c = 'end'));
		let h = r.doc.sliceString(l, a, Dn),
			f,
			d;
		!s.empty &&
		s.from >= l &&
		s.to <= a &&
		(e.typeOver || h != e.text) &&
		h.slice(0, s.from - l) == e.text.slice(0, s.from - l) &&
		h.slice(s.to - l) ==
			e.text.slice((f = e.text.length - (h.length - (s.to - l))))
			? (t = {
					from: s.from,
					to: s.to,
					insert: Oe.of(e.text.slice(s.from - l, f).split(Dn)),
				})
			: (d = Nd(h, e.text, u - l, c)) &&
				(j.chrome &&
					o == 13 &&
					d.toB == d.from + 2 &&
					e.text.slice(d.from, d.toB) == Dn + Dn &&
					d.toB--,
				(t = {
					from: l + d.from,
					to: l + d.toA,
					insert: Oe.of(e.text.slice(d.from, d.toB).split(Dn)),
				}));
	} else i && ((!n.hasFocus && r.facet(oi)) || mo(i, s)) && (i = null);
	if (!t && !i) return !1;
	if (
		((j.mac || j.android) &&
		t &&
		...
		n.contentDOM.getAttribute('autocorrect') == 'off'
			? (i &&
					t.insert.length == 2 &&
					(i = T.single(i.main.anchor - 1, i.main.head - 1)),
				(t = {
					from: t.from,
					to: t.to,
					insert: Oe.of([t.insert.toString().replace('.', ' ')]),
				}))
 ...
 ` &&
					...
					(t = { from: s.from, to: s.to, insert: Oe.of([' ']) })),
		t)
	)
		return Fu(n, t, i, o);
	if (i && !mo(i, s)) {
...
function Fu(n, e, t, i = -1) {
	if (j.ios && n.inputState.flushIOSKey(e)) return !0;
	let r = n.state.selection.main;
	if (
		j.android &&
		((e.to == r.to &&
			(e.from == r.from ||
				(e.from == r.from - 1 && n.state.sliceDoc(e.from, r.from) == ' ')) &&
			e.insert.length == 1 &&
			e.insert.lines == 2 &&
			En(n.contentDOM, 'Enter', 13)) ||
			(((e.from == r.from - 1 && e.to == r.to && e.insert.length == 0) ||
				(i == 8 && e.insert.length < e.to - e.from && e.to > r.head)) &&
				En(n.contentDOM, 'Backspace', 8)) ||
			(e.from == r.from &&
				e.to == r.to + 1 &&
				e.insert.length == 0 &&
				En(n.contentDOM, 'Delete', 46)))
	)
		return !0;
	...
	let o,
		l = () => o || (o = V0(n, e, t));
	return (
		n.state.facet(Zd).some((a) => a(n, e.from, e.to, s, l)) || n.dispatch(l()),
		!0
	);
}
function V0(n, e, t) {
	...
	if ((e.from == e.to && e.from < s.from) || e.from > s.to) {
		let a = e.from < s.from ? -1 : 1,
			u = a < 0 ? s.from : s.to,
			c = gr(
				r.facet(Lr).map((h) => h(n)),
				u,
				a,
			);
		e.from == c && (o = c);
	...
	if (o > -1)
		i = { changes: e, selection: T.cursor(e.from + e.insert.length, -1) };
	else if (
		e.from >= s.from &&
		e.to <= s.to &&
		...
		let a = s.from < e.from ? r.sliceDoc(s.from, e.from) : '',
			u = s.to > e.to ? r.sliceDoc(e.to, s.to) : '';
		i = r.replaceSelection(
			n.state.toText(
				a + e.insert.sliceString(0, void 0, n.state.lineBreak) + u,
			),
		);
	} else {
		let a = r.changes(e),
			u = t && t.main.to <= a.newLength ? t.main : void 0;
		if (
			...
			i = r.changeByRange((p) => {
				...
				let O = p.to - d,
					m = O - c.length;
				if (n.state.sliceDoc(m, O) != c || (O >= h.from && m <= h.to))
					return { range: p };
				...
				return {
					changes: g,
					range: u
						? T.range(Math.max(0, u.anchor + S), Math.max(0, u.head + S))
						: p.map(g),
				};
			});
		} else i = { changes: a, selection: u && r.selection.replaceRange(u) };
	}
	let l = 'input.type';
	return (
		(n.composing ||
		...
		r.update(i, { userEvent: l, scrollIntoView: !0 })
	);
}
function Nd(n, e, t, i) {
...
function Y0(n) {
	...
	return (
		t && (e.push(new Yc(t, i)), (r != t || s != i) && e.push(new Yc(r, s))),
		e
	);
}
function N0(n, e) {
...
class G0 {
	...
	constructor(e) {
		((this.view = e),
			...
			j.gecko && c1(e.contentDOM.ownerDocument));
	}
	handleEvent(e) {
		!n1(this.view, e) ||
	...
	keydown(e) {
		...
		return j.ios &&
			...
			!e.metaKey &&
			!e.shiftKey &&
			(((t = Gd.find((i) => i.keyCode == e.keyCode)) && !e.ctrlKey) ||
				(H0.indexOf(e.key) > -1 && e.ctrlKey))
...
function U0(n) {
	...
	for (let i of n) {
		...
		if (s)
			for (let l in s) {
				let a = s[l];
				a && t(l).handlers.push(Nc(i.value, a));
			}
		if (o)
			for (let l in o) {
				let a = o[l];
				a && t(l).observers.push(Nc(i.value, a));
			}
	}
	for (let i in Mt) t(i).handlers.push(Mt[i]);
	for (let i in ot) t(i).observers.push(ot[i]);
	return e;
}
const Gd = [
...
class J0 {
	constructor(e, t, i, r) {
		((this.view = e),
			...
			(this.scrolling = -1),
			(this.lastEvent = t),
			(this.scrollParents = xd(e.contentDOM)),
			(this.atoms = e.state.facet(Lr).map((o) => o(e))));
		...
		(s.addEventListener('mousemove', (this.move = this.move.bind(this))),
			...
			(this.multiple = e.state.facet(fe.allowMultipleSelections) && e1(e, t)),
			(this.dragging = i1(e, t) && Jd(t) == 1 ? null : !1));
	}
	start(e) {
	...
	move(e) {
		...
		if (this.dragging || (this.dragging == null && K0(this.startEvent, e) < 10))
			return;
		...
		(this.scrollParents.x &&
			({ left: r, right: o } = this.scrollParents.x.getBoundingClientRect()),
			this.scrollParents.y &&
				({ top: s, bottom: l } = this.scrollParents.y.getBoundingClientRect()));
		let a = Bu(this.view);
		(e.clientX - a.left <= r + Ps
			? (t = -$s(r - e.clientX))
			: e.clientX + a.right >= o - Ps && (t = $s(e.clientX - o)),
			e.clientY - a.top <= s + Ps
				? (i = -$s(s - e.clientY))
				: e.clientY + a.bottom >= l - Ps && (i = $s(e.clientY - l)),
	...
	select(e) {
		let { view: t } = this,
			i = qd(this.atoms, this.style.get(e, this.extend, this.multiple));
...
const Mt = Object.create(null),
	...
	Hd = (j.ie && j.ie_version < 15) || (j.ios && j.webkit_version < 604);
function r1(n) {
	...
	if (
		...
		i = t.changeByRange((u) => {
			...
			return {
				...
				range: T.cursor(u.from + h.length),
			};
		});
	} else
		o
			? (i = t.changeByRange((a) => {
					...
					return {
						...
						range: T.cursor(a.from + u.length),
					};
				}))
...
Mt.mousedown = (n, e) => {
	if ((n.observer.flush(), n.inputState.lastTouchTime > Date.now() - 2e3))
		return !1;
	let t = null;
	for (let i of n.state.facet(Ed)) if (((t = i(n, e)), t)) break;
	if ((!t && e.button == 0 && (t = o1(n, e)), t)) {
		let i = !n.hasFocus;
		(n.inputState.startMouseSelection(new J0(n, e, t, i)),
			i &&
				n.observer.ignore(() => {
					bd(n.contentDOM);
...
function Gc(n, e, t, i) {
	...
	if (i == 2) return B0(n.state, e, t);
	{
		let r = n.docView.lineAt(e, t),
			s = n.state.doc.lineAt(r ? r.posAtEnd : e),
			o = r ? r.posAtStart : s.from,
			l = r ? r.posAtEnd : s.to;
		return (l < n.state.doc.length && l == s.to && l++, T.range(o, l));
	}
}
const s1 = j.ie && j.ie_version <= 11;
let Uc = null,
	Hc = 0,
	Kc = 0;
function Jd(n) {
	if (!s1) return n.detail;
	let e = Uc,
		t = Kc;
	return (
		(Uc = n),
...
function o1(n, e) {
	...
	return {
		...
		get(s, o, l) {
			let a = n.posAndSideAtCoords({ x: s.clientX, y: s.clientY }, !1),
				u,
				c = Gc(n, a.pos, a.assoc, i);
			if (t.pos != a.pos && !o) {
				let h = Gc(n, t.pos, t.assoc, i),
					f = Math.min(h.from, c.from),
					d = Math.max(h.to, c.to);
				c = f < c.from ? T.range(f, d, c.assoc) : T.range(d, f, c.assoc);
			}
			return o
				? r.replaceRange(r.main.extend(c.from, c.to, c.assoc))
				: l && i == 1 && r.ranges.length > 1 && (u = l1(r, a.pos))
					? u
					: l
						? r.addRange(c)
						: T.create([c]);
	...
	return (
		...
		e.dataTransfer &&
			(e.dataTransfer.setData(
				'Text',
				qo(n.state, Zu, n.state.sliceDoc(t.from, t.to)),
			),
...
Mt.drop = (n, e) => {
	...
	if (t && t.length) {
		let i = Array(t.length),
			...
			s = () => {
				++r == t.length &&
					Jc(n, e, i.filter((o) => o != null).join(n.state.lineBreak), !1);
			};
...
Mt.paste = (n, e) => {
	...
	return t
		? (Kd(n, t.getData('text/plain') || t.getData('text/uri-list')), !0)
		: (r1(n), !1);
};
function a1(n, e) {
...
function u1(n) {
	...
	return { text: qo(n, Zu, e.join(n.lineBreak)), ranges: t, linewise: i };
}
let Na = null;
Mt.copy = Mt.cut = (n, e) => {
	if (!pr(n.contentDOM, n.observer.selectionRange)) return !1;
	let { text: t, ranges: i, linewise: r } = u1(n.state);
	if (!t && !r) return !1;
	((Na = r ? t : null),
		e.type == 'cut' &&
			!n.state.readOnly &&
			n.dispatch({ changes: i, scrollIntoView: !0, userEvent: 'delete.cut' }));
	let s = Hd ? null : e.clipboardData;
	return s ? (s.clearData(), s.setData('text/plain', t), !0) : (a1(n, t), !1);
};
const ep = Gt.define();
function tp(n, e) {
	let t = [];
	...
	return t.length ? n.update({ effects: t, annotations: ep.of(!0) }) : null;
}
function ip(n) {
	setTimeout(() => {
		let e = n.hasFocus;
...
ot.blur = (n) => {
	(n.observer.clearSelectionRange(), ip(n));
};
ot.compositionstart = ot.compositionupdate = (n) => {
...
Mt.beforeinput = (n, e) => {
	...
	if (
		...
		if (s && o.length) {
			let l = o[0],
				...
				u = n.posAtDOM(l.endContainer, l.endOffset);
			return (Fu(n, { from: a, to: u, insert: n.state.toText(s) }, null), !0);
		}
	}
	let r;
	if (
		j.chrome &&
		j.android &&
		(r = Gd.find((s) => s.inputType == e.inputType)) &&
	...
	return (
		j.ios && e.inputType == 'deleteContentForward' && n.observer.flushSoon(),
		j.safari &&
			e.inputType == 'insertText' &&
			n.inputState.composing >= 0 &&
			setTimeout(() => ot.compositionend(n, e), 20),
		!1
	);
};
const eh = new Set();
...
const th = ['pre-wrap', 'normal', 'pre-line', 'break-spaces'];
let Xn = !1;
function ih() {
	Xn = !1;
}
class h1 {
	...
	mustRefreshForWrapping(e) {
		return th.indexOf(e) > -1 != this.lineWrapping;
	}
...
class Je {
	...
	setHeight(e) {
		this.height != e &&
			(Math.abs(this.height - e) > Js && (Xn = !0), (this.height = e));
	}
	replace(e, t, i) {
		return Je.of(i);
	}
	...
	applyChanges(e, t, i, r) {
		...
		for (let l = r.length - 1; l >= 0; l--) {
			let { fromA: a, toA: u, fromB: c, toB: h } = r[l],
				f = s.lineAt(a, Se.ByPosNoHeight, i.setDoc(t), 0, 0),
				d = f.to >= u ? f : s.lineAt(u, Se.ByPosNoHeight, i, 0, 0);
			for (h += d.to - u, u = d.to; l > 0 && f.from <= r[l - 1].toA; )
				((a = r[l - 1].fromA),
					(c = r[l - 1].fromB),
					l--,
					a < f.from && (f = s.lineAt(a, Se.ByPosNoHeight, i, 0, 0)));
			((c += f.from - a), (a = f.from));
			let p = _u.build(i.setDoc(o), e, c, h);
			s = go(s, s.replace(a, u, p));
		}
	...
	static of(e) {
		...
		return (
			...
			new p1(Je.of(e.slice(0, t)), o, Je.of(e.slice(i)))
		);
	}
}
function go(n, e) {
...
class np extends Je {
	...
	blockAt(e, t, i, r) {
		return this.spaceAbove && e < i + this.spaceAbove
			? new $t(r, 0, i, this.spaceAbove, d1)
			: this.mainBlock(i, r);
	}
	lineAt(e, t, i, r, s) {
	...
	forEachLine(e, t, i, r, s, o) {
		e <= s + this.length && t >= s && o(this.lineAt(0, Se.ByPos, i, r, s));
	}
	setMeasuredHeight(e) {
	...
	updateHeight(e, t = 0, i = !1, r) {
		return (
			r && r.from <= t && r.more && this.setMeasuredHeight(r),
			(this.outdated = !1),
			this
		);
	}
...
class ct extends np {
	...
	replace(e, t, i) {
		let r = i[0];
		return i.length == 1 &&
			(r instanceof ct || (r instanceof je && r.flags & 4)) &&
			Math.abs(this.length - r.length) < 10
			? (r instanceof je
					? (r = new ct(r.length, this.height, this.spaceAbove))
...
class je extends Je {
	...
	blockAt(e, t, i, r) {
		...
		if (t.lineWrapping) {
			let u =
				...
				h = l + c.length * a,
				f = Math.max(i, e - h / 2);
			return new $t(c.from, c.length, f, h, 0);
		} else {
			let u = Math.max(0, Math.min(o - s, Math.floor((e - i) / l))),
				{ from: c, length: h } = t.doc.line(s + u);
			return new $t(c, h, i + l * u, l, 0);
		}
	}
	lineAt(e, t, i, r, s) {
		...
		let { firstLine: o, perLine: l, perChar: a } = this.heightMetrics(i, s),
			...
			c = l + u.length * a,
			h = u.number - o,
			f = r + l * h + a * (u.from - s - h);
		return new $t(
			u.from,
			u.length,
			Math.max(r, Math.min(f, r + this.height - c)),
			c,
			0,
		);
	}
	forEachLine(e, t, i, r, s, o) {
		...
		for (let c = e, h = r; c <= t; ) {
			...
			let d = a + u * f.length;
			(o(new $t(f.from, f.length, h, d, 0)), (h += d), (c = f.to + 1));
		}
	}
	replace(e, t, i) {
		let r = this.length - t;
		if (r > 0) {
			let s = i[i.length - 1];
			s instanceof je
				? (i[i.length - 1] = new je(s.length + r))
				: i.push(null, new je(r - 1));
		}
		if (e > 0) {
			let s = i[0];
			s instanceof je
				? (i[0] = new je(e + s.length))
				: i.unshift(new je(e - 1), null);
		}
		return Je.of(i);
	}
	decomposeLeft(e, t) {
	...
	updateHeight(e, t = 0, i = !1, r) {
		...
		if (r && r.from <= t + this.length && r.more) {
			let o = [],
				...
				a = -1;
			for (
				r.from > t && o.push(new je(r.from - t - 1).updateHeight(e, t));
				l <= s && r.more;
			) {
				...
				let h = r.heights[r.index++],
					f = 0;
				(h < 0 && ((f = -h), (h = r.heights[r.index++])),
					a == -1 ? (a = h) : Math.abs(h - a) >= Js && (a = -2));
				let d = new ct(c, h, f);
			...
			return (
				(a < 0 ||
					Math.abs(u.height - this.height) >= Js ||
					Math.abs(a - this.heightMetrics(e, t).perLine) >= Js) &&
					(Xn = !0),
				go(this, u)
			);
		} else
...
class p1 extends Je {
	...
	lineAt(e, t, i, r, s) {
		...
		return a
			? u.join(this.right.lineAt(l, c, i, o, l))
			: this.left.lineAt(l, c, i, r, s).join(u);
	}
	forEachLine(e, t, i, r, s, o) {
		...
		if (this.break)
			...
			let u = this.lineAt(a, Se.ByPos, i, r, s);
	...
	replace(e, t, i) {
		...
		if ((e > 0 && nh(s, o - 1), t < this.length)) {
			let l = s.length;
			(this.decomposeRight(t, s), nh(s, l));
		}
		return Je.of(s);
	}
	decomposeLeft(e, t) {
	...
	balanced(e, t) {
		return e.size > 2 * t.size || t.size > 2 * e.size
			? Je.of(this.break ? [e, null, t] : [e, t])
			: ((this.left = go(this.left, e)),
				(this.right = go(this.right, t)),
...
function nh(n, e) {
	let t, i;
	n[e] == null &&
		(t = n[e - 1]) instanceof je &&
		(i = n[e + 1]) instanceof je &&
		n.splice(e - 1, 3, new je(t.length + 1 + i.length));
}
const O1 = 5;
class _u {
	constructor(e, t) {
		...
		if (this.lineStart > -1) {
			...
			(r instanceof ct
				...
				: (i > this.pos || !this.isCovered) &&
					this.nodes.push(new ct(i - this.pos, -1, 0)),
				(this.writtenTo = i),
				t > i &&
	...
	point(e, t, i) {
		if (e < t || i.heightRelevant) {
			...
			let o = t - e;
			i.block
				? this.addBlock(new np(o, r, i))
				: (o || s || r >= O1) && this.addLineDeco(r, s, o);
	...
	enterLine() {
		...
		((this.lineStart = e),
			...
			this.pos > e && this.nodes.push(new ct(this.pos - e, -1, 0)),
	...
	finish(e) {
		...
		this.lineStart > -1 && !(t instanceof ct) && !this.isCovered
			? this.nodes.push(new ct(0, -1, 0))
			: (this.writtenTo < this.pos || t == null) &&
				this.nodes.push(this.blankContent(this.writtenTo, this.pos));
		let i = e;
		for (let r of this.nodes)
			(r instanceof ct && r.updateHeight(this.oracle, i),
				(i += r ? r.length : 1));
		return this.nodes;
	}
		...
		if (u.nodeType == 1) {
			...
			if (
				...
				((s = Math.max(s, f.left)),
					...
					(l = Math.max(l, f.top)),
					(a = Math.min(u == n.parentNode ? r.innerHeight : a, f.bottom)));
			}
			u =
...
class Xl {
	...
	draw(e, t) {
		return U.replace({
			widget: new S1(this.displaySize * (t ? e.scaleY : e.scaleX), t),
...
class rh {
	constructor(e, t) {
		((this.view = e),
			...
			(this.defaultTextDirection = ye.LTR),
			(this.visibleRanges = []),
			(this.mustEnforceCursorAssoc = !1));
		let i = t
			.facet(Mu)
			.some((r) => typeof r != 'function' && r.class == 'cm-lineWrapping');
		((this.heightOracle = new h1(i)),
			(this.stateDeco = oh(t)),
			(this.heightMap = Je.empty().applyChanges(
				this.stateDeco,
				Oe.empty,
				this.heightOracle.setDoc(t.doc),
				[new yt(0, 0, 0, t.doc.length)],
			)));
		for (
			let r = 0;
			r < 2 &&
		...
		return (
			(this.scaler =
				this.heightMap.height <= 7e6
					? sh
					: new Xu(this.heightOracle, this.heightMap, this.viewports)),
	...
	updateViewportLines() {
		((this.viewportLines = []),
			this.heightMap.forEachLine(
				...
				0,
				(e) => {
					this.viewportLines.push(ar(e, this.scaler));
				},
			));
	}
	update(e, t = null) {
		...
		this.stateDeco = oh(this.state);
		let r = e.changedRanges,
			s = yt.extendWithRanges(
				r,
				m1(i, this.stateDeco, e ? e.changes : Re.empty(this.state.doc.length)),
			),
		...
		(ih(),
			...
			(this.heightMap.height != o || Xn) && (e.flags |= 2),
			l
	...
	measure() {
		let { view: e } = this,
			...
			r = this.heightOracle,
			s = i.whiteSpace;
		this.defaultTextDirection = i.direction == 'rtl' ? ye.RTL : ye.LTR;
		let o =
				this.heightOracle.mustRefreshForWrapping(s) ||
		...
		let u = 0,
			c = 0;
		if (l.width && l.height) {
			let { scaleX: x, scaleY: C } = yd(t, l);
			((x > 0.005 && Math.abs(this.scaleX - x) > 0.005) ||
				(C > 0.005 && Math.abs(this.scaleY - C) > 0.005)) &&
				((this.scaleX = x), (this.scaleY = C), (u |= 16), (o = a = !0));
		}
		let h = (parseInt(i.paddingTop) || 0) * this.scaleY,
			f = (parseInt(i.paddingBottom) || 0) * this.scaleY;
		((this.paddingTop != h || this.paddingBottom != f) &&
			((this.paddingTop = h), (this.paddingBottom = f), (u |= 18)),
			this.editorWidth != e.scrollDOM.clientWidth &&
				(r.lineWrapping && (a = !0),
				(this.editorWidth = e.scrollDOM.clientWidth),
				(u |= 16)));
		let d = xd(this.view.contentDOM, !1).y;
		d != this.scrollParent &&
			((this.scrollParent = d),
			(this.scrollAnchorHeight = -1),
			(this.scrollOffset = 0));
		...
		(this.scrollOffset != p &&
			...
			(this.scrolledToBottom = Sd(this.scrollParent || e.win)));
		let O = (this.printing ? b1 : y1)(t, this.paddingTop),
		...
		if (
			(S != this.inView && ((this.inView = S), S && (a = !0)),
			!this.inView && !this.scrollTarget && !x1(e.dom))
		)
			return 0;
		let w = l.width;
		if (
			...
			if (
				...
				((o = C > 0 && r.refresh(s, C, E, B, Math.max(5, w / E), x)),
					o && ((e.docView.minWidth = 0), (u |= 16)));
			}
			(m > 0 && g > 0
				? (c = Math.max(m, g))
			...
			for (let C of this.viewports) {
				let E =
					C.from == this.viewport.from
						? x
						: e.docView.measureVisibleLineHeights(C);
				this.heightMap = (
					o
						? Je.empty().applyChanges(
								this.stateDeco,
								Oe.empty,
								this.heightOracle,
								[new yt(0, 0, 0, e.state.doc.length)],
							)
						: this.heightMap
				).updateHeight(r, 0, o, new f1(C.from, E));
			}
			Xn && (u |= 2);
		}
		let k =
		...
		return (
			...
			(u & 2 || k) && this.updateViewportLines(),
			(this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) &&
	...
	getViewport(e, t) {
		let i = 0.5 - Math.max(-0.5, Math.min(0.5, e / 1e3 / 2)),
			...
			a = new Es(
				...
				r.lineAt(l + (1 - i) * 1e3, Se.ByHeight, s, 0, 0).to,
			);
		if (t) {
			let { head: u } = t.range;
			if (u < a.from || u > a.to) {
				let c = Math.min(
					...
					h = r.lineAt(u, Se.ByPos, s, 0, 0),
					f;
				(t.y == 'center'
					? (f = (h.top + h.bottom) / 2 - c / 2)
					: t.y == 'start' || (t.y == 'nearest' && u < a.from)
						? (f = h.top)
						: (f = h.bottom - c),
					(a = new Es(
						r.lineAt(f - 1e3 / 2, Se.ByHeight, s, 0, 0).from,
						r.lineAt(f + c + 1e3 / 2, Se.ByHeight, s, 0, 0).to,
					)));
			}
		}
		return a;
	...
	mapLineGaps(e, t) {
		...
		for (let r of e)
			t.touchesRange(r.from, r.to) ||
				i.push(new Xl(t.mapPos(r.from), t.mapPos(r.to), r.size, r.displaySize));
		return i;
	}
	ensureLineGaps(e, t) {
		let i = this.heightOracle.lineWrapping,
			...
			s = r >> 1,
			o = r << 1;
		if (this.defaultTextDirection != ye.LTR && !i) return [];
		let l = [],
			a = (c, h, f, d) => {
				if (h - c < s) return;
				...
				if (!m) {
					if (
						...
						t &&
						i &&
						t.visibleRanges.some((w) => w.from <= h && w.to >= h)
					) {
						let w = t.moveToLineBoundary(T.cursor(h), !1, !0).head;
						w > c && (h = w);
					}
					let g = this.gapSize(f, c, h, d),
						S = i || g < 2e6 ? g : 2e6;
					m = new Xl(c, h, g, S);
				}
				l.push(m);
			...
			u = (c) => {
				if (c.length < o || c.type != ze.Text) return;
				let h = D1(c.from, c.to, this.stateDeco);
				if (h.total < o) return;
				...
				if (i) {
					...
					if (f != null) {
						...
						((m = (this.visibleTop - c.top - O) / c.height),
							(g = (this.visibleBottom - c.top + O) / c.height));
					((d = Ts(h, m)), (p = Ts(h, g)));
				} else {
					let O = h.total * this.heightOracle.charWidth,
					...
					if (O > 2e6)
						for (let C of e)
							C.from >= c.from &&
								C.from < c.to &&
								C.size != C.displaySize &&
								C.from * this.heightOracle.charWidth + g <
									this.pixelViewport.left &&
								(g = C.size - C.displaySize);
					let S = this.pixelViewport.left + g,
						w = this.pixelViewport.right + g,
						k,
						x;
					if (f != null) {
						let C = Zs(h, f),
...
function oh(n) {
	let e = n.facet(zo).filter((i) => typeof i != 'function'),
		t = n.facet(Ru).filter((i) => typeof i != 'function');
...
class Xu {
	constructor(e, t, i) {
		...
		((this.viewports = i.map(({ from: l, to: a }) => {
			let u = t.lineAt(l, Se.ByPos, e, 0, 0).top,
				c = t.lineAt(a, Se.ByPos, e, 0, 0).bottom;
			return (
				(r += c - u),
...
function ar(n, e) {
	...
	return new $t(
		...
		t,
		i - t,
		Array.isArray(n._content) ? n._content.map((r) => ar(r, e)) : n._content,
	);
}
const Ms = L.define({ combine: (n) => n.join(' ') }),
	Ga = L.define({ combine: (n) => n.indexOf(!0) > -1 }),
	Ua = vi.newName(),
	rp = vi.newName(),
	sp = vi.newName(),
	op = { '&light': '.' + rp, '&dark': '.' + sp };
...
const v1 = Ha(
	...
	jl = j.ie && j.ie_version <= 11;
class C1 {
	constructor(e) {
		((this.view = e),
			(this.active = !1),
			(this.editContext = null),
			(this.selectionRange = new i0()),
			...
			window.EditContext &&
				...
				!(j.chrome && j.chrome_version < 126) &&
				((this.editContext = new A1(e)),
				e.state.facet(oi) &&
	...
	onSelectionChange(e) {
		...
		if (i.state.facet(oi) ? i.root.activeElement != this.dom : !pr(this.dom, r))
			return;
		...
		r.focusNode &&
		mr(r.focusNode, r.focusOffset, r.anchorNode, r.anchorOffset)
			? this.flushSoon()
			: this.flush(!1);
	}
	readSelectionRange() {
	...
	start() {
		this.active ||
			(this.observer.observe(this.dom, Q1),
			jl &&
		...
		if (!this.delayedAndroidKey) {
			let r = () => {
				...
				s &&
					...
					!this.flush() && s.force && En(this.dom, s.key, s.keyCode));
			};
	...
	readChange() {
		let { from: e, to: t, typeOver: i } = this.processRecords(),
			r = this.selectionChanged && pr(this.dom, this.selectionRange);
		if (e < 0 && !r) return null;
		(e > -1 && (this.lastChange = Date.now()),
			(this.view.inputState.lastFocusTime = 0),
			(this.selectionChanged = !1));
		let s = new q0(this.view, e, t, i);
		return (
	...
	flush(e = !0) {
		...
		return (
			this.view.state == i &&
				(t.domChanged ||
					(t.newSel && !mo(this.view.state.selection, t.newSel.main))) &&
				this.view.update([]),
			r
		);
	}
	readMutation(e) {
		...
		if ((t.markDirty(e.type == 'attributes'), e.type == 'childList')) {
			let i = lh(t, e.previousSibling || e.target.previousSibling, -1),
				r = lh(t, e.nextSibling || e.target.nextSibling, 1);
			return {
	...
	update(e) {
		this.editContext &&
			...
			e.startState.facet(oi) != e.state.facet(oi) &&
				(e.view.contentDOM.editContext = e.state.facet(oi)
...
function ah(n, e) {
	...
	return (
		mr(o.node, o.offset, r, s) && ([t, i, r, s] = [r, s, t, i]),
...
class A1 {
	constructor(e) {
		...
		((this.handlers.textupdate = (i) => {
			...
			l == this.from && s < this.from
				? (l = s)
				: a == this.to && s > this.to && (a = s);
			let c = Nd(
			...
			if (!c) {
				...
				mo(f, r) || e.dispatch({ selection: f, userEvent: 'select' });
				return;
			}
			let h = {
				from: c.from + l,
...
`),
			...
			if (
				((j.mac || j.android) &&
					...
					(h = { from: l, to: a, insert: Oe.of([i.text.replace('.', ' ')]) }),
				...
				Fu(
					...
					h,
					T.single(
						this.toEditorPos(i.selectionStart, f),
						this.toEditorPos(i.selectionEnd, f),
					),
				);
			}
				...
				for (let s of i.getTextFormats()) {
					...
					if (!/none/i.test(o) && !/none/i.test(l)) {
						let a = this.toEditorPos(s.rangeStart),
							u = this.toEditorPos(s.rangeEnd);
						if (a < u) {
							let c = `text-decoration: underline ${/^[a-z]/.test(o) ? o + ' ' : o == 'Dashed' ? 'dashed ' : o == 'Squiggle' ? 'wavy ' : ''}${/thin/i.test(l) ? 1 : 2}px`;
							r.push(U.mark({ attributes: { style: c } }).range(a, u));
						}
					}
				}
				e.dispatch({ effects: _d.of(U.set(r)) });
			}),
	...
	applyEdits(e) {
		...
		return (
			e.changes.iterChanges((s, o, l, a, u) => {
				if (i) return;
				let c = u.length - (o - s);
				if (r && o >= r.to)
				...
				if (((s += t), (o += t), o <= this.from))
					...
					if (
						s < this.from ||
						o > this.to ||
						this.to - this.from + u.length > 3e4
					) {
						i = !0;
						return;
					}
...
class X {
	...
	constructor(e = {}) {
		...
		((this.dispatchTransactions =
			...
			(this._root = e.root || n0(e.parent) || document),
			(this.viewState = new rh(this, e.state || fe.create(e))),
			e.scrollTo &&
				e.scrollTo.is(As) &&
				(this.viewState.scrollTarget = e.scrollTo.value.clip(
					this.viewState.state,
				)),
			(this.plugins = this.state.facet(Qn).map((r) => new Ml(r))));
		for (let r of this.plugins) r.update(this);
		((this.observer = new C1(this)),
			(this.inputState = new G0(this)),
			this.inputState.ensureHandlers(this.plugins),
			(this.docView = new qc(this)),
			this.mountStyles(),
			this.updateAttrs(),
			(this.updateState = 0),
			this.requestMeasure(),
	...
	update(e) {
		...
		let o = this.hasFocus,
			l = 0,
			a = null;
		e.some((f) => f.annotation(ep))
			? ((this.inputState.notifiedFocused = o), (l = 1))
			: o != this.inputState.notifiedFocused &&
				((this.inputState.notifiedFocused = o), (a = tp(s, o)), a || (l = 1));
			...
			(u
				? (this.observer.clearDelayedAndroidKey(),
					...
					((c && !this.state.doc.eq(s.doc)) ||
						...
						(c = null))
				: this.observer.clear(),
			s.facet(fe.phrases) != this.state.facet(fe.phrases))
		)
			return this.setState(s);
		((r = fo.create(this, s, e)), (r.flags |= l));
		...
		try {
			...
			for (let f of e) {
				if ((h && (h = h.map(f.changes)), f.scrollIntoView)) {
					...
					h = new Tn(
						d.empty ? d : T.cursor(d.head, d.head > d.anchor ? -1 : 1),
					);
				}
				for (let d of f.effects) d.is(As) && (h = d.value.clip(this.state));
			}
			(this.viewState.update(r, h),
				(this.bidiCache = yo.update(this.bidiCache, r.changes)),
				r.empty || (this.updatePlugins(r), this.inputState.update(r)),
				(t = this.docView.update(r)),
				this.state.facet(lr) != this.styleModules && this.mountStyles(),
				(i = this.updateAttrs()),
		...
		if (
			(r.startState.facet(Ms) != r.state.facet(Ms) &&
			...
			for (let f of this.state.facet(Ia))
				try {
					f(r);
				} catch (d) {
			...
			Promise.resolve().then(() => {
				(a && this.state == a.startState && this.dispatch(a),
					c &&
						!Yd(this, c) &&
						u.force &&
						En(this.contentDOM, u.key, u.keyCode));
			});
	}
	setState(e) {
		if (this.updateState != 0)
		...
		try {
			...
			((this.viewState = new rh(this, e)),
				(this.plugins = e.facet(Qn).map((i) => new Ml(i))),
	...
	updatePlugins(e) {
		let t = e.startState.facet(Qn),
			i = e.state.facet(Qn);
		if (t != i) {
			let r = [];
			for (let s of i) {
				let o = t.indexOf(s);
				if (o < 0) r.push(new Ml(s));
				else {
	...
	measure(e = !0) {
		...
		(Math.abs(r - this.viewState.scrollOffset) > 1 && (o = -1),
			...
			for (let l = 0; ; l++) {
				...
				let c = u.map((d) => {
						try {
							...
							return (rt(this.state, p), uh);
						}
					}),
					h = fo.create(this, this.state, []),
					f = !1;
				((h.flags |= a),
					t ? (t.flags |= a) : (t = h),
					(this.updateState = 2),
						...
						if (this.viewState.scrollTarget) {
							...
							let p =
								((s < 0
									...
									: this.viewState.lineBlockAt(s).top) -
									o) /
								this.scaleY;
							if (
								(p > 1 || p < -1) &&
		...
		if (t && !t.empty) for (let l of this.state.facet(Ia)) l(t);
	}
	get themeClasses() {
		return (
			Ua + ' ' + (this.state.facet(Ga) ? sp : rp) + ' ' + this.state.facet(Ms)
		);
	}
	updateAttrs() {
		let e = ch(this, Xd, {
		...
		(this.state.readOnly && (t['aria-readonly'] = 'true'), ch(this, Mu, t));
		let i = this.observer.ignore(() => {
			let r = Xc(this.contentDOM, this.contentAttrs, t),
				s = Xc(this.dom, this.editorAttrs, e);
			return r || s;
		});
	...
	mountStyles() {
		...
		vi.mount(
			this.root,
			this.styleModules.concat(v1).reverse(),
			e ? { nonce: e } : void 0,
		);
	}
	readMeasured() {
	...
	moveByChar(e, t, i) {
		return _l(this, e, Vc(this, e, t, i));
	}
	moveByGroup(e, t) {
		return _l(
			this,
			e,
			Vc(this, e, t, (i) => X0(this, e.head, i)),
		);
	}
	visualLineSide(e, t) {
	...
	moveToLineBoundary(e, t, i = !0) {
		return _0(this, e, t, i);
	}
	moveVertically(e, t, i) {
		return _l(this, e, j0(this, e, t, i));
	}
	domAtPos(e, t = 1) {
	...
	coordsAtPos(e, t = 1) {
		...
		let r = this.state.doc.lineAt(e),
			s = this.bidiSpans(r),
			o = s[It.find(s, e - r.from, -1, t)];
		return Ar(i, (o.dir == ye.LTR) == t > 0);
	}
	coordsForChar(e) {
	...
	bidiSpans(e) {
		if (e.length > P1) return kd(e.length);
		...
		for (let s of this.bidiCache)
			if (
				s.from == e.from &&
				s.dir == t &&
				(s.fresh || Cd(s.isolates, (i = zc(this, e))))
			)
				return s.order;
		i || (i = zc(this, e));
		let r = h0(e.text, t, i);
		return (this.bidiCache.push(new yo(e.from, e.to, t, i, !0, r)), r);
	}
	get hasFocus() {
		var e;
		return (
	...
	scrollSnapshot() {
		...
		return As.of(new Tn(T.cursor(i.from), 'start', 'start', i.top - e, t, !0));
	}
	setTabFocusMode(e) {
		e == null
	...
	static theme(e, t) {
		let i = vi.newName(),
			r = [Ms.of(i), lr.of(Ha(`.${i}`, e))];
		return (t && t.dark && r.push(Ga.of(!0)), r);
	}
	static baseTheme(e) {
		return Ki.lowest(lr.of(Ha('.' + Ua, e, op)));
	}
	static findFromDOM(e) {
		var t;
		let i = e.querySelector('.cm-content'),
			r = (i && Ce.get(i)) || Ce.get(e);
		return ((t = r?.root) === null || t === void 0 ? void 0 : t.view) || null;
	}
}
X.styleModule = lr;
X.inputHandler = Zd;
X.clipboardInputFilter = Tu;
X.clipboardOutputFilter = Zu;
X.scrollHandler = Fd;
X.focusChangeEffect = Md;
X.perLineTextDirection = Rd;
X.exceptionSink = Td;
X.updateListener = Ia;
X.editable = oi;
X.mouseSelectionStyle = Ed;
X.dragMovesSelection = $d;
X.clickAddsSelectionRange = Pd;
X.decorations = zo;
X.blockWrappers = jd;
X.outerDecorations = Ru;
X.atomicRanges = Lr;
X.bidiIsolatedRanges = Ld;
X.scrollMargins = zd;
X.darkTheme = Ga;
X.cspNonce = L.define({ combine: (n) => (n.length ? n[0] : '') });
X.contentAttributes = Mu;
X.editorAttributes = Xd;
X.lineWrapping = X.contentAttributes.of({ class: 'cm-lineWrapping' });
X.announce = re.define();
const P1 = 4096,
	uh = {};
class yo {
	constructor(e, t, i, r, s, o) {
	...
	static update(e, t) {
		...
		let i = [],
			r = e.length ? e[e.length - 1].dir : ye.LTR;
...
const $1 = j.mac ? 'mac' : j.windows ? 'win' : j.linux ? 'linux' : 'key';
function E1(n, e) {
	const t = n.split(/-(?!$)/);
	let i = t[t.length - 1];
	i == 'Space' && (i = ' ');
...
const T1 = Ki.default(
		X.domEventHandlers({
			keydown(n, e) {
				return ap(lp(e.state), n, e, 'editor');
			},
		}),
	),
	zr = L.define({ enables: T1 }),
	hh = new WeakMap();
function lp(n) {
	let e = n.facet(zr),
		t = hh.get(e);
	return (t || hh.set(e, (t = R1(e.reduce((i, r) => i.concat(r), [])))), t);
}
function Z1(n, e, t) {
	return ap(lp(n.state), e, n, t);
}
let xi = null;
const M1 = 4e3;
function R1(n, e = $1) {
		...
		s = (o, l, a, u, c) => {
				...
				(r(S, !0),
					d[S] ||
						(d[S] = {
							...
							run: [
								(w) => {
									let k = (xi = { view: w, prefix: S, scope: o });
									return (
										setTimeout(() => {
											xi == k && (xi = null);
										}, M1),
			...
			let m =
				...
				(d[O] = {
					...
					stopPropagation: !1,
					run:
						((f = (h = d._any) === null || h === void 0 ? void 0 : h.run) ===
							null || f === void 0
							? void 0
							: f.slice()) || [],
				});
			(a && m.run.push(a),
				u && (m.preventDefault = !0),
	...
	for (let o of n) {
		...
		if (o.any)
			for (let u of l) {
				let c = t[u] || (t[u] = Object.create(null));
				c._any ||
					(c._any = { preventDefault: !1, stopPropagation: !1, run: [] });
				let { any: h } = o;
				for (let f in c) c[f].run.push((d) => h(d, Ka));
			}
		let a = o[e] || o.key;
		if (a)
			for (let u of l)
...
function ap(n, e, t, i) {
	...
	xi &&
		...
		xi.scope == i &&
		((l = xi.prefix + ' '),
		Ud.indexOf(e.keyCode) < 0 && ((u = !0), (xi = null)));
	let h = new Set(),
		f = (m) => {
			if (m) {
				for (let g of m.run)
		...
		d &&
			(f(d[l + Rs(r, e, !o)])
				...
				: o &&
					  ...
					  !(j.windows && e.ctrlKey && e.altKey) &&
					  !(j.mac && e.altKey && !(e.ctrlKey || e.metaKey)) &&
					  (p = Qi[e.keyCode]) &&
					  p != r
					? (f(d[l + Rs(p, e, !0)]) ||
							(e.shiftKey &&
								...
								f(d[l + Rs(O, e, !1)]))) &&
						(a = !0)
					: o && e.shiftKey && f(d[l + Rs(r, e, !0)]) && (a = !0),
			!a && f(d._any) && (a = !0)),
		u && (a = !0),
...
class qi {
	...
	static forRange(e, t, i) {
		if (i.empty) {
			...
			let s = up(e);
			return [
				new qi(t, r.left - s.left, r.top - s.top, null, r.bottom - r.top),
			];
		} else return B1(e, t, i);
	}
}
function up(n) {
...
function B1(n, e, t) {
	...
	let i = Math.max(t.from, n.viewport.from),
		...
		f = l.right - (c ? parseInt(c.paddingRight) : 0),
		d = Va(n, i, 1),
		p = Va(n, r, -1),
		O = d.type == ze.Text ? d : null,
		m = p.type == ze.Text ? p : null;
	if (
		(O && (n.lineWrapping || d.widgetLineBreaks) && (O = fh(n, i, 1, O)),
		m && (n.lineWrapping || p.widgetLineBreaks) && (m = fh(n, r, -1, m)),
		O && m && O.from == m.from && O.to == m.to)
	)
		return S(w(t.from, t.to, O));
	{
		let x = O ? w(t.from, null, O) : k(d, !1),
			C = m ? w(null, t.to, m) : k(p, !0),
			E = [];
		return (
			(O || d).to < (m || p).from - (O && m ? 1 : 0) ||
			(d.widgetLineBreaks > 1 && x.bottom + n.defaultLineHeight / 2 < C.top)
				? E.push(g(h, x.bottom, f, C.top))
				: x.bottom < C.top &&
					n.elementAtHeight((x.bottom + C.top) / 2).type == ze.Text &&
					(x.bottom = C.top = (x.bottom + C.top) / 2),
			S(x).concat(E).concat(S(C))
		);
	}
	function g(x, C, E, B) {
		return new qi(e, x - a.left, C - a.top, Math.max(0, E - x), B - C);
	}
	function S({ top: x, bottom: C, horizontal: E }) {
		let B = [];
		for (let v = 0; v < E.length; v += 2) B.push(g(E[v], x, E[v + 1], C));
		return B;
	}
	function w(x, C, E) {
		let B = 1e9,
			v = -1e9,
			D = [];
		function P(R, z, N, q, te) {
			let M = n.coordsAtPos(R, R == E.to ? -2 : 2),
				V = n.coordsAtPos(N, N == E.from ? 2 : -2);
			!M ||
				!V ||
				((B = Math.min(M.top, V.top, B)),
				(v = Math.max(M.bottom, V.bottom, v)),
				te == ye.LTR
					? D.push(s && z ? h : M.left, s && q ? f : V.right)
					: D.push(!s && q ? h : V.left, !s && z ? f : M.right));
		}
		let $ = x ?? E.from,
			A = C ?? E.to;
		for (let R of n.visibleRanges)
			if (R.to > $ && R.from < A)
				for (let z = Math.max(R.from, $), N = Math.min(R.to, A); ; ) {
					let q = n.state.doc.lineAt(z);
					for (let te of n.bidiSpans(q)) {
						let M = te.from + q.from,
							V = te.to + q.from;
						if (M >= N) break;
						V > z &&
							P(
					...
					if (((z = q.to + 1), z >= N)) break;
				}
		return (
			D.length == 0 && P($, x == null, A, C == null, n.textDirection),
			{ top: B, bottom: v, horizontal: D }
		);
	}
	function k(x, C) {
		let E = l.top + (C ? x.top : x.bottom);
...
class _1 {
	...
	update(e) {
		(e.startState.facet(eo) != e.state.facet(eo) && this.setOrder(e.state),
...
const eo = L.define();
function cp(n) {
	return [ke.define((e) => new _1(e, n)), eo.of(n)];
}
const jn = L.define({
	combine(n) {
		return Ut(
...
function hp(n = {}) {
	return [jn.of(n), X1, j1, L1, Bd.of(!0)];
}
function fp(n) {
...
const X1 = cp({
	...
	markers(n) {
		...
		for (let r of e.selection.ranges) {
			...
			if (
				r.empty ||
				(t.drawRangeCursor && !(s && j.ios && t.iosSelectionHandles))
			) {
				let o = s
						? 'cm-cursor cm-cursor-primary'
						: 'cm-cursor cm-cursor-secondary',
					l = r.empty ? r : T.cursor(r.head, r.assoc);
				for (let a of qi.forRange(n, o, l)) i.push(a);
			}
		}
		return i;
	},
...
const j1 = cp({
		...
		markers(n) {
			...
			for (let r of i)
				if (!r.empty)
					for (let s of qi.forRange(n, 'cm-selectionBackground', r)) e.push(s);
			if (j.ios && !t.empty && n.state.facet(jn).iosSelectionHandles) {
				for (let r of qi.forRange(
					n,
		...
		update(n, e) {
			return n.docChanged || n.selectionSet || n.viewportChanged || fp(n);
		},
	...
	ur = Ve.define({
		...
		update(n, e) {
			return (
				...
				e.effects.reduce((t, i) => (i.is(dp) ? i.value : t), n)
			);
		},
	}),
	z1 = ke.fromClass(
		class {
			...
			setDropPos(n) {
				this.view.state.field(ur) != n &&
					this.view.dispatch({ effects: dp.of(n) });
			}
		},
		{
			eventObservers: {
...
class q1 {
	constructor(e) {
		...
		else if (i) this.addMatch = (l, a, u, c) => c(u, u + l[0].length, i);
		else
			throw new RangeError(
	...
	createDeco(e) {
		let t = new hi(),
			i = t.add.bind(t);
		for (let { from: r, to: s } of I1(e, this.maxLength))
			...
			if (l >= o) {
				...
				if (a == u)
					for (
						...
						(d = this.regexp.exec(a.text)) && d.index < h - a.from;
					)
						this.addMatch(d, e, d.index + a.from, p);
				else
					ph(e.state.doc, this.regexp, c, h, (O, m) =>
...
function N1() {
	var n;
	if (Ll == null && typeof document < 'u' && document.body) {
		let e = document.body.style;
		Ll = ((n = e.tabSize) !== null && n !== void 0 ? n : e.MozTabSize) != null;
	}
	return Ll || !1;
}
const to = L.define({
	combine(n) {
		let e = Ut(n, { render: null, specialChars: V1, addSpecialChars: null });
		return (
			(e.replaceTabs = !N1()) &&
				(e.specialChars = new RegExp('	|' + e.specialChars.source, Ja)),
			e.addSpecialChars &&
			...
			class {
				constructor(n) {
					((this.view = n),
						...
						(this.decorator = this.makeDecorator(n.state.facet(to))),
					...
					return new q1({
						...
						decoration: (e, t, i) => {
							...
							return (
								...
								(this.decorationCache[s] = U.replace({ widget: new K1(n, s) }))
							);
						},
				...
				update(n) {
					let e = n.state.facet(to);
					n.startState.facet(to) != e
...
const U1 = '•';
function H1(n) {
	return n >= 32 ? U1 : n == 10 ? '␤' : String.fromCharCode(9216 + n);
}
class K1 extends Ht {
	constructor(e, t) {
	...
	toDOM(e) {
		let t = H1(this.code),
			i =
				...
				' ' +
				(Y1[this.code] || '0x' + this.code.toString(16)),
...
const ey = U.line({ class: 'cm-activeLine' }),
	ty = ke.fromClass(
		class {
			constructor(n) {
			...
			getDeco(n) {
				...
				for (let i of n.state.selection.ranges) {
					...
					r.from > e && (t.push(ey.range(r.from)), (e = r.from));
				}
				return U.set(t);
			}
		},
...
class iy extends Ht {
	...
	coordsAt(e) {
		let t = e.firstChild ? Or(e.firstChild) : [];
		if (!t.length) return null;
		let i = window.getComputedStyle(e.parentNode),
			r = Ar(t[0], i.direction != 'rtl'),
...
function ny(n) {
	let e = ke.fromClass(
		class {
			constructor(t) {
				((this.view = t),
					(this.placeholder = n
						? U.set([U.widget({ widget: new iy(n), side: 1 }).range(0)])
						: U.none));
			}
			get decorations() {
	...
	return typeof n == 'string'
		? [e, X.contentAttributes.of({ 'aria-placeholder': n })]
		: e;
}
const eu = 2e3;
function ry(n, e, t) {
	let i = Math.min(e.line, t.line),
		...
		s = [];
	if (e.off > eu || t.off > eu || e.col < 0 || t.col < 0) {
		let o = Math.min(e.off, t.off),
			l = Math.max(e.off, t.off);
		for (let a = i; a <= r; a++) {
			let u = n.doc.line(a);
			u.length <= l && s.push(T.range(u.from + o, u.to + l));
		}
	} else {
		...
		for (let a = i; a <= r; a++) {
			let u = n.doc.line(a),
				c = Za(u.text, o, n.tabSize, !0);
			if (c < 0) s.push(T.cursor(u.to));
			else {
				let h = Za(u.text, l, n.tabSize);
				s.push(T.range(u.from + c, u.from + h));
			}
		}
	}
	return s;
	...
	let t = n.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
		...
		s =
			r > eu
				...
				: r == i.length
					? sy(n, e.clientX)
					: Wn(i.text, n.state.tabSize, t - i.from);
	...
	return t
		? {
				...
				get(r, s, o) {
					let l = mh(n, r);
					if (!l) return i;
					let a = ry(n.state, t, l);
					return a.length
						? o
							? T.create(a.concat(i.ranges))
							: T.create(a)
						: i;
				},
			}
...
function ly(n) {
	...
	return X.mouseSelectionStyle.of((t, i) => (e(i) ? oy(t, i) : null));
}
const ay = {
		Alt: [18, (n) => !!n.altKey],
		...
		class {
			...
			readMeasure() {
				...
				if (this.position == 'fixed' && this.manager.tooltipViews.length) {
					...
					if (j.safari) {
						...
						t =
							!!s.offsetParent &&
							s.offsetParent != this.container.ownerDocument.body;
				}
			...
			writeMeasure(n) {
				...
				for (let l = 0; l < this.manager.tooltips.length; l++) {
					...
					if (
						!h ||
						(a.clip !== !1 &&
							(h.bottom <= Math.max(t.top, i.top) ||
								h.top >= Math.min(t.bottom, i.bottom) ||
								h.right < Math.max(t.left, i.left) - 0.1 ||
								h.left > Math.min(t.right, i.right) + 0.1))
					) {
						c.style.top = Bs;
						continue;
					}
					let d = a.arrow ? u.dom.querySelector('.cm-tooltip-arrow') : null,
						p = d ? 7 : 0,
						O = f.right - f.left,
						m = (e = gh.get(u)) !== null && e !== void 0 ? e : f.bottom - f.top,
						g = u.offset || dy,
						S = this.view.textDirection == ye.LTR,
						w =
							f.width > i.right - i.left
								...
								: S
									? Math.max(
											i.left,
											Math.min(h.left - (d ? 14 : 0) + g.x, i.right - O),
										)
									: Math.min(
											Math.max(i.left, h.left - O + (d ? 14 : 0) - g.x),
											i.right - O,
										),
						k = this.above[l];
					!a.strictSide &&
						(k
							? h.top - m - p - g.y < i.top
							: h.bottom + m + p + g.y > i.bottom) &&
						k == i.bottom - h.bottom > h.top - i.top &&
						(k = this.above[l] = !k);
					let x = (k ? h.top - i.top : i.bottom - h.bottom) - p;
					if (x < m && u.resize !== !1) {
						if (x < this.view.defaultLineHeight) {
							c.style.top = Bs;
							continue;
						}
						(gh.set(u, m), (c.style.height = (m = x) / s + 'px'));
					} else c.style.height && (c.style.height = '');
					let C = k ? h.top - m - p - g.y : h.bottom + p + g.y,
						E = w + O;
					if (u.overlap !== !0)
						for (let B of o)
							B.left < E &&
								...
								B.top < C + m &&
								B.bottom > C &&
								(C = k ? B.top - m - 2 - p : B.bottom + p + 2);
					if (
						(this.position == 'absolute'
							? ((c.style.top = (C - n.parent.top) / s + 'px'),
								yh(c, (w - n.parent.left) / r))
							: ((c.style.top = C / s + 'px'), yh(c, w / r)),
						d)
					) {
						let B = h.left + (S ? g.x : -g.x) - (w + 14 - 7);
						d.style.left = B / r + 'px';
					}
					(u.overlap !== !0 &&
						o.push({ left: w, top: C, right: E, bottom: C + m }),
			...
			maybeMeasure() {
				if (
					...
					for (let n of this.manager.tooltipViews) n.dom.style.top = Bs;
			}
		},
		{
			eventObservers: {
...
const fy = X.baseTheme({
	...
	dy = { x: 0, y: 0 },
	Lu = L.define({ enables: [ju, fy] }),
	xo = L.define({ combine: (n) => n.reduce((e, t) => e.concat(t), []) });
class Vo {
	static create(e) {
		return new Vo(e);
	}
...
class Oy {
	...
	get tooltip() {
		let e = this.view.plugin(ju),
			t = e ? e.manager.tooltips.findIndex((i) => i.create == Vo.create) : -1;
	...
	mousemove(e) {
		...
		if ((r.length && s && !my(s.dom, e)) || this.pending) {
			let { pos: o } = r[0] || this.pending,
				l =
					(i = (t = r[0]) === null || t === void 0 ? void 0 : t.end) !== null &&
					i !== void 0
						? i
						: o;
			(o == l
				? this.view.posAtCoords(this.lastMove) != o
				: !gy(this.view, o, l, e.clientX, e.clientY)) &&
...
function yy(n, e = {}) {
	...
	return {
		...
		extension: [
			i,
			ke.define((r) => new Oy(r, n, i, t, e.hoverTime || 300)),
			py,
		],
	};
}
...
const yp = ke.fromClass(
	class {
		constructor(n) {
			((this.input = n.state.facet($r)),
				(this.specs = this.input.filter((t) => t)),
				(this.panels = this.specs.map((t) => t(n))));
			let e = n.state.facet(xh);
			((this.top = new _s(n, !0, e.topContainer)),
				(this.bottom = new _s(n, !1, e.bottomContainer)),
		...
		update(n) {
			...
			(this.top.container != e.topContainer &&
				(this.top.sync([]), (this.top = new _s(n.view, !0, e.topContainer))),
				this.bottom.container != e.bottomContainer &&
					(this.bottom.sync([]),
					(this.bottom = new _s(n.view, !1, e.bottomContainer))),
				this.top.syncClasses(),
				this.bottom.syncClasses());
			let t = n.state.facet($r);
			if (t != this.input) {
				let i = t.filter((a) => a),
					r = [],
					s = [],
				...
				for (let a of i) {
					...
					(u < 0
						? ((c = a(n.view)), l.push(c))
						: ((c = this.panels[u]), c.update && c.update(n)),
						r.push(c),
						(c.top ? s : o).push(c));
				}
				((this.specs = i),
...
const $r = L.define({ enables: yp });
function by(n, e) {
	let t,
		i = new Promise((o) => (t = o)),
		r = (o) => Sy(o, e, t);
	n.state.field(Wl, !1)
		? n.dispatch({ effects: xp.of(r) })
		: n.dispatch({ effects: re.appendConfig.of(Wl.init(() => [r])) });
	let s = bp.of(r);
	return {
		close: s,
		result: i.then(
			(o) => (
				(n.win.queueMicrotask || ((a) => n.win.setTimeout(a, 10)))(() => {
					n.state.field(Wl).indexOf(r) > -1 && n.dispatch({ effects: s });
				}),
				o
			),
		),
...
const Wl = Ve.define({
		...
		update(n, e) {
			for (let t of e.effects)
				t.is(xp)
					? (n = [t.value].concat(n))
					: t.is(bp) && (n = n.filter((i) => i != t.value));
			return n;
		},
		provide: (n) => $r.computeN([n], (e) => e.field(n)),
	}),
	xp = re.define(),
	bp = re.define();
function Sy(n, e, t) {
	...
	if (!i) {
		if (((i = me('form')), e.input)) {
			let l = me('input', e.input);
			(/^(text|password|number|email|tel|url)$/.test(l.type) &&
				l.classList.add('cm-textfield'),
				l.name || (l.name = 'input'),
				i.appendChild(me('label', (e.label || '') + ': ', l)));
	...
	for (let l = 0; l < r.length; l++) {
		...
		(a.addEventListener('keydown', (u) => {
			u.keyCode == 27
				...
				: u.keyCode == 13 && (u.preventDefault(), o(a));
		}),
			a.addEventListener('submit', (u) => {
				(u.preventDefault(), o(a));
			}));
	}
	let s = me(
		'div',
...
di.prototype.elementClass = '';
di.prototype.toDOM = void 0;
di.prototype.mapMode = He.TrackBefore;
...
const io = L.define(),
	...
	yr = L.define();
function vy(n) {
	return [Sp(), yr.of({ ...wy, ...n })];
}
const Sh = L.define({ combine: (n) => n.some((e) => e) });
function Sp(n) {
	return [Qy];
}
const Qy = ke.fromClass(
	class {
		constructor(n) {
			((this.view = n),
				(this.domAfter = null),
				...
				(this.gutters = n.state.facet(yr).map((e) => new wh(n, e))),
				(this.fixed = !n.state.facet(Sh)));
		...
		update(n) {
			...
			(this.view.state.facet(Sh) != !this.fixed &&
		...
		syncGutters(n) {
			...
			let t = ce.iter(this.view.state.facet(io), this.view.viewport.from),
				i = [],
				r = this.gutters.map(
					(s) => new Cy(s, this.view.viewport, -this.view.documentPadding.top),
				);
...
class Cy {
	...
	line(e, t, i) {
		let r = [];
		(tu(this.cursor, r, t.from), i.length && (r = r.concat(i)));
...
class wh {
	constructor(e, t) {
		...
		((this.markers = Dh(t.markers(e))),
			t.initialSpacer &&
				((this.spacer = new Dp(e, 0, 0, [t.initialSpacer(e)])),
	...
	update(e) {
		let t = this.markers;
		if (
			((this.markers = Dh(this.config.markers(e.view))),
		...
		return (
			!ce.eq(this.markers, t, i.from, i.to) ||
...
class Dp {
	...
	update(e, t, i, r) {
		(this.height != t &&
			...
			ky(this.markers, r) || this.setMarkers(e, r));
	}
	setMarkers(e, t) {
		...
		for (let s = 0, o = 0; ; ) {
			...
			if (!a) break;
			(a.toDOM &&
				(u ? (r = r.nextSibling) : this.dom.insertBefore(a.toDOM(e), r)),
				u && o++);
		}
...
const $y = yr.compute([Cn], (n) => ({
	class: 'cm-lineNumbers',
	renderEmptyElements: !1,
	markers(e) {
		return e.state.facet(Ay);
	},
	lineMarker(e, t, i) {
		return i.some((r) => r.toDOM)
			? null
			: new Il(ql(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, i) => {
		for (let r of e.state.facet(Py)) {
			let s = r(e, t, i);
			if (s) return s;
		}
		return null;
	...
	initialSpacer(e) {
		return new Il(ql(e, vh(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let i = ql(t.view, vh(t.view.state.doc.lines));
...
const Ey = new (class extends di {
		constructor() {
			(super(...arguments), (this.elementClass = 'cm-activeLineGutter'));
		}
	})(),
	Ty = io.compute(['selection'], (n) => {
		let e = [],
			t = -1;
		for (let i of n.selection.ranges) {
			let r = n.doc.lineAt(i.head).from;
			r > t && ((t = r), e.push(Ey.range(r)));
		}
		return ce.of(e);
	});
function vp() {
...
class ue {
	...
	add(e) {
		...
		return (
			typeof e != 'function' && (e = lt.match(e)),
			(t) => {
				let i = e(t);
...
class lt {
	...
	static define(e) {
		let t = e.props && e.props.length ? Object.create(null) : My,
			i =
				(e.top ? 1 : 0) |
				(e.skipped ? 2 : 0) |
				(e.error ? 4 : 0) |
				(e.name == null ? 8 : 0),
			r = new lt(e.name || '', t, e.id, i);
		if (e.props) {
		...
		for (let i of this.types) {
			...
			for (let s of e) {
				...
				if (o) {
					...
					let l = o[1],
						a = o[0];
					(a.combine && a.id in r && (l = a.combine(r[a.id], l)),
						(r[a.id] = l));
				}
			}
			t.push(r ? new lt(i.name, r, i.id, i.flags) : i);
		}
		return new Wu(t);
	}
}
...
class Te {
	...
	cursor(e = 0) {
		return new nu(this.topNode, e);
	}
	cursorAt(e, t = 0, i = 0) {
		let r = Xs.get(this) || this.topNode,
			s = new nu(r);
		return (s.moveTo(e, t), Xs.set(this, s._tree), s);
	}
	get topNode() {
		return new St(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let i = Er(Xs.get(this) || this.topNode, e, t, !1);
		return (Xs.set(this, i), i);
	}
	resolveInner(e, t = 0) {
		let i = Er(Qh.get(this) || this.topNode, e, t, !0);
		return (Qh.set(this, i), i);
	}
	resolveStack(e, t = 0) {
		return Fy(this, e, t);
	}
	iterate(e) {
		let { enter: t, leave: i, from: r = 0, to: s = this.length } = e,
			o = e.mode || 0,
			l = (o & Qe.IncludeAnonymous) > 0;
		for (let a = this.cursor(o | Qe.IncludeAnonymous); ; ) {
			let u = !1;
			if (
				a.from <= s &&
				a.to >= r &&
	...
	balance(e = {}) {
		return this.children.length <= 8
			...
			: Vu(
					...
					0,
					this.length,
					(t, i, r) => new Te(this.type, t, i, r, this.propValues),
					e.makeTree || ((t, i, r) => new Te(lt.none, t, i, r)),
				);
	}
	static build(e) {
		return _y(e);
...
class ki {
	...
	findChild(e, t, i, r, s) {
		...
		for (
			let a = e;
			a != t && !(Cp(s, r, o[a + 1], o[a + 2]) && ((l = a), i > 0));
			a = o[a + 3]
		);
		return l;
	}
...
function Er(n, e, t, i) {
	for (
		...
		let o = !i && n instanceof St && n.index < 0 ? null : n.parent;
		if (!o) return n;
		n = o;
	}
	let s = i ? 0 : Qe.IgnoreOverlays;
	if (i)
		for (let o = n, l = o.parent; l; o = l, l = o.parent)
			o instanceof St &&
				o.index < 0 &&
				((r = l.enter(e, t, s)) === null || r === void 0 ? void 0 : r.from) !=
					o.from &&
				(n = l);
	for (;;) {
		let o = n.enter(e, t, s);
...
class St extends kp {
	...
	nextChild(e, t, i, r, s = 0) {
		for (let o = this; ; ) {
			for (
				let { children: l, positions: a } = o._tree, u = t > 0 ? l.length : -1;
				e != u;
				e += t
			) {
				let c = l[e],
				...
				if (
					...
					if (c instanceof ki) {
						...
						let d = c.findChild(0, c.buffer.length, t, i - h, r);
						if (d > -1) return new Si(new Ry(o, c, e, h), null, d);
					} else if (s & Qe.IncludeAnonymous || !c.type.isAnonymous || qu(c)) {
						let d;
						if (!(s & Qe.IgnoreMounts) && (d = xr.get(c)) && !d.overlay)
							return new St(d.tree, h, e, o);
						let p = new St(c, h, e, o);
						return s & Qe.IncludeAnonymous || !p.type.isAnonymous
							? p
							: p.nextChild(t < 0 ? c.children.length - 1 : 0, t, i, r, s);
					}
				}
			}
			if (
				s & Qe.IncludeAnonymous ||
				!o.type.isAnonymous ||
				(o.index >= 0
					? (e = o.index + t)
	...
	enter(e, t, i = 0) {
		let r;
		if (!(i & Qe.IgnoreOverlays) && (r = xr.get(this._tree)) && r.overlay) {
			let s = e - this.from,
				o = i & Qe.EnterBracketed && r.bracketed;
			for (let { from: l, to: a } of r.overlay)
				if ((t > 0 || o ? l <= s : l < s) && (t < 0 || o ? a >= s : a > s))
					return new St(r.tree, r.overlay[0].from + this.from, -1, this);
		}
...
class Si extends kp {
	...
	child(e, t, i) {
		...
		return s < 0 ? null : new Si(this.context, this, s);
	}
	get firstChild() {
	...
	get nextSibling() {
		...
		return t <
			...
			? new Si(this.context, this._parent, t)
...
function Ap(n) {
	...
	let i = t instanceof St && t.index < 0 ? null : t.parent,
		r = n.slice();
	return (i ? (r[e] = i) : r.splice(e, 1), new By(r, t));
}
class By {
	constructor(e, t) {
...
function Fy(n, e, t) {
	let i = n.resolveInner(e, t),
		r = null;
	for (let s = i instanceof St ? i : i.context.parent; s; s = s.parent)
		if (s.index < 0) {
			let o = s.parent;
			...
			if (
				...
				let l = new St(o.tree, o.overlay[0].from + s.from, -1, s);
...
class nu {
	...
	get node() {
		...
		for (let r = i; r < this.stack.length; r++)
			t = new Si(this.buffer, t, this.stack[r]);
	...
	matchContext(e) {
		if (!this.buffer) return iu(this.node.parent, e);
		let { buffer: t } = this.buffer,
			{ types: i } = t.set;
		for (let r = e.length - 1, s = this.stack.length - 1; r >= 0; s--) {
			if (s < 0) return iu(this._tree, e, r);
...
function qu(n) {
	return n.children.some(
		(e) => e instanceof ki || !e.type.isAnonymous || qu(e),
	);
}
function _y(n) {
	var e;
	let {
			buffer: t,
			nodeSet: i,
			maxBufferLength: r = Qp,
			reused: s = [],
			minRepeatType: o = i.types.length,
		} = n,
		l = Array.isArray(t) ? new Iu(t, t.length) : t,
		a = i.types,
		u = 0,
		c = 0;
	function h(x, C, E, B, v, D) {
		let { id: P, start: $, end: A, size: R } = l,
			z = c,
			N = u;
		if (R < 0)
			if ((l.next(), R == -1)) {
		...
		let q = a[P],
			...
			M,
			V = $ - x;
		if (A - $ <= r && (M = m(l.pos - C, v))) {
			let se = new Uint16Array(M.size - M.skip),
				Q = l.pos - M.size,
				F = se.length;
			for (; l.pos > Q; ) F = g(M.start, se, F);
			((te = new ki(se, A - M.start, i)), (V = M.start - x));
		} else {
			let se = l.pos - R;
			l.next();
			let Q = [],
			...
			for (; l.pos > se; )
				Y >= 0 && l.id == Y && l.size >= 0
					? (l.end <= K - r &&
							(p(Q, F, $, G, l.end, K, Y, z, N), (G = Q.length), (K = l.end)),
						l.next())
					: D > 2500
						? f($, se, Q, F)
						: h($, se, Q, F, Y, D + 1);
			if (
				(Y >= 0 && G > 0 && G < Q.length && p(Q, F, $, G, $, K, Y, z, N),
				Q.reverse(),
				F.reverse(),
				Y > -1 && G > 0)
			) {
				let le = d(q, N);
				te = Vu(q, Q, F, 0, Q.length, 0, A - $, le, le);
			} else te = O(q, Q, F, A - $, z - A, N);
		}
		(E.push(te), B.push(V));
	}
	function f(x, C, E, B) {
		let v = [],
			...
			P = -1;
		for (; l.pos > C; ) {
			let { id: $, start: A, end: R, size: z } = l;
			if (z > 4) l.next();
			else {
				if (P > -1 && A < P) break;
				(P < 0 && (P = R - r), v.push($, A, R), D++, l.next());
			}
		}
		if (D) {
			let $ = new Uint16Array(D * 4),
				A = v[v.length - 2];
			for (let R = v.length - 3, z = 0; R >= 0; R -= 3)
				(($[z++] = v[R]),
					($[z++] = v[R + 1] - A),
					($[z++] = v[R + 2] - A),
					($[z++] = z));
			(E.push(new ki($, v[2] - A, i)), B.push(A - x));
		}
	}
	function d(x, C) {
		return (E, B, v) => {
			let D = 0,
				...
				$,
				A;
			if (P >= 0 && ($ = E[P]) instanceof Te) {
				if (!P && $.type == x && $.length == v) return $;
				(A = $.prop(ue.lookAhead)) && (D = B[P] + $.length + A);
			}
			return O(x, E, B, v, D, C);
		};
	}
	function p(x, C, E, B, v, D, P, $, A) {
		let R = [],
			z = [];
		for (; x.length > B; ) (R.push(x.pop()), z.push(C.pop() + E - v));
		(x.push(O(i.types[P], R, z, D - v, $ - D, A)), C.push(v - E));
	}
	function O(x, C, E, B, v, D, P) {
		if (D) {
			let $ = [ue.contextHash, D];
			P = P ? [$].concat(P) : [$];
		}
		if (v > 25) {
			let $ = [ue.lookAhead, v];
	...
	function m(x, C) {
		...
		e: for (let A = E.pos - x; E.pos > A; ) {
			...
			let z = E.pos - R;
			if (R < 0 || z < A || E.start < P) break;
			let N = E.id >= o ? 4 : 0,
				q = E.start;
			for (E.next(); E.pos > z; ) {
				if (E.size < 0)
					if (E.size == -3 || E.size == -4) N += 4;
					else break e;
				else E.id >= o && (N += 4);
				E.next();
			}
		...
		return (
			(C < 0 || B == x) && (($.size = B), ($.start = v), ($.skip = D)),
			$.size > 4 ? $ : void 0
		);
	}
	function g(x, C, E) {
		let { id: B, start: v, end: D, size: P } = l;
		if ((l.next(), P >= 0 && B < o)) {
			let $ = E;
			if (P > 4) {
				let A = l.pos - (P - 4);
				for (; l.pos > A; ) E = g(x, C, E);
			}
			((C[--E] = $), (C[--E] = D - x), (C[--E] = v - x), (C[--E] = B));
		} else P == -3 ? (u = B) : P == -4 && (c = B);
		return E;
	}
	let S = [],
		w = [];
	for (; l.pos > 0; ) h(n.start || 0, n.bufferStart || 0, S, w, -1, 0);
	let k =
		(e = n.length) !== null && e !== void 0
			...
			: S.length
				? w[0] + S[0].length
				: 0;
	return new Te(a[n.topID], S.reverse(), w.reverse(), k);
}
const kh = new WeakMap();
function no(n, e) {
	if (!n.isAnonymous || e instanceof ki || e.type != n) return 1;
	let t = kh.get(e);
	if (t == null) {
		t = 1;
...
function Vu(n, e, t, i, r, s, o, l, a) {
	let u = 0;
	for (let p = i; p < r; p++) u += no(n, e[p]);
	...
	function d(p, O, m, g, S) {
		for (let w = m; w < g; ) {
			...
			if (w == k + 1) {
				if (C > c) {
					let E = p[k];
					d(E.children, E.positions, 0, E.children.length, O[k] + S);
					continue;
				}
				h.push(p[k]);
			} else {
				let E = O[w - 1] + p[w - 1].length - x;
				h.push(Vu(n, p, O, k, w, x, E, null, a));
			}
			f.push(x + S - s);
		}
	}
	return (d(e, t, i, r, 0), (l || a)(h, f, o));
}
class Vi {
	...
	static addTree(e, t = [], i = !1) {
		let r = [new Vi(0, e.length, e, 0, !1, i)];
				...
				for (; o && o.from < h; ) {
					...
					if (a >= f.from || h <= f.to || u) {
						let d = Math.max(f.from, a) - u,
							p = Math.min(f.to, h) - u;
						f = d >= p ? null : new Vi(d, p, f.tree, f.offset + u, l > 0, !!c);
					}
					if ((f && r.push(f), o.to > h)) break;
...
class Pp {
	startParse(e, t, i) {
		return (
			typeof e == 'string' && (e = new Xy(e)),
			(i = i
				? i.length
					? i.map((r) => new Vl(r.from, r.to))
					: [new Vl(0, 0)]
				: [new Vl(0, e.length)]),
...
class bo {
	constructor(e) {
		((this.name = e), (this.instances = []), (this.id = Ly++));
	}
	static get(e, t) {
		if (!t.length) return e;
		let i = t[0].instances.find((l) => l.base == e && zy(t, l.modified));
		if (i) return i;
		let r = [],
			s = new gt(e.name, r, e, t);
		for (let l of t) l.instances.push(s);
		let o = Wy(t);
		for (let l of e.set)
			if (!l.modified.length) for (let a of o) r.push(bo.get(l, a));
		return s;
	}
}
function zy(n, e) {
	...
	for (let t in n) {
		...
		for (let r of t.split(' '))
			if (r) {
				...
				let c = new Tr(i, o, a > 0 ? s.slice(0, a) : null);
				e[u] = c.sort(e[u]);
			}
	}
	return Ep.add(e);
...
function qy(n, e, t, i = 0, r = n.length) {
	let s = new Vy(i, Array.isArray(e) ? e : [e], t);
...
class Vy {
	...
	highlightRange(e, t, i, r, s) {
		...
		if (
			(h &&
				(u && (u += ' '), (u += h), c.mode == 1 && (r += (r ? ' ' : '') + h)),
			this.startSpan(Math.max(t, l), u),
			c.opaque)
		)
			return;
		let f = e.tree && e.tree.prop(ue.mounted);
		if (f && f.overlay) {
			...
			do
				if (!(e.to <= t)) {
					...
					(this.highlightRange(e, t, i, r, s),
						this.startSpan(Math.min(i, e.to), u));
				}
			while (e.nextSibling());
			e.parent();
		}
...
const _ = gt.define,
	...
	y = {
		...
		unit: _(_t),
		modifier: _(_t),
		operatorKeyword: _(_t),
		controlKeyword: _(_t),
		definitionKeyword: _(_t),
		moduleKeyword: _(_t),
		operator: Xt,
		derefOperator: _(Xt),
		arithmeticOperator: _(Xt),
		logicOperator: _(Xt),
		bitwiseOperator: _(Xt),
		compareOperator: _(Xt),
		updateOperator: _(Xt),
		definitionOperator: _(Xt),
		typeOperator: _(Xt),
		controlOperator: _(Xt),
		punctuation: ru,
		separator: _(ru),
		bracket: nr,
		angleBracket: _(nr),
...
const kn = new ue();
function Ny(n) {
	return L.define({ combine: n ? (e) => e.concat(n) : void 0 });
}
const Gy = new ue();
class Tt {
	constructor(e, t, i = [], r = '') {
		((this.data = e),
			(this.name = r),
			fe.prototype.hasOwnProperty('tree') ||
				Object.defineProperty(fe.prototype, 'tree', {
					get() {
						return qe(this);
					},
				}),
	...
	isActiveAt(e, t, i = -1) {
		return $h(e, t, i).type.prop(kn) == this.data;
	}
	findRegions(e) {
		let t = e.facet(Ai);
		...
		let i = [],
			r = (s, o) => {
				if (s.prop(kn) == this.data) {
					i.push({ from: o, to: o + s.length });
					return;
				}
				let l = s.prop(ue.mounted);
				if (l) {
					if (l.tree.prop(kn) == this.data) {
						if (l.overlay)
...
Tt.setState = re.define();
function $h(n, e, t) {
	let i = n.facet(Ai),
		r = qe(n).topNode;
	if (!i || i.allowsNesting)
		for (let s = r; s; s = s.enter(e, t, Qe.ExcludeBuffers | Qe.EnterBracketed))
			s.type.isTop && (r = s);
	return r;
}
class So extends Tt {
	...
	static define(e) {
		let t = Ny(e.languageData);
		return new So(
			t,
			e.parser.configure({ props: [kn.add((i) => (i.isTop ? t : void 0))] }),
			e.name,
		);
	}
	configure(e, t) {
		return new So(this.data, this.parser.configure(e), t || this.name);
	}
	get allowsNesting() {
...
class Do {
	...
	static create(e, t, i) {
		return new Do(e, t, [], Te.empty, 0, i, [], null);
	}
	startParse() {
		return this.parser.startParse(new Uy(this.state.doc), this.fragments);
	}
	work(e, t) {
		return (
			t != null && t >= this.state.doc.length && (t = void 0),
			this.tree != Te.empty && this.isDone(t ?? this.state.doc.length)
				? (this.takeTree(), !0)
				: this.withContext(() => {
						var i;
						if (typeof e == 'number') {
							...
							if (r)
								if (
									((this.fragments = this.withoutTempSkipped(
										Vi.addTree(r, this.fragments, this.parse.stoppedAt != null),
									)),
									(this.treeLen =
	...
	takeTree() {
		...
		this.parse &&
			...
			(this.tree = t),
			(this.fragments = this.withoutTempSkipped(
				Vi.addTree(this.tree, this.fragments, !0),
			)),
			(this.parse = null));
	}
	withContext(e) {
	...
	withoutTempSkipped(e) {
		for (let t; (t = this.tempSkipped.pop()); ) e = Eh(e, t.from, t.to);
		return e;
	}
	changes(e, t) {
		...
		if ((this.takeTree(), !e.empty)) {
			let a = [];
			if (
				(e.iterChangedRanges((u, c, h, f) =>
					a.push({ fromA: u, toA: c, fromB: h, toB: f }),
				),
				(i = Vi.applyChanges(i, a)),
				(r = Te.empty),
				(s = 0),
		...
		return new Do(this.parser, t, i, r, s, o, l, this.scheduleOn);
	}
	updateViewport(e) {
		...
		for (let i = 0; i < this.skipped.length; i++) {
			...
			r < e.to &&
				s > e.from &&
				((this.fragments = Eh(this.fragments, r, s)),
			...
			createParse(t, i, r) {
				...
				return {
					...
					advance() {
						...
						return ((this.parsedPos = o), new Te(lt.none, [], [], o - s));
					},
					stoppedAt: null,
					stopAt() {},
				};
...
function Eh(n, e, t) {
	return Vi.applyChanges(n, [{ fromA: e, toA: t, fromB: e, toB: t }]);
}
class Ln {
	constructor(e) {
	...
	static init(e) {
		let t = Math.min(3e3, e.doc.length),
			i = Do.create(e.facet(Ai).parser, e, { from: 0, to: t });
...
Tt.state = Ve.define({
	create: Ln.init,
	update(n, e) {
		for (let t of e.effects) if (t.is(Tt.setState)) return t.value;
		return e.startState.facet(Ai) != e.state.facet(Ai)
			? Ln.init(e.state)
			: n.apply(e);
	},
});
...
const Gl =
		typeof navigator < 'u' &&
		!((Nl = navigator.scheduling) === null || Nl === void 0) &&
		Nl.isInputPending
	...
	Hy = ke.fromClass(
		class {
			...
			update(e) {
				let t = this.view.state.field(Tt.state).context;
			...
			work(e) {
				...
				let o =
						...
						Math.min(
							this.chunkBudget,
							100,
							e && !Gl ? Math.max(25, e.timeRemaining() - 5) : 1e9,
						),
				...
				((this.chunkBudget -= Date.now() - t),
					(a || this.chunkBudget <= 0) &&
						(s.context.takeTree(),
						this.view.dispatch({ effects: Tt.setState.of(new Ln(s.context)) })),
	...
	Ai = L.define({
		...
		enables: (n) => [
			Tt.state,
			Hy,
			X.contentAttributes.compute([n], (e) => {
				let t = e.facet(n);
...
function Yu(n, e) {
	n instanceof fe && (n = new No(n));
	for (let i of n.state.facet(Ky)) {
		let r = i(n, e);
		if (r !== void 0) return r;
	}
	let t = qe(n.state);
	return t.length >= e ? Jy(n, t, e) : null;
}
class No {
	constructor(e, t = {}) {
		((this.state = e), (this.options = t), (this.unit = wo(e)));
	}
	lineAt(e, t = 1) {
	...
	countColumn(e, t = e.length) {
		return Wn(e, this.state.tabSize, t);
	}
	lineIndent(e, t = 1) {
		let { text: i, from: r } = this.lineAt(e, t),
...
function tx(n) {
	...
	if (t && (i = t.type.prop(ue.closedBy))) {
		...
		return (o) => Bp(o, !0, 1, void 0, s && !ex(o) ? r.from : void 0);
	}
	return n.parent == null ? ix : null;
}
function ix() {
	return 0;
}
class Nu extends No {
	...
	continue() {
		return Rp(this.context.next, this.base, this.pos);
	}
}
function nx(n, e) {
...
function sx({ closing: n, align: e = !0, units: t = 1 }) {
	return (i) => Bp(i, e, t, n);
}
...
const ox = (n) => n.baseIndent;
function Ul({ except: n, units: e = 1 } = {}) {
	return (t) => {
...
const lx = 200;
function Fp() {
	return fe.transactionFilter.of((n) => {
		if (
			!n.docChanged ||
...
function cx(n, e, t) {
	...
	for (let o = r; o; o = o.next) {
		...
		if (s && l.from < e) break;
		let a = l.type.prop(_p);
		if (a && (l.to < i.length - 50 || i.length == n.doc.length || !hx(l))) {
			let u = a(l, n);
...
const Hi = Ve.define({
	...
	update(n, e) {
		(e.isUserEvent('delete') &&
			e.changes.iterChangedRanges((t, i) => (n = Th(n, t, i))),
			(n = n.map(e.changes)));
		for (let t of e.effects)
			if (t.is(Go) && !fx(n, t.value.from, t.value.to)) {
				let { preparePlaceholder: i } = e.state.facet(Wp),
					r = i ? U.replace({ widget: new xx(i(e.state, t.value)) }) : Zh;
	...
	provide: (n) => X.decorations.from(n),
	toJSON(n, e) {
		let t = [];
		return (
...
function Lp(n, e) {
	return n.field(Hi, !1) ? e : e.concat(re.appendConfig.of(Ip()));
}
const dx = (n) => {
		for (let e of jp(n)) {
			let t = vo(n.state, e.from, e.to);
			if (t)
				return (n.dispatch({ effects: Lp(n.state, [Go.of(t), zp(n, t)]) }), !0);
		}
		return !1;
	},
	px = (n) => {
		if (!n.state.field(Hi, !1)) return !1;
		let e = [];
		for (let t of jp(n)) {
			let i = Qo(n.state, t.from, t.to);
			i && e.push(Wr.of(i), zp(n, i, !1));
		}
...
const Ox = (n) => {
		...
		for (let i = 0; i < e.doc.length; ) {
			let r = n.lineBlockAt(i),
				s = vo(e, r.from, r.to);
			(s && t.push(Go.of(s)), (i = (s ? n.lineBlockAt(s.to) : r).to + 1));
		}
		return (t.length && n.dispatch({ effects: Lp(n.state, t) }), !!t.length);
	},
	mx = (n) => {
	...
	gx = [
		{ key: 'Ctrl-Shift-[', mac: 'Cmd-Alt-[', run: dx },
		{ key: 'Ctrl-Shift-]', mac: 'Cmd-Alt-]', run: px },
		{ key: 'Ctrl-Alt-[', run: Ox },
		{ key: 'Ctrl-Alt-]', run: mx },
	],
	yx = { placeholderDOM: null, preparePlaceholder: null, placeholderText: '…' },
	Wp = L.define({
		combine(n) {
			return Ut(n, yx);
		},
	...
	let { state: t } = n,
		...
		r = (o) => {
			let l = n.lineBlockAt(n.posAtDOM(o.target)),
				a = Qo(n.state, l.from, l.to);
			(a && n.dispatch({ effects: Wr.of(a) }), o.preventDefault());
		};
		...
		r = ke.fromClass(
			class {
				...
				update(o) {
					(o.docChanged ||
						o.viewportChanged ||
						o.startState.facet(Ai) != o.state.facet(Ai) ||
						o.startState.field(Hi, !1) != o.state.field(Hi, !1) ||
						qe(o.startState) != qe(o.state) ||
						e.foldingChanged(o)) &&
				...
				buildMarkers(o) {
					...
					for (let a of o.viewportLineBlocks) {
						let u = Qo(o.state, a.from, a.to)
							? i
							: vo(o.state, a.from, a.to)
								? t
								: null;
	...
	return [
		...
		vy({
			...
			markers(o) {
				var l;
				return (
					((l = o.plugin(r)) === null || l === void 0 ? void 0 : l.markers) ||
					ce.empty
				);
			},
			initialSpacer() {
			...
			domEventHandlers: {
				...
				click: (o, l, a) => {
					...
					let u = Qo(o.state, l.from, l.to);
					if (u) return (o.dispatch({ effects: Wr.of(u) }), !0);
					let c = vo(o.state, l.from, l.to);
					return c ? (o.dispatch({ effects: Go.of(c) }), !0) : !1;
				},
			},
		}),
		Ip(),
...
function Uo(n, e) {
	...
	return (
		n instanceof In &&
			(n.module && t.push(X.styleModule.of(n.module)), (i = n.themeType)),
		e?.fallback
			? t.push(Vp.of(n))
			: i
				? t.push(
						su.computeN([X.darkTheme], (r) =>
							r.facet(X.darkTheme) == (i == 'dark') ? [n] : [],
						),
					)
				: t.push(su.of(n)),
		t
...
class wx {
	constructor(e) {
		((this.markCache = Object.create(null)),
			(this.tree = qe(e.state)),
			(this.decorations = this.buildDeco(e, Kl(e.state))),
...
const vx = Ki.high(ke.fromClass(wx, { decorations: (n) => n.decorations })),
	Yp = In.define([
	...
	Cx = U.mark({ class: 'cm-matchingBracket' }),
	kx = U.mark({ class: 'cm-nonmatchingBracket' });
function Ax(n) {
	let e = [],
		t = n.matched ? Cx : kx;
	return (
...
function Mh(n) {
	...
	for (let i of n.selection.ranges) {
		...
		let r =
			qt(n, i.head, -1, t) ||
			(i.head > 0 && qt(n, i.head - 1, 1, t)) ||
			(t.afterCursor &&
				(qt(n, i.head, 1, t) ||
					(i.head < n.doc.length && qt(n, i.head + 1, -1, t))));
		r && (e = e.concat(t.renderMatch(r, n)));
	}
	return U.set(e, !0);
}
const Px = ke.fromClass(
		class {
			constructor(n) {
				((this.paused = !1), (this.decorations = Mh(n.state)));
			}
			update(n) {
				(n.docChanged || n.selectionSet || this.paused) &&
					(n.view.composing
						? ((this.decorations = this.decorations.map(n.changes)),
							(this.paused = !0))
						: ((this.decorations = Mh(n.state)), (this.paused = !1)));
			}
		},
		{ decorations: (n) => n.decorations },
	),
...
function lu(n) {
	let e = n.type.prop(Ex);
	return e ? e(n.node) : n;
}
function qt(n, e, t, i = {}) {
	let r = i.maxScanDistance || Np,
		s = i.brackets || Gp,
		o = qe(n),
	...
	for (let a = l; a; a = a.parent) {
		...
		if (u && a.from < a.to) {
			...
			if (c && (t > 0 ? e >= c.from && e < c.to : e > c.from && e <= c.to))
				return Tx(n, e, t, a, c, u, s);
		}
	}
	return Zx(n, e, t, o, l.type, r, s);
}
		...
		do
			if (t < 0 ? c.to <= i.from : c.from >= i.to) {
				if (u == 0 && s.indexOf(c.type.name) > -1 && c.from < c.to) {
					...
					return {
						start: a,
						end: h ? { from: h.from, to: h.to } : void 0,
						matched: !0,
					};
				} else if (ou(c.type, t, o)) u++;
				else if (ou(c.type, -t, o)) {
					if (u == 0) {
						let h = lu(c);
						return {
							start: a,
...
for (let [n, e] of [
	...
	Rx[n] = Bx(Mx, e);
function Jl(n, e) {
	Bh.indexOf(n) > -1 || (Bh.push(n), console.warn(e));
}
function Bx(n, e) {
	let t = [];
		...
		for (let u of l.split('.')) {
			...
			c
				? typeof c == 'function'
					? a.length
						? (a = a.map(c))
						: Jl(u, `Modifier ${u} used at start of tag`)
					: a.length
						? Jl(u, `Tag ${u} used as modifier`)
						: (a = Array.isArray(c) ? c : [c])
				: Jl(u, `Unknown highlighting tag ${u}`);
		}
...
const Fx = (n) => {
	let { state: e } = n,
		...
		i = Uu(n.state, t.from);
	return i.line ? _x(n) : i.block ? jx(n) : !1;
};
function Gu(n, e) {
...
const _x = Gu(Wx, 0),
	Xx = Gu(Kp, 0),
	jx = Gu((n, e) => Kp(n, e, zx(e)), 0);
function Uu(n, e) {
	let t = n.languageDataAt('commentTokens', e, 1);
	return t.length ? t[0] : {};
}
const sr = 50;
function Lx(n, { open: e, close: t }, i, r) {
	let s = n.sliceDoc(i - sr, i),
		o = n.sliceDoc(r, r + sr),
		l = /\s*$/.exec(s)[0].length,
		a = /^\s*/.exec(o)[0].length,
		u = s.length - l;
	...
	r - i <= 2 * sr
		? (c = h = n.sliceDoc(i, r))
		: ((c = n.sliceDoc(i, i + sr)), (h = n.sliceDoc(r - sr, r)));
	let f = /^\s*/.exec(c)[0].length,
		d = /\s*$/.exec(h)[0].length,
		p = h.length - d - t.length;
...
function Kp(n, e, t = e.selection.ranges) {
	let i = t.map((s) => Uu(e, s.from).block);
	if (!i.every((s) => s)) return null;
	let r = t.map((s, o) => Lx(e, i[o], s.from, s.to));
	if (n != 2 && !r.every((s) => s))
		return {
			changes: e.changes(
				t.map((s, o) =>
...
function Wx(n, e, t = e.selection.ranges) {
	let i = [],
		r = -1;
	e: for (let { from: s, to: o } of t) {
		...
		for (let c = s; c <= o; ) {
			...
			if (u == null && ((u = Uu(e, h.from).line), !u)) continue e;
			if (h.from > r && (s == o || o > h.from)) {
				r = h.from;
				let f = /^\s*/.exec(h.text)[0].length,
					d = f == h.length,
					p = h.text.slice(f, f + u.length) == u ? f : -1;
				(f < h.text.length && f < a && (a = f),
					i.push({
						line: h,
						comment: p,
						token: u,
...
const au = Gt.define(),
	...
	eO = Ve.define({
		...
		update(n, e) {
			let t = e.state.facet(Jp),
				i = e.annotation(au);
			if (i) {
				let a = st.fromTransaction(e, i.selection),
					u = i.side,
					c = u == 0 ? n.undone : n.done;
				return (
					a
						? (c = Co(c, c.length, t.minDepth, a))
						: (c = rO(c, e.startState.selection)),
					new Vt(u == 0 ? i.rest : c, u == 0 ? c : i.rest)
				);
			}
			let r = e.annotation(Ix);
			if (
				((r == 'full' || r == 'before') && (n = n.isolate()),
				e.annotation(Be.addToHistory) === !1)
			)
				return e.changes.empty ? n : n.addMapping(e.changes.desc);
			let s = st.fromTransaction(e),
				o = e.annotation(Be.time),
				l = e.annotation(Be.userEvent);
			return (
				s
		...
		fromJSON(n) {
			return new Vt(n.done.map(st.fromJSON), n.undone.map(st.fromJSON));
		},
	});
function tO(n = {}) {
	return [
...
class st {
	...
	static fromTransaction(e, t) {
		let i = xt;
		for (let r of e.startState.facet(qx)) {
			let s = r(e);
	...
	static selection(e) {
		return new st(void 0, xt, void 0, void 0, e);
	}
}
function Co(n, e, t, i) {
...
function rO(n, e) {
	if (n.length) {
		let t = n[n.length - 1],
			i = t.selectionsAfter.slice(Math.max(0, t.selectionsAfter.length - Ux));
		return i.length && i[i.length - 1].eq(e)
			? n
			: (i.push(e), Co(n, n.length - 1, 1e9, t.setSelAfter(i)));
	} else return [st.selection([e])];
}
function Hx(n) {
	let e = n[n.length - 1],
		t = n.slice();
...
function ea(n, e) {
	...
	return i.length ? [st.selection(i)] : xt;
}
function Kx(n, e, t) {
	let i = nO(
		n.selectionsAfter.length ? n.selectionsAfter.map((l) => l.map(e)) : xt,
		t,
	);
	if (!n.changes) return st.selection(i);
	let r = n.changes.map(e),
		s = e.mapDesc(n.changes, !0),
		o = n.mapped ? n.mapped.composeDesc(s) : s;
	return new st(r, re.mapEffects(n.effects, e), o, n.startSelection.map(s), i);
}
const Jx = /^(input\.type|delete)($|\.)/;
class Vt {
	...
	isolate() {
		return this.prevTime ? new Vt(this.done, this.undone) : this;
	}
	addChanges(e, t, i, r, s) {
		...
		return (
			...
			((!l.selectionsAfter.length &&
				...
				r.joinToEvent(s, Nx(l.changes, e.changes))) ||
				...
				? (o = Co(
						...
						new st(
							...
							nO(re.mapEffects(e.effects, l.changes), l.effects),
							l.mapped,
							l.startSelection,
							xt,
						),
					))
				: (o = Co(o, o.length, r.minDepth, e)),
			new Vt(o, xt, t, i)
		);
	}
	addSelection(e, t, i, r) {
		...
		return s.length > 0 &&
			...
			Gx(s[s.length - 1], e)
			? this
			: new Vt(rO(this.done, e), this.undone, t, i);
	}
	addMapping(e) {
		return new Vt(
			ea(this.done, e),
	...
	pop(e, t, i) {
		...
		let s = r[r.length - 1],
			o =
				s.selectionsAfter[0] ||
				(s.startSelection
					? s.startSelection.map(s.changes.invertedDesc, 1)
					: t.selection);
		if (i && s.selectionsAfter.length)
			return t.update({
				selection: s.selectionsAfter[s.selectionsAfter.length - 1],
				annotations: au.of({ side: e, rest: Hx(r), selection: o }),
		...
		if (s.changes) {
			...
			return (
				s.mapped && (l = ea(l, s.mapped)),
				t.update({
					changes: s.changes,
					selection: s.startSelection,
					effects: s.effects,
					annotations: au.of({ side: e, rest: l, selection: o }),
					filter: !1,
...
Vt.empty = new Vt(xt, xt);
const sO = [
	{ key: 'Mod-z', run: iO, preventDefault: !0 },
	{ key: 'Mod-y', mac: 'Mod-Shift-z', run: uu, preventDefault: !0 },
	{ linux: 'Ctrl-Shift-z', run: uu, preventDefault: !0 },
	{ key: 'Mod-u', run: Vx, preventDefault: !0 },
	{ key: 'Alt-u', mac: 'Mod-Shift-u', run: Yx, preventDefault: !0 },
];
function qn(n, e) {
...
function Bt({ state: n, dispatch: e }, t) {
	let i = qn(n.selection, t);
	return i.eq(n.selection, !0) ? !1 : (e(Rt(n, i)), !0);
}
function Ko(n, e) {
	return T.cursor(e ? n.to : n.from);
}
function oO(n, e) {
	return Bt(n, (t) => (t.empty ? n.moveByChar(t, e) : Ko(t, e)));
}
function Ye(n) {
	return n.textDirectionAt(n.state.selection.main.head) == ye.LTR;
}
const lO = (n) => oO(n, !Ye(n)),
	aO = (n) => oO(n, Ye(n));
function uO(n, e) {
	return Bt(n, (t) => (t.empty ? n.moveByGroup(t, e) : Ko(t, e)));
}
const eb = (n) => uO(n, !Ye(n)),
	tb = (n) => uO(n, Ye(n));
function ib(n, e, t) {
...
function Jo(n, e, t) {
	let i = qe(n).resolveInner(e.head),
		r = t ? ue.closedBy : ue.openedBy;
	for (let a = e.head; ; ) {
		let u = t ? i.childAfter(a) : i.childBefore(a);
		if (!u) break;
		ib(n, u, r) ? (i = u) : (a = t ? u.to : u.from);
	}
	let s = i.type.prop(r),
		o,
		l;
	return (
		s && (o = t ? qt(n, i.from, 1) : qt(n, i.to, -1)) && o.matched
			? (l = t ? o.end.to : o.end.from)
			: (l = t ? i.to : i.from),
		T.cursor(l, t ? -1 : 1)
	);
}
const nb = (n) => Bt(n, (e) => Jo(n.state, e, !Ye(n))),
	rb = (n) => Bt(n, (e) => Jo(n.state, e, Ye(n)));
function cO(n, e) {
	return Bt(n, (t) => {
		if (!t.empty) return Ko(t, e);
...
function dO(n) {
	let e = n.scrollDOM.clientHeight < n.scrollDOM.scrollHeight - 2,
		...
		r;
	if (e) {
		for (let s of n.state.facet(X.scrollMargins)) {
			let o = s(n);
...
function pO(n, e) {
	let t = dO(n),
		{ state: i } = n,
		r = qn(i.selection, (o) =>
			o.empty ? n.moveVertically(o, e, t.height) : Ko(o, e),
		);
	...
	if (t.selfScroll) {
		...
		o &&
			o.top > a &&
			o.bottom < u &&
			(s = X.scrollIntoView(r.main.head, { y: 'start', yMargin: o.top - a }));
	}
	return (n.dispatch(Rt(i, r), { effects: s }), !0);
}
const _h = (n) => pO(n, !1),
	cu = (n) => pO(n, !0);
function Ei(n, e, t) {
...
const sb = (n) => Bt(n, (e) => Ei(n, e, !0)),
	ob = (n) => Bt(n, (e) => Ei(n, e, !1)),
	lb = (n) => Bt(n, (e) => Ei(n, e, !Ye(n))),
	ab = (n) => Bt(n, (e) => Ei(n, e, Ye(n))),
	ub = (n) => Bt(n, (e) => T.cursor(n.lineBlockAt(e.head).from, 1)),
	cb = (n) => Bt(n, (e) => T.cursor(n.lineBlockAt(e.head).to, -1));
function hb(n, e, t) {
	let i = !1,
		r = qn(n.selection, (s) => {
			let o =
				qt(n, s.head, -1) ||
				qt(n, s.head, 1) ||
				(s.head > 0 && qt(n, s.head - 1, 1)) ||
				(s.head < n.doc.length && qt(n, s.head + 1, -1));
			if (!o || !o.end) return s;
			i = !0;
			let l = o.start.from == s.head ? o.end.to : o.end.from;
			return T.cursor(l);
		});
	return i ? (e(Rt(n, r)), !0) : !1;
}
const fb = ({ state: n, dispatch: e }) => hb(n, e);
function Dt(n, e) {
	let t = qn(n.state.selection, (i) => {
		let r = e(i);
		return T.range(
			i.anchor,
			r.head,
...
const mO = (n) => OO(n, !Ye(n)),
	gO = (n) => OO(n, Ye(n));
function yO(n, e) {
	return Dt(n, (t) => n.moveByGroup(t, e));
}
const db = (n) => yO(n, !Ye(n)),
	pb = (n) => yO(n, Ye(n)),
	Ob = (n) => Dt(n, (e) => Jo(n.state, e, !Ye(n))),
	mb = (n) => Dt(n, (e) => Jo(n.state, e, Ye(n)));
function xO(n, e) {
...
const bO = (n) => xO(n, !1),
	SO = (n) => xO(n, !0);
function DO(n, e) {
	return Dt(n, (t) => n.moveVertically(t, e, dO(n).height));
}
const Xh = (n) => DO(n, !1),
	jh = (n) => DO(n, !0),
	gb = (n) => Dt(n, (e) => Ei(n, e, !0)),
	yb = (n) => Dt(n, (e) => Ei(n, e, !1)),
	xb = (n) => Dt(n, (e) => Ei(n, e, !Ye(n))),
	bb = (n) => Dt(n, (e) => Ei(n, e, Ye(n))),
	Sb = (n) => Dt(n, (e) => T.cursor(n.lineBlockAt(e.head).from)),
	Db = (n) => Dt(n, (e) => T.cursor(n.lineBlockAt(e.head).to)),
	Lh = ({ state: n, dispatch: e }) => (e(Rt(n, { anchor: 0 })), !0),
	zh = ({ state: n, dispatch: e }) => (e(Rt(n, { anchor: n.doc.length })), !0),
	Wh = ({ state: n, dispatch: e }) => (
		e(Rt(n, { anchor: n.selection.main.anchor, head: 0 })),
		!0
	),
	Ih = ({ state: n, dispatch: e }) => (
		e(Rt(n, { anchor: n.selection.main.anchor, head: n.doc.length })),
		!0
	),
	...
	vb = ({ state: n, dispatch: e }) => {
		let t = el(n).map(({ from: i, to: r }) =>
			T.range(i, Math.min(r + 1, n.doc.length)),
		);
		return (e(n.update({ selection: T.create(t), userEvent: 'select' })), !0);
	},
	Qb = ({ state: n, dispatch: e }) => {
		let t = qn(n.selection, (i) => {
			let r = qe(n),
			...
			for (let o = s; o; o = o.next) {
				...
				if (
					...
					return T.range(l.to, l.from);
			}
			return i;
		});
		return t.eq(n.selection) ? !1 : (e(Rt(n, t)), !0);
	};
function wO(n, e) {
	let { state: t } = n,
		i = t.selection,
		...
		if (e ? o.to < n.state.doc.length : o.from > 0)
			for (let l = s; ; ) {
				...
				if (a.head < o.from || a.head > o.to) {
					r.some((u) => u.head == a.head) || r.push(a);
					break;
				} else {
	...
	return r.length == i.ranges.length
		? !1
		: (n.dispatch(Rt(t, T.create(r, r.length - 1))), !0);
}
const Cb = (n) => wO(n, !1),
	kb = (n) => wO(n, !0),
	Ab = ({ state: n, dispatch: e }) => {
		...
		return (
			t.ranges.length > 1
				? (i = T.create([t.main]))
				: t.main.empty || (i = T.create([T.cursor(t.main.head)])),
			i ? (e(Rt(n, i)), !0) : !1
		);
	};
function Ir(n, e) {
	...
	let t = 'delete.selection',
		...
		r = i.changeByRange((s) => {
			...
			if (o == l) {
				let a = e(s);
				(a < o
					? ((t = 'delete.backward'), (a = Ws(n, a, !1)))
					: a > o && ((t = 'delete.forward'), (a = Ws(n, a, !0))),
					(o = Math.min(o, a)),
					(l = Math.max(l, a)));
			} else ((o = Ws(n, o, !1)), (l = Ws(n, l, !0)));
			return o == l
				? { range: s }
				: {
						changes: { from: o, to: l },
						range: T.cursor(o, o < s.head ? -1 : 1),
					};
		});
	return r.changes.empty
		...
		: (n.dispatch(
				i.update(r, {
					...
					effects:
						t == 'delete.selection'
							? X.announce.of(i.phrase('Selection deleted'))
							: void 0,
				}),
			),
			!0);
...
function Ws(n, e, t) {
	if (n instanceof X)
		for (let i of n.state.facet(X.atomicRanges).map((r) => r(n)))
			i.between(e, e, (r, s) => {
				r < e && s > e && (e = t ? s : r);
			});
	return e;
...
const vO = (n, e, t) =>
		Ir(n, (i) => {
			...
			if (
				...
				let u = Wn(l, s.tabSize),
					c = u % wo(s) || wo(s);
				for (let h = 0; h < c && l[l.length - 1 - h] == ' '; h++) r--;
				a = r;
			} else
				((a = Xe(o.text, r - o.from, e, e) + o.from),
					a == r && o.number != (e ? s.doc.lines : 1)
						? (a += e ? 1 : -1)
						: !e &&
							/[\ufe00-\ufe0f]/.test(o.text.slice(a - o.from, r - o.from)) &&
							(a = Xe(o.text, a - o.from, !1, !1) + o.from));
			return a;
		}),
	hu = (n) => vO(n, !1, !0),
	QO = (n) => vO(n, !0, !1),
	CO = (n, e) =>
		Ir(n, (t) => {
			...
			for (let l = null; ; ) {
				...
				let a = Xe(s.text, i - s.from, e) + s.from,
	...
	Zb = ({ state: n, dispatch: e }) => {
		...
		let t = n.changeByRange((i) => ({
			changes: { from: i.from, to: i.to, insert: Oe.of(['', '']) },
	...
	Mb = ({ state: n, dispatch: e }) => {
		...
		let t = n.changeByRange((i) => {
			...
			let r = i.from,
				...
				l = r == s.to ? r + 1 : Xe(s.text, r - s.from, !0) + s.from;
			return {
				changes: {
					from: o,
					to: l,
...
function AO(n, e, t) {
	...
	for (let s of el(n)) {
		...
		if (t) {
			...
			for (let a of s.ranges) r.push(T.range(a.anchor - l, a.head - l));
		}
	}
	return i.length
		? (e(
...
const Rb = ({ state: n, dispatch: e }) => AO(n, e, !1),
	Bb = ({ state: n, dispatch: e }) => AO(n, e, !0);
function PO(n, e, t) {
	if (n.readOnly) return !1;
	let i = [];
	for (let s of el(n))
...
const Fb = ({ state: n, dispatch: e }) => PO(n, e, !1),
	_b = ({ state: n, dispatch: e }) => PO(n, e, !0),
	Xb = (n) => {
		if (n.state.readOnly) return !1;
		let { state: e } = n,
			t = e.changes(
			...
			i = qn(e.selection, (r) => {
				...
				if (n.lineWrapping) {
					...
					l &&
						(s = o.bottom + n.documentTop - l.bottom + n.defaultLineHeight / 2);
				}
...
function $O(n) {
	return ({ state: e, dispatch: t }) => {
		...
		let i = e.changeByRange((r) => {
			...
			let u = new No(e, { simulateBreak: s, simulateDoubleBreak: !!a }),
				c = Yu(u, s);
			for (
				c == null && (c = Wn(/^\s*/.exec(e.doc.lineAt(s).text)[0], e.tabSize));
			...
			let h = ['', Zr(e, c)];
			return (
				a && h.push(Zr(e, u.lineIndent(l.from, -1))),
				{
					changes: { from: s, to: o, insert: Oe.of(h) },
					range: T.cursor(s + 1 + h[1].length),
				}
			);
		});
...
function Hu(n, e) {
	...
	return n.changeByRange((i) => {
		...
		return {
			changes: r,
			range: T.range(s.mapPos(i.anchor, 1), s.mapPos(i.head, 1)),
		};
	});
}
const zb = ({ state: n, dispatch: e }) => {
		if (n.readOnly) return !1;
		let t = Object.create(null),
			i = new No(n, {
	...
	EO = ({ state: n, dispatch: e }) =>
		n.readOnly
			? !1
			: (e(
					n.update(
						Hu(n, (t, i) => {
							i.push({ from: t.from, insert: n.facet(Yo) });
						}),
						{ userEvent: 'input.indent' },
					),
				),
				!0),
	TO = ({ state: n, dispatch: e }) =>
		n.readOnly
			? !1
			: (e(
					n.update(
						Hu(n, (t, i) => {
							...
							if (!r) return;
							let s = Wn(r, n.tabSize),
								o = 0,
								l = Zr(n, Math.max(0, s - wo(n)));
							for (
								;
								o < r.length &&
								o < l.length &&
				...
				!0),
	Wb = (n) => (n.setTabFocusMode(), !0),
	Ib = [
		{ key: 'Ctrl-b', run: lO, shift: mO, preventDefault: !0 },
		{ key: 'Ctrl-f', run: aO, shift: gO },
		{ key: 'Ctrl-p', run: hO, shift: bO },
		{ key: 'Ctrl-n', run: fO, shift: SO },
		{ key: 'Ctrl-a', run: ub, shift: Sb },
		{ key: 'Ctrl-e', run: cb, shift: Db },
		{ key: 'Ctrl-d', run: QO },
		{ key: 'Ctrl-h', run: hu },
		{ key: 'Ctrl-k', run: $b },
	...
	qb = [
		{ key: 'ArrowLeft', run: lO, shift: mO, preventDefault: !0 },
		{
			key: 'Mod-ArrowLeft',
			mac: 'Alt-ArrowLeft',
			run: eb,
		...
		{ mac: 'Cmd-ArrowLeft', run: lb, shift: xb, preventDefault: !0 },
		{ key: 'ArrowRight', run: aO, shift: gO, preventDefault: !0 },
		{
			key: 'Mod-ArrowRight',
			mac: 'Alt-ArrowRight',
			run: tb,
		...
		{ mac: 'Cmd-ArrowRight', run: ab, shift: bb, preventDefault: !0 },
		{ key: 'ArrowUp', run: hO, shift: bO, preventDefault: !0 },
		{ mac: 'Cmd-ArrowUp', run: Lh, shift: Wh },
		{ mac: 'Ctrl-ArrowUp', run: _h, shift: Xh },
		{ key: 'ArrowDown', run: fO, shift: SO, preventDefault: !0 },
		{ mac: 'Cmd-ArrowDown', run: zh, shift: Ih },
		{ mac: 'Ctrl-ArrowDown', run: cu, shift: jh },
		{ key: 'PageUp', run: _h, shift: Xh },
		{ key: 'PageDown', run: cu, shift: jh },
		{ key: 'Home', run: ob, shift: yb, preventDefault: !0 },
		{ key: 'Mod-Home', run: Lh, shift: Wh },
		{ key: 'End', run: sb, shift: gb, preventDefault: !0 },
		{ key: 'Mod-End', run: zh, shift: Ih },
		{ key: 'Enter', run: qh, shift: qh },
		{ key: 'Mod-a', run: wb },
		{ key: 'Backspace', run: hu, shift: hu, preventDefault: !0 },
		{ key: 'Delete', run: QO, preventDefault: !0 },
		{ key: 'Mod-Backspace', mac: 'Alt-Backspace', run: kO, preventDefault: !0 },
		{ key: 'Mod-Delete', mac: 'Alt-Delete', run: Pb, preventDefault: !0 },
		{ mac: 'Mod-Backspace', run: Eb, preventDefault: !0 },
		{ mac: 'Mod-Delete', run: Tb, preventDefault: !0 },
	].concat(Ib.map((n) => ({ mac: n.key, run: n.run, shift: n.shift }))),
	ZO = [
		{ key: 'Alt-ArrowLeft', mac: 'Ctrl-ArrowLeft', run: nb, shift: Ob },
		{ key: 'Alt-ArrowRight', mac: 'Ctrl-ArrowRight', run: rb, shift: mb },
		{ key: 'Alt-ArrowUp', run: Rb },
		{ key: 'Shift-Alt-ArrowUp', run: Fb },
		{ key: 'Alt-ArrowDown', run: Bb },
		{ key: 'Shift-Alt-ArrowDown', run: _b },
		{ key: 'Mod-Alt-ArrowUp', run: Cb },
		{ key: 'Mod-Alt-ArrowDown', run: kb },
		{ key: 'Escape', run: Ab },
		{ key: 'Mod-Enter', run: Lb },
		{ key: 'Alt-l', mac: 'Ctrl-l', run: vb },
		{ key: 'Mod-i', run: Qb, preventDefault: !0 },
		{ key: 'Mod-[', run: TO },
		{ key: 'Mod-]', run: EO },
		{ key: 'Mod-Alt-\\', run: zb },
		{ key: 'Shift-Mod-k', run: Xb },
		{ key: 'Shift-Mod-\\', run: fb },
		{ key: 'Mod-/', run: Fx },
		{ key: 'Alt-A', run: Xx },
		{ key: 'Ctrl-m', mac: 'Shift-Alt-m', run: Wb },
	].concat(qb),
	Vb = { key: 'Tab', run: EO, shift: TO },
	Vh =
...
const MO = { from: -1, to: -1, match: /.*/.exec('') },
	Ku = 'gm' + (/x/.unicode == null ? '' : 'u');
class RO {
	constructor(e, t, i, r = 0, s = e.length) {
		if (
			...
			return new BO(e, t, i, r, s);
		((this.re = new RegExp(t, Ku + (i?.ignoreCase ? 'i' : ''))),
			(this.test = i?.test),
			(this.iter = e.iter()));
		let o = e.lineAt(r);
		((this.curLineStart = o.from),
			(this.matchPos = ko(e, r)),
		...
		for (let e = this.matchPos - this.curLineStart; ; ) {
			...
			if (t) {
				let i = this.curLineStart + t.index,
					r = i + t[0].length;
				if (
					((this.matchPos = ko(this.text, r + (i == r ? 1 : 0))),
...
class Zn {
	...
	static get(e, t, i) {
		...
		if (!r || r.from >= i || r.to <= t) {
			let l = new Zn(t, e.sliceString(t, i));
			return (ta.set(e, l), l);
		}
...
class BO {
	constructor(e, t, i, r, s) {
		((this.text = e),
			...
			(this.re = new RegExp(t, Ku + (i?.ignoreCase ? 'i' : ''))),
			(this.test = i?.test),
			(this.flat = Zn.get(e, r, this.chunkEnd(r + 5e3))));
	}
	chunkEnd(e) {
...
typeof Symbol < 'u' &&
	(RO.prototype[Symbol.iterator] = BO.prototype[Symbol.iterator] =
		function () {
			return this;
		});
function Yb(n) {
	try {
		return (new RegExp(n, Ku), !0);
	} catch {
		return !1;
	}
}
...
const Nb = (n) => {
		...
		return (
			r.then((s) => {
				...
				if (u && h) {
					let m = d / 100;
					(a && (m = m * (a == '-' ? -1 : 1) + l.number / e.doc.lines),
						(d = Math.round(e.doc.lines * m)));
				} else u && a && (d = d * (a == '-' ? -1 : 1) + l.number);
				let p = e.doc.line(Math.max(1, Math.min(e.doc.lines, d))),
					O = T.cursor(p.from + Math.max(0, Math.min(f, p.length)));
				n.dispatch({
					effects: [i, X.scrollIntoView(O.from, { y: 'center' })],
					selection: O,
				});
			}),
			!0
...
const Hb = U.mark({ class: 'cm-selectionMatch' }),
	Kb = U.mark({ class: 'cm-selectionMatch cm-selectionMatch-main' });
function Yh(n, e, t, i) {
	return (
		(t == 0 || n(e.sliceDoc(t - 1, t)) != ve.Word) &&
		(i == e.doc.length || n(e.sliceDoc(i, i + 1)) != ve.Word)
	);
}
function Jb(n, e, t, i) {
	return (
		n(e.sliceDoc(t, t + 1)) == ve.Word && n(e.sliceDoc(i - 1, i)) == ve.Word
	);
}
const eS = ke.fromClass(
		class {
			constructor(n) {
				this.decorations = this.getDeco(n);
			}
			...
			getDeco(n) {
				let e = n.state.facet(Ub),
					{ state: t } = n,
					i = t.selection;
				if (i.ranges.length > 1) return U.none;
				let r = i.main,
					s,
					o = null;
				if (r.empty) {
					...
					if (e.wholeWords) {
						if (
							...
							!(Yh(o, t, r.from, r.to) && Jb(o, t, r.from, r.to)))
						)
							return U.none;
					} else if (((s = t.sliceDoc(r.from, r.to)), !s)) return U.none;
				}
				let l = [];
				for (let a of n.visibleRanges) {
					let u = new zn(t.doc, s, a.from, a.to);
					for (; !u.next().done; ) {
						let { from: c, to: h } = u.value;
						if (
							(!o || Yh(o, t, c, h)) &&
							(r.empty && c <= r.from && h >= r.to
								? l.push(Kb.range(c, h))
								: (c >= r.to || h <= r.from) && l.push(Hb.range(c, h)),
	...
	iS = ({ state: n, dispatch: e }) => {
		let { selection: t } = n,
			i = T.create(
				t.ranges.map((r) => n.wordAt(r.head) || T.cursor(r.head)),
				t.mainIndex,
			);
...
function nS(n, e) {
	...
	for (let o = !1, l = new zn(n.doc, e, i[i.length - 1].to); ; )
		if ((l.next(), l.done)) {
			if (o) return null;
			((l = new zn(n.doc, e, 0, Math.max(0, i[i.length - 1].from - 1))),
				(o = !0));
		} else {
...
const rS = ({ state: n, dispatch: e }) => {
		let { ranges: t } = n.selection;
		if (t.some((s) => s.from === s.to)) return iS({ state: n, dispatch: e });
		...
		return r
			? (e(
					n.update({
						selection: n.selection.addRange(T.range(r.from, r.to), !1),
						effects: X.scrollIntoView(r.to),
					}),
				),
				!0)
			: !1;
...
class _O {
	constructor(e) {
		((this.search = e.search),
			...
			(this.valid = !!this.search && (!this.regexp || Yb(this.search))),
...
`
	...
	create() {
		return this.regexp ? new cS(this) : new lS(this);
	}
	getCursor(e, t = 0, i) {
		let r = e.doc ? e : fe.create({ doc: e });
		return (
			i == null && (i = r.doc.length),
			this.regexp ? vn(this, r, t, i) : wn(this, r, t, i)
		);
	}
}
class XO {
...
function sS(n, e, t) {
	return (i, r, s, o) => {
		if (t && !t(i, r, s, o)) return !1;
		let l =
			i >= o && r <= o + s.length
				? s.slice(i - o, r - o)
				: e.doc.sliceString(i, r);
		return n(l, e, i, r);
	};
}
function wn(n, e, t, i) {
	let r;
	return (
		n.wholeWord && (r = oS(e.doc, e.charCategorizer(e.selection.main.head))),
		n.test && (r = sS(n.test, e, r)),
		new zn(
			e.doc,
			n.unquoted,
			t,
...
function oS(n, e) {
	return (t, i, r, s) => (
		...
		(e(Ao(r, t - s)) != ve.Word || e(Po(r, t - s)) != ve.Word) &&
			(e(Po(r, i - s)) != ve.Word || e(Ao(r, i - s)) != ve.Word)
	);
}
class lS extends XO {
	constructor(e) {
	...
	nextMatch(e, t, i) {
		let r = wn(this.spec, e, i, e.doc.length).nextOverlapping();
		if (r.done) {
			let s = Math.min(e.doc.length, t + this.spec.unquoted.length);
			r = wn(this.spec, e, 0, s).nextOverlapping();
		}
	...
	matchAll(e, t) {
		let i = wn(this.spec, e, 0, e.doc.length),
			r = [];
		for (; !i.next().done; ) {
...
function vn(n, e, t, i) {
	let r;
	return (
		n.wholeWord && (r = uS(e.charCategorizer(e.selection.main.head))),
		n.test && (r = aS(n.test, e, r)),
		new RO(e.doc, n.search, { ignoreCase: !n.caseSensitive, test: r }, t, i)
	);
}
function Ao(n, e) {
	return n.slice(Xe(n, e, !1), e);
}
function Po(n, e) {
...
function uS(n) {
	return (e, t, i) =>
		!i[0].length ||
		((n(Ao(i.input, i.index)) != ve.Word ||
			n(Po(i.input, i.index)) != ve.Word) &&
			(n(Po(i.input, i.index + i[0].length)) != ve.Word ||
				n(Ao(i.input, i.index + i[0].length)) != ve.Word));
}
class cS extends XO {
	nextMatch(e, t, i) {
		let r = vn(this.spec, e, i, e.doc.length).next();
		return (
			r.done && (r = vn(this.spec, e, 0, t).next()),
			r.done ? null : r.value
		);
	}
	prevMatchInRange(e, t, i) {
	...
	matchAll(e, t) {
		let i = vn(this.spec, e, 0, e.doc.length),
			r = [];
		for (; !i.next().done; ) {
			if (r.length >= t) return null;
			r.push(i.value);
...
const Mr = re.define(),
	...
	Di = Ve.define({
		create(n) {
			return new ia(fu(n).create(), null);
		},
		update(n, e) {
			for (let t of e.effects)
				t.is(Mr)
					? (n = new ia(t.value.create(), n.panel))
					: t.is(Ju) && (n = new ia(n.query, t.value ? ec : null));
			return n;
		},
		provide: (n) => $r.from(n, (e) => e.panel),
	});
class ia {
	constructor(e, t) {
...
const hS = U.mark({ class: 'cm-searchMatch' }),
	fS = U.mark({ class: 'cm-searchMatch cm-searchMatch-selected' }),
	dS = ke.fromClass(
		class {
			constructor(n) {
				((this.view = n),
					(this.decorations = this.highlight(n.state.field(Di))));
			}
			update(n) {
				let e = n.state.field(Di);
				(e != n.startState.field(Di) ||
					n.docChanged ||
					n.selectionSet ||
					n.viewportChanged) &&
			...
			highlight({ query: n, panel: e }) {
				if (!e || !n.spec.valid) return U.none;
				let { view: t } = this,
					i = new hi();
				for (let r = 0, s = t.visibleRanges, o = s.length; r < o; r++) {
					let { from: l, to: a } = s[r];
					for (; r < o - 1 && a > s[r + 1].from - 500; ) a = s[++r].to;
					n.highlight(t.state, l, a, (u, c) => {
						let h = t.state.selection.ranges.some(
							(f) => f.from == u && f.to == c,
						);
						i.add(u, c, h ? fS : hS);
					});
...
function qr(n) {
	return (e) => {
		let t = e.state.field(Di, !1);
		return t && t.query.spec.valid ? n(e, t) : zO(e);
	};
}
const $o = qr((n, { query: e }) => {
		let { to: t } = n.state.selection.main,
			i = e.nextMatch(n.state, t, t);
		if (!i) return !1;
		let r = T.single(i.from, i.to),
			s = n.state.facet(Vn);
		return (
			n.dispatch({
				selection: r,
				effects: [tc(n, i), s.scrollToMatch(r.main, n)],
	...
	Eo = qr((n, { query: e }) => {
		let { state: t } = n,
			...
			r = e.prevMatch(t, i, i);
		if (!r) return !1;
		let s = T.single(r.from, r.to),
			o = n.state.facet(Vn);
		return (
			n.dispatch({
				selection: s,
				effects: [tc(n, r), o.scrollToMatch(s.main, n)],
				userEvent: 'select.search',
			}),
			LO(n),
			!0
	...
	OS = ({ state: n, dispatch: e }) => {
		...
		let { from: i, to: r } = t.main,
			s = [],
			o = 0;
		for (let l = new zn(n.doc, n.sliceDoc(i, r)); !l.next().done; ) {
			if (s.length > 1e3) return !1;
			(l.value.from == i && (o = s.length),
				s.push(T.range(l.value.from, l.value.to)));
		}
		return (
			e(
				n.update({
	...
	Nh = qr((n, { query: e }) => {
		...
		return (
			o &&
				((a = T.single(o.from, o.to).map(h)),
				c.push(tc(n, o)),
				c.push(t.facet(Vn).scrollToMatch(a.main, n))),
			n.dispatch({
				changes: h,
				selection: a,
				effects: c,
...
function ec(n) {
	return n.state.facet(Vn).createPanel(n);
}
function fu(n, e) {
	var t, i, r, s, o;
	...
	let u = n.facet(Vn);
	return new _O({
		search: ((t = e?.literal) !== null && t !== void 0 ? t : u.literal)
			? a
			: a.replace(/\n/g, '\\n'),
		caseSensitive:
			(i = e?.caseSensitive) !== null && i !== void 0 ? i : u.caseSensitive,
		literal: (r = e?.literal) !== null && r !== void 0 ? r : u.literal,
...
const zO = (n) => {
		...
		if (e && e.panel) {
			...
			if (t && t != n.root.activeElement) {
				let i = fu(n.state, e.query.spec);
				(i.valid && n.dispatch({ effects: Mr.of(i) }), t.focus(), t.select());
			}
		} else
			n.dispatch({
				effects: [
					Ju.of(!0),
					e ? Mr.of(fu(n.state, e.query.spec)) : re.appendConfig.of(bS),
				],
			});
		return !0;
	},
	WO = (n) => {
		...
		return (
			...
			n.dispatch({ effects: Ju.of(!1) }),
			!0
		);
	},
	gS = [
		{ key: 'Mod-f', run: zO, scope: 'editor search-panel' },
		{
			key: 'F3',
			run: $o,
			shift: Eo,
		...
		{ key: 'Mod-Shift-l', run: OS },
		{ key: 'Mod-Alt-g', run: Nb },
		{ key: 'Mod-d', run: rS, preventDefault: !0 },
	];
class yS {
	constructor(e) {
		this.view = e;
		let t = (this.query = e.state.field(Di).query.spec);
		((this.commit = this.commit.bind(this)),
			(this.searchField = me('input', {
				value: t.search,
		...
		this.dom = me(
			...
			[
				this.searchField,
				i('next', () => $o(e), [at(e, 'next')]),
				i('prev', () => Eo(e), [at(e, 'previous')]),
				i('select', () => pS(e), [at(e, 'all')]),
				me('label', null, [this.caseField, at(e, 'match case')]),
				me('label', null, [this.reField, at(e, 'regexp')]),
				me('label', null, [this.wordField, at(e, 'by word')]),
				...(e.state.readOnly
					? []
					: [
							me('br'),
							this.replaceField,
							i('replace', () => Nh(e), [at(e, 'replace')]),
							i('replaceAll', () => mS(e), [at(e, 'replace all')]),
						]),
				me(
					'button',
					{
	...
	commit() {
		...
		e.eq(this.query) ||
			((this.query = e), this.view.dispatch({ effects: Mr.of(e) }));
	}
	keydown(e) {
		Z1(this.view, e, 'search-panel')
			? e.preventDefault()
			: e.keyCode == 13 && e.target == this.searchField
				? (e.preventDefault(), (e.shiftKey ? Eo : $o)(this.view))
				: e.keyCode == 13 &&
					e.target == this.replaceField &&
					(e.preventDefault(), Nh(this.view));
	}
	update(e) {
		for (let t of e.transactions)
			for (let i of t.effects)
				i.is(Mr) && !i.value.eq(this.query) && this.setQuery(i.value);
	}
	setQuery(e) {
		((this.query = e),
...
function tc(n, { from: e, to: t }) {
	...
	if (o != r) {
		for (let a = l.length - 1; a > l.length - Is; a--)
			if (!qs.test(l[a - 1]) && qs.test(l[a])) {
				l = l.slice(0, a);
				break;
			}
...
function DS(n) {
	let e = n.map((r) => (typeof r == 'string' ? { label: r } : r)),
		[t, i] = e.every((r) => /^\w+$/.test(r.label)) ? [/\w*$/, /\w+$/] : SS(e);
	return (r) => {
	...
	return {
		...n.changeByRange((l) => {
			...
			return {
				...
				range: T.cursor(l.from + s + a.length),
			};
		}),
		scrollIntoView: !0,
...
class QS {
	...
	match(e) {
		...
		let a = t.length,
			u = 0;
		if (l < 0) {
			for (let S = 0, w = Math.min(e.length, 200); S < w && u < a; ) {
				let k = tt(e, S);
				((k == t[u] || k == i[u]) && (r[u++] = S), (S += zt(k)));
			}
			if (u < a) return null;
		}
		let c = 0,
			...
			m = /[a-z]/.test(e),
			g = !0;
		for (let S = 0, w = Math.min(e.length, 200), k = 0; S < w && h < a; ) {
			let x = tt(e, S);
			l < 0 &&
				(c < a && x == t[c] && (s[c++] = S),
				d < a &&
	...
	result(e, t, i) {
		let r = [],
			s = 0;
		for (let o of t) {
			let l = o + (this.astral ? zt(tt(i, o)) : 1);
	...
	combine(n) {
		return Ut(
			...
			},
			{
				...
				closeOnBlur: (e, t) => e && t,
				icons: (e, t) => e && t,
				tooltipClass: (e, t) => (i) => Kh(e(i), t(i)),
				optionClass: (e, t) => (i) => Kh(e(i), t(i)),
...
function kS(n, e, t, i, r, s) {
	let o = n.textDirection == ye.RTL,
		...
		O = i.bottom - i.top;
	if (
		(l && f < Math.min(p, d) ? (l = !1) : !l && d < Math.min(p, f) && (l = !0),
		p <= (l ? f : d))
	)
		((c = Math.max(r.top, Math.min(t.top, r.bottom - O)) - e.top),
			(h = Math.min(400, l ? f : d)));
	else {
		((a = !0), (h = Math.min(400, (o ? e.right : r.right - e.left) - 30)));
		let S = r.bottom - e.bottom;
		S >= O || S > e.top
			? (c = t.bottom - e.top)
			: ((u = 'bottom'), (c = e.bottom - t.top));
	}
		...
		e.push(
			{
				render(t, i, r, s) {
					...
					for (let u = 0; u < s.length; ) {
						...
						(f.appendChild(document.createTextNode(l.slice(c, h))),
...
class PS {
	constructor(e, t, i) {
		...
		let r = e.state.field(t),
			...
			l = e.state.facet(_e);
		((this.optionContent = AS(l)),
			(this.optionClass = l.optionClass),
			(this.tooltipClass = l.tooltipClass),
			(this.range = na(s.length, o, l.maxRenderedOptions)),
			(this.dom = document.createElement('div')),
					...
					let c =
						...
						a.clientY < this.list.firstChild.getBoundingClientRect().top
							...
							: this.list.classList.contains(
								...
								? this.range.to
								: null;
					c != null && (e.dispatch({ effects: ic.of(c) }), a.preventDefault());
				}
			}),
			this.dom.addEventListener('focusout', (a) => {
				...
				u &&
					u.tooltip &&
					e.state.facet(_e).closeOnBlur &&
					a.relatedTarget != e.contentDOM &&
					e.dispatch({ effects: Rr.of(null) });
			}),
	...
	update(e) {
		...
		if ((this.updateTooltipClass(e.state), i != r)) {
			...
			((!r.open || r.open.options != s) &&
				((this.range = na(s.length, o, e.state.facet(_e).maxRenderedOptions)),
	...
	updateSel() {
		...
		((t.selected > -1 && t.selected < this.range.from) ||
			...
			((this.range = na(
				t.options.length,
				t.selected,
				this.view.state.facet(_e).maxRenderedOptions,
			)),
				...
				? o
						.then((l) => {
							l &&
								...
								this.addInfoPane(l, r);
						})
						.catch((l) => rt(this.view.state, l, 'completion info'))
	...
	measureInfo() {
		...
		return r.top > Math.min(s.bottom, t.bottom) - 10 ||
			...
			? null
			: this.view.state.facet(_e).positionInfo(this.view, t, r, i, s, this.dom);
	}
	placeInfo(e) {
		this.info &&
			(e
...
function TS(n, e) {
	let t = [],
		...
		s = (c) => {
			...
			if (h) {
				...
				i.some((d) => d.name == f) ||
					i.push(typeof h == 'string' ? { name: f } : h);
			}
		},
		o = e.facet(_e);
	for (let c of n)
		if (c.hasResult()) {
			...
			if (c.result.filter === !1)
				for (let f of c.result.options)
					s(new Uh(f, c.source, h ? h(f) : [], 1e9 - t.length));
			else {
				let f = e.sliceDoc(c.from, c.to),
					d,
					p = o.filterStrict ? new CS(f) : new QS(f);
				for (let O of c.result.options)
					if ((d = p.match(O.label))) {
						let m = O.displayLabel ? (h ? h(O, d.matched) : []) : d.matched,
							g = d.score + (O.boost || 0);
						if (
							(s(new Uh(O, c.source, m, g)),
							typeof O.section == 'object' && O.section.rank === 'dynamic')
						) {
							let { name: S } = O.section;
							(r || (r = Object.create(null)),
								(r[S] = Math.max(g, r[S] || -1e9)));
						}
					}
			}
		}
	if (i) {
		let c = Object.create(null),
			...
			f = (d, p) =>
				...
				(d.name < p.name ? -1 : 1);
		for (let d of i.sort(f)) ((h -= 1e5), (c[d.name] = h));
		for (let d of t) {
	...
	let l = [],
		a = null,
		u = o.compareCompletions;
	for (let c of t.sort(
		(h, f) => f.score - h.score || u(h.completion, f.completion),
	)) {
		let h = c.completion;
		(!a ||
		a.label != h.label ||
		a.detail != h.detail ||
		(a.type != null && h.type != null && a.type != h.type) ||
		a.apply != h.apply ||
		a.boost != h.boost
			? l.push(c)
			: Jh(c.completion) > Jh(a) && (l[l.length - 1] = c),
			(a = c.completion));
	}
	return l;
}
class An {
	...
	static build(e, t, i, r, s, o) {
		if (r && !o && e.some((u) => u.isPending)) return r.setDisabled();
		let l = TS(e, t);
		if (!l.length)
...
class Zo {
	...
	update(e) {
		let { state: t } = e,
			i = t.facet(_e),
			s = (i.override || t.languageDataAt('autocomplete', Yi(t)).map(vS)).map(
				(a) =>
					(
						this.active.find((c) => c.source == a) ||
						new bt(a, this.active.some((c) => c.state != 0) ? 1 : 0)
					).update(e, i),
			);
		s.length == this.active.length &&
			s.every((a, u) => a == this.active[u]) &&
			(s = this.active);
		let o = this.open,
			l = e.effects.some((a) => a.is(nc));
		(o && e.docChanged && (o = o.map(e.changes)),
			e.selection ||
			s.some((a) => a.hasResult() && e.changes.touchesRange(a.from, a.to)) ||
			!ZS(s, this.active) ||
			l
				? (o = An.build(s, t, this.id, o, i, l))
				: o && o.disabled && !s.some((a) => a.isPending) && (o = null),
			!o &&
				s.every((a) => !a.isPending) &&
				s.some((a) => a.hasResult()) &&
				(s = s.map((a) => (a.hasResult() ? new bt(a.source, 0) : a))));
		for (let a of e.effects)
			a.is(ic) && (o = o && o.setSelected(a.value, this.id));
		return s == this.active && o == this.open ? this : new Zo(s, this.id, o);
	}
	get tooltip() {
		return this.open ? this.open.tooltip : null;
	}
	get attrs() {
		return this.open ? this.open.attrs : this.active.length ? MS : RS;
	}
}
function ZS(n, e) {
	if (n == e) return !0;
...
const MS = { 'aria-autocomplete': 'list' },
	RS = {};
function ef(n, e) {
	let t = {
...
class bt {
	...
	update(e, t) {
		let i = YO(e, t),
			r = this;
		((i & 8 || (i & 16 && this.touches(e))) && (r = new bt(r.source, 0)),
			i & 4 && r.state == 0 && (r = new bt(this.source, 1)),
			(r = r.updateFor(e, i)));
		for (let s of e.effects)
			if (s.is(To)) r = new bt(r.source, 1, s.value);
			else if (s.is(Rr)) r = new bt(r.source, 0);
			else if (s.is(nc)) for (let o of s.value) o.source == r.source && (r = o);
		return r;
	}
	updateFor(e, t) {
	...
	touches(e) {
		return e.changes.touchesRange(Yi(e.state));
	}
}
class Mn extends bt {
	constructor(e, t, i, r, s, o) {
	...
	updateFor(e, t) {
		...
		if (
			l > o ||
			!r ||
			(t & 2 && (Yi(e.startState) == this.from || l < this.limit))
		)
			return new bt(this.source, t & 4 ? 1 : 0);
		let a = e.changes.mapPos(this.limit);
		return FS(r.validFor, e.state, s, o)
			? new Mn(this.source, this.explicit, a, r, s, o)
			: r.update && (r = r.update(r, s, o, new IO(e.state, l, !1)))
				? new Mn(
						this.source,
						this.explicit,
						a,
						r,
						r.from,
						(i = r.to) !== null && i !== void 0 ? i : Yi(e.state),
					)
				: new bt(this.source, 1, this.explicit);
	}
	map(e) {
		return e.empty
			? this
...
function FS(n, e, t, i) {
	...
	return typeof n == 'function' ? n(r, t, i, e) : qO(n, !0).test(r);
}
const nc = re.define({
		map(n, e) {
	...
	it = Ve.define({
		...
		provide: (n) => [
			Lu.from(n, (e) => e.tooltip),
			X.contentAttributes.from(n, (e) => e.attrs),
		],
	});
function rc(n, e) {
	const t = e.completion.apply || e.completion.label;
	let i = n.state.field(it).active.find((r) => r.source == e.source);
	return i instanceof Mn
		? (typeof t == 'string'
				? n.dispatch({
						...wS(n.state, t, i.from, i.to),
...
function Vs(n, e = 'option') {
	return (t) => {
		let i = t.state.field(it, !1);
		if (
			!i ||
			!i.open ||
			i.open.disabled ||
			Date.now() - i.open.timestamp < t.state.facet(_e).interactionDelay
		)
			return !1;
		let r = 1,
			s;
		e == 'page' &&
			(s = gp(t, i.open.tooltip)) &&
			(r = Math.max(
				2,
				Math.floor(
...
const XS = (n) => {
		...
		return n.state.readOnly ||
			...
			e.open.selected < 0 ||
			e.open.disabled ||
			Date.now() - e.open.timestamp < n.state.facet(_e).interactionDelay
			? !1
			: rc(n, e.open.options[e.open.selected]);
	},
	ra = (n) =>
		n.state.field(it, !1) ? (n.dispatch({ effects: To.of(!0) }), !0) : !1,
	jS = (n) => {
		let e = n.state.field(it, !1);
		return !e || !e.active.some((t) => t.state != 0)
			? !1
			: (n.dispatch({ effects: Rr.of(null) }), !0);
	};
class LS {
	constructor(e, t) {
		((this.active = e),
		...
		class {
			constructor(n) {
				((this.view = n),
					...
					(this.pendingStart = !1),
					(this.composing = 0));
				for (let e of n.state.field(it).active)
					e.isPending && this.startQuery(e);
			}
			update(n) {
				let e = n.state.field(it),
					t = n.state.facet(_e);
				...
				for (let s = 0; s < this.running.length; s++) {
					...
					if (
						...
						(o.updates.length + n.transactions.length > zS &&
							Date.now() - o.time > WS)
					) {
				...
				(this.debounceUpdate > -1 && clearTimeout(this.debounceUpdate),
					n.transactions.some((s) => s.effects.some((o) => o.is(To))) &&
						(this.pendingStart = !0));
			...
			startUpdate() {
				...
				this.running.length &&
					...
					(this.debounceAccept = setTimeout(
						() => this.accept(),
						this.view.state.facet(_e).updateSyncTime,
					));
			}
			startQuery(n) {
				let { state: e } = this.view,
					t = Yi(e),
					i = new IO(e, t, n.explicit, this.view),
					r = new LS(n, i);
				(this.running.push(r),
					Promise.resolve(n.source(i)).then(
						...
						(s) => {
							(this.view.dispatch({ effects: Rr.of(null) }),
			...
			accept() {
				...
				(this.debounceAccept > -1 && clearTimeout(this.debounceAccept),
					(this.debounceAccept = -1));
				let e = [],
					t = this.view.state.facet(_e),
					i = this.view.state.field(it);
				for (let r = 0; r < this.running.length; r++) {
					...
					if ((this.running.splice(r--, 1), s.done)) {
						...
						for (let c of s.updates) u = u.update(c, t);
						if (u.hasResult()) {
							e.push(u);
							continue;
						}
			...
			eventHandlers: {
				blur(n) {
					...
					if (e && e.tooltip && this.view.state.facet(_e).closeOnBlur) {
						let t = e.open && gp(this.view, e.open.tooltip);
				...
				compositionend() {
					(this.composing == 3 &&
						setTimeout(() => this.view.dispatch({ effects: To.of(!1) }), 20),
						(this.composing = 0));
				},
			},
		},
	),
	qS = typeof navigator == 'object' && /Win/.test(navigator.platform),
	VS = Ki.highest(
		X.domEventHandlers({
			keydown(n, e) {
				...
				return (s && s.indexOf(n.key) > -1 && rc(e, i), !1);
			},
		}),
	),
	YS = X.baseTheme({
...
const NO = Ve.define({
	...
	update(n, e) {
		...
		for (let t of e.effects)
			t.is(Ii) && (n = n.update({ add: [sc.range(t.value, t.value + 1)] }));
		return n;
	},
});
function GO() {
...
const sa = '()[]{}<>«»»«［］｛｝';
function UO(n) {
	for (let e = 0; e < sa.length; e += 2)
		if (sa.charCodeAt(e) == n) return sa.charAt(e + 1);
	return vu(n < 128 ? n : n + 1);
}
function HO(n, e) {
	return n.languageDataAt('closeBrackets', e)[0] || Br;
}
const NS =
		typeof navigator == 'object' && /Android\b/.test(navigator.userAgent),
	GS = X.inputHandler.of((n, e, t, i) => {
		if ((NS ? n.composing : n.compositionStarted) || n.state.readOnly)
			return !1;
		let r = n.state.selection.main;
		if (
			i.length > 2 ||
			(i.length == 2 && zt(tt(i, 0)) == 1) ||
			e != r.from ||
			t != r.to
		)
			return !1;
	...
	US = ({ state: n, dispatch: e }) => {
		if (n.readOnly) return !1;
		let i = HO(n, n.selection.main.head).brackets || Br.brackets,
			r = null,
			s = n.changeByRange((o) => {
				if (o.empty) {
					let l = JS(n.doc, o.head);
					for (let a of i)
						if (a == l && tl(n.doc, o.head) == UO(tt(a, 0)))
							return {
								changes: { from: o.head - a.length, to: o.head + a.length },
								range: T.cursor(o.head - a.length),
							};
				}
				return { range: (r = o) };
			});
	...
	HS = [{ key: 'Backspace', run: US }];
function KS(n, e) {
	let t = HO(n, n.selection.main.head),
		i = t.brackets || Br.brackets;
	for (let r of i) {
		let s = UO(tt(r, 0));
		if (e == r)
			return s == r
				? iD(n, r, i.indexOf(r + r + r) > -1, t)
				: eD(n, r, s, t.before || Br.before);
		if (e == s && KO(n, n.selection.main.from)) return tD(n, r, s);
	}
	return null;
}
function KO(n, e) {
	let t = !1;
	return (
		n.field(NO).between(0, n.doc.length, (i) => {
			i == e && (t = !0);
		}),
		t
	);
...
function tl(n, e) {
	...
	return t.slice(0, zt(tt(t, 0)));
}
function JS(n, e) {
	let t = n.sliceString(e - 2, e);
	return zt(tt(t, 0)) == t.length ? t : t.slice(1);
}
function eD(n, e, t, i) {
	let r = null,
		s = n.changeByRange((o) => {
...
function tD(n, e, t) {
	let i = null,
		r = n.changeByRange((s) =>
			s.empty && tl(n.doc, s.head) == t
				? {
						changes: { from: s.head, to: s.head + t.length, insert: t },
						range: T.cursor(s.head + t.length),
					}
				: (i = { range: s }),
		);
	return i
...
function iD(n, e, t, i) {
	let r = i.stringPrefixes || Br.stringPrefixes,
		s = null,
		o = n.changeByRange((l) => {
			if (!l.empty)
				return {
...
function nf(n, e, t) {
	let i = n.charCategorizer(e);
	if (i(n.sliceDoc(e - 1, e)) != ve.Word) return e;
	for (let r of t) {
		let s = e - r.length;
...
function rD(n = {}) {
	return [VS, it, _e.of(n), IS, sD, YS];
}
const JO = [
		{ key: 'Ctrl-Space', run: ra },
		{ mac: 'Alt-`', run: ra },
		{ mac: 'Alt-i', run: ra },
		{ key: 'Escape', run: jS },
		{ key: 'ArrowDown', run: Vs(!0) },
		{ key: 'ArrowUp', run: Vs(!1) },
		{ key: 'PageDown', run: Vs(!0, 'page') },
		{ key: 'PageUp', run: Vs(!1, 'page') },
		{ key: 'Enter', run: XS },
	],
	sD = Ki.highest(
		zr.computeN([_e], (n) => (n.facet(_e).defaultKeymap ? [JO] : [])),
	);
class rf {
	constructor(e, t, i) {
...
class Li {
	...
	static init(e, t, i) {
		let r = i.facet(Fr).markerFilter;
		r && (e = r(e, i));
		let s = e.slice().sort((d, p) => d.from - p.from || d.to - p.to),
			o = new hi(),
			l = [],
			a = 0,
			u = i.doc.iter(),
		...
		for (let d = 0; ; ) {
			...
			if (l.length)
				((O = a),
					(m = l.reduce(
						(w, k) => Math.min(w, k.to),
						p && p.from > O ? p.from : 1e8,
					)));
			else {
				if (((O = p.from), O > h)) break;
				((m = p.to), l.push(p), d++);
			}
			for (; d < s.length; ) {
				let w = s[d];
				if (w.from == O && (w.to > w.from || w.to == O))
			...
			let g = !1;
			if (
				l.some((w) => w.from == O && (w.to == m || m == h)) &&
				((g = O == m), !g && m - O < 10)
			) {
				let w = O - (c + u.value.length);
				w > 0 && (u.next(w), (c = O));
				for (let k = O; ; ) {
					if (k >= m) {
						g = !0;
					...
					if (!u.lineBreak && c + u.value.length > k) break;
					((k = c + u.value.length), (c += u.value.length), u.next());
				}
			}
			let S = yD(l);
			if (g)
				o.add(O, O, U.widget({ widget: new pD(S), diagnostics: l.slice() }));
			else {
				let w = l.reduce(
					(k, x) => (x.markClass ? k + ' ' + x.markClass : k),
					'',
				);
				o.add(
					O,
					m,
					U.mark({
						class: 'cm-lintRange cm-lintRange-' + S + w,
						diagnostics: l.slice(),
			...
			if (((a = m), a == h)) break;
			for (let w = 0; w < l.length; w++) l[w].to <= a && l.splice(w--, 1);
		}
		let f = o.finish();
		return new Li(f, t, Pi(f));
	}
}
	...
	return (
		n.between(t, 1e9, (r, s, { spec: o }) => {
			if (!(e && o.diagnostics.indexOf(e) < 0))
				if (!i) i = new rf(r, s, e || o.diagnostics[0]);
				else {
					if (o.diagnostics.indexOf(i.diagnostic) < 0) return !1;
					i = new rf(i.from, s, i.diagnostic);
				}
		}),
		i
	);
...
function oD(n, e) {
	let t = e.pos,
		i = e.end || t,
		r = n.state.facet(Fr).hideOn(n, t, i);
	if (r != null) return r;
	let s = n.startState.doc.lineAt(e.pos);
	return !!(
		n.effects.some((o) => o.is(em)) ||
		n.changes.touchesRange(s.from, Math.max(s.to, i))
	);
}
function lD(n, e) {
	return n.field(pt, !1) ? e : e.concat(re.appendConfig.of(xD));
}
const em = re.define(),
	oc = re.define(),
	tm = re.define(),
	pt = Ve.define({
		create() {
			return new Li(U.none, null, null);
		},
		update(n, e) {
			if (e.docChanged && n.diagnostics.size) {
				...
				(!t.size && r && e.state.facet(Fr).autoPanel && (r = null),
					(n = new Li(t, r, i)));
			}
			for (let t of e.effects)
				if (t.is(em)) {
					let i = e.state.facet(Fr).autoPanel
						? t.value.length
							? _r.open
							: null
						: n.panel;
					n = Li.init(t.value, i, e.state);
				} else
					t.is(oc)
						? (n = new Li(n.diagnostics, t.value ? _r.open : null, n.selected))
						: t.is(tm) && (n = new Li(n.diagnostics, n.panel, t.value));
			return n;
		},
		provide: (n) => [
			$r.from(n, (e) => e.panel),
			X.decorations.from(n, (e) => e.diagnostics),
		],
	}),
	aD = U.mark({ class: 'cm-lintRange cm-lintRange-active' });
function uD(n, e, t) {
	let { diagnostics: i } = n.state.field(pt),
		r,
		s = -1,
		o = -1;
	i.between(e - (t < 0 ? 1 : 0), e + (t > 0 ? 1 : 0), (a, u, { spec: c }) => {
		if (e >= a && e <= u && (a == u || ((e > a || t > 0) && (e < u || t < 0))))
			return ((r = c.diagnostics), (s = a), (o = u), !1);
	});
...
const hD = (n) => {
		...
		(!e || !e.panel) && n.dispatch({ effects: lD(n.state, [oc.of(!0)]) });
		let t = zu(n, _r.open);
		return (t && t.dom.querySelector('.cm-panel-lint ul').focus(), !0);
	},
	sf = (n) => {
		let e = n.state.field(pt, !1);
		return !e || !e.panel ? !1 : (n.dispatch({ effects: oc.of(!1) }), !0);
	},
	fD = (n) => {
		let e = n.state.field(pt, !1);
		if (!e) return !1;
		let t = n.state.selection.main,
			i = Pi(e.diagnostics, null, t.to + 1);
		return !i &&
			((i = Pi(e.diagnostics, null, 0)),
	...
	dD = [
		{ key: 'Mod-Shift-m', run: hD, preventDefault: !0 },
		{ key: 'F8', run: fD },
	],
	Fr = L.define({
		combine(n) {
			...
			: i.map((s, o) => {
					let l = !1,
						a = (d) => {
							...
							l = !0;
							let p = Pi(n.state.field(pt).diagnostics, e);
							p && s.apply(n, p.from, p.to);
						},
						{ name: u } = s,
						c = r[o] ? u.indexOf(r[o]) : -1,
						h =
							c < 0
								? u
								: [u.slice(0, c), me('u', u.slice(c, c + 1)), u.slice(c + 1)],
...
class pD extends Ht {
	...
	toDOM() {
		return me('span', { class: 'cm-lintPoint cm-lintPoint-' + this.sev });
	}
}
class lf {
	constructor(e, t) {
...
class _r {
	constructor(e) {
		...
		let t = (r) => {
				if (!(r.ctrlKey || r.altKey || r.metaKey)) {
					if (r.keyCode == 27) (sf(this.view), this.view.focus());
						...
						for (let l = 0; l < o.length; l++)
							if (o[l].toUpperCase().charCodeAt(0) == r.keyCode) {
								let a = Pi(this.view.state.field(pt).diagnostics, s);
	...
	update() {
		let { diagnostics: e, selected: t } = this.view.state.field(pt),
			...
			o = new Set();
		for (
			e.between(0, this.view.state.doc.length, (l, a, { spec: u }) => {
				for (let c of u.diagnostics) {
					...
					(h < 0
						? ((f = new lf(this.view, c)), this.items.splice(i, 0, f), (r = !0))
						: ((f = this.items[h]),
							h > i && (this.items.splice(i, h - i), (r = !0))),
						t && f.diagnostic == t.diagnostic
							? f.dom.hasAttribute('aria-selected') ||
								(f.dom.setAttribute('aria-selected', 'true'), (s = f))
							: f.dom.hasAttribute('aria-selected') &&
								f.dom.removeAttribute('aria-selected'),
						i++);
				}
			});
			i < this.items.length &&
				...
				? (this.list.setAttribute('aria-activedescendant', s.id),
					this.view.requestMeasure({
						...
						write: ({ sel: l, panel: a }) => {
							...
							l.top < a.top
								? (this.list.scrollTop -= (a.top - l.top) / u)
								: l.bottom > a.bottom &&
									(this.list.scrollTop += (l.bottom - a.bottom) / u);
						},
					}))
				: this.selectedIndex < 0 &&
	...
	moveSelection(e) {
		...
		let t = this.view.state.field(pt),
			i = Pi(t.diagnostics, this.items[e].diagnostic);
		i &&
			this.view.dispatch({
				selection: { anchor: i.from, head: i.to },
				scrollIntoView: !0,
...
function OD(n, e = 'viewBox="0 0 40 40"') {
...
const mD = X.baseTheme({
	...
	'.cm-lintRange-error': { backgroundImage: Ys('#d11') },
	'.cm-lintRange-warning': { backgroundImage: Ys('orange') },
	'.cm-lintRange-info': { backgroundImage: Ys('#999') },
	'.cm-lintRange-hint': { backgroundImage: Ys('#66d') },
...
var af = function (e) {
	...
	var { crosshairCursor: t = !1 } = e,
		i = [];
	(e.closeBracketsKeymap !== !1 && (i = i.concat(HS)),
		e.defaultKeymap !== !1 && (i = i.concat(ZO)),
		e.searchKeymap !== !1 && (i = i.concat(gS)),
		e.historyKeymap !== !1 && (i = i.concat(sO)),
		e.foldKeymap !== !1 && (i = i.concat(gx)),
		e.completionKeymap !== !1 && (i = i.concat(JO)),
		e.lintKeymap !== !1 && (i = i.concat(dD)));
	var r = [];
	return (
		e.lineNumbers !== !1 && r.push(wp()),
		e.highlightActiveLineGutter !== !1 && r.push(vp()),
		e.highlightSpecialChars !== !1 && r.push(pp()),
		e.history !== !1 && r.push(tO()),
		e.foldGutter !== !1 && r.push(Sx()),
		e.drawSelection !== !1 && r.push(hp()),
		e.dropCursor !== !1 && r.push(W1()),
		e.allowMultipleSelections !== !1 &&
			r.push(fe.allowMultipleSelections.of(!0)),
		e.indentOnInput !== !1 && r.push(Fp()),
		e.syntaxHighlighting !== !1 && r.push(Uo(Yp, { fallback: !0 })),
		e.bracketMatching !== !1 && r.push(Hp()),
		e.closeBrackets !== !1 && r.push(GO()),
		e.autocompletion !== !1 && r.push(rD()),
		e.rectangularSelection !== !1 && r.push(ly()),
		t !== !1 && r.push(cy()),
		e.highlightActiveLine !== !1 && r.push(Op()),
		e.highlightSelectionMatches !== !1 && r.push(FO()),
		e.tabSize &&
			typeof e.tabSize == 'number' &&
			r.push(Yo.of(' '.repeat(e.tabSize))),
		r.concat([zr.of(i.flat())]).filter(Boolean)
	);
};
const bD = '#e5c07b',
	uf = '#e06c75',
	...
	AD = X.theme(
		{
			'&': { color: ro, backgroundColor: ff },
			'.cm-content': { caretColor: df },
			'.cm-cursor, .cm-dropCursor': { borderLeftColor: df },
			'&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection':
				{ backgroundColor: kD },
			'.cm-panels': { backgroundColor: CD, color: ro },
			...
			'.cm-gutters': { backgroundColor: ff, color: du, border: 'none' },
			'.cm-activeLineGutter': { backgroundColor: hf },
			'.cm-foldPlaceholder': {
				backgroundColor: 'transparent',
				border: 'none',
				color: '#ddd',
			},
			'.cm-tooltip': { border: 'none', backgroundColor: oa },
			...
			'.cm-tooltip .cm-tooltip-arrow:after': {
				borderTopColor: oa,
				borderBottomColor: oa,
			},
			'.cm-tooltip-autocomplete': {
				'& > ul > li[aria-selected]': { backgroundColor: hf, color: ro },
			},
		},
		{ dark: !0 },
	),
	PD = In.define([
		{ tag: y.keyword, color: QD },
		{
			tag: [y.name, y.deleted, y.character, y.propertyName, y.macroName],
			color: uf,
		},
		{ tag: [y.function(y.variableName), y.labelName], color: wD },
		{ tag: [y.color, y.constant(y.name), y.standard(y.name)], color: cf },
		{ tag: [y.definition(y.name), y.separator], color: ro },
		{
			tag: [
				y.typeName,
				y.className,
		...
		{ tag: [y.meta, y.comment], color: du },
		{ tag: y.strong, fontWeight: 'bold' },
		{ tag: y.emphasis, fontStyle: 'italic' },
		{ tag: y.strikethrough, textDecoration: 'line-through' },
		{ tag: y.link, color: du, textDecoration: 'underline' },
		{ tag: y.heading, fontWeight: 'bold', color: uf },
		{ tag: [y.atom, y.bool, y.special(y.variableName)], color: cf },
		{ tag: [y.processingInstruction, y.string, y.inserted], color: vD },
		{ tag: y.invalid, color: DD },
	]),
	$D = [AD, Uo(PD)];
var ED = X.theme({ '&': { backgroundColor: '#fff' } }, { dark: !1 }),
	TD = function (e) {
		e === void 0 && (e = {});
		var {
				indentWithTab: t = !0,
			...
			a = [];
		switch (
			(t && a.unshift(zr.of([Vb])),
			l && (typeof l == 'boolean' ? a.unshift(af()) : a.unshift(af(l))),
			o && a.unshift(ny(o)),
			s)
		) {
			case 'light':
		...
		return (
			i === !1 && a.push(X.editable.of(!1)),
			r && a.push(fe.readOnly.of(!0)),
			[...a]
		);
	},
	ZD = (n) => ({
...
var la = null,
	RD = () => (typeof window > 'u' ? new pf() : (la || (la = new pf()), la)),
	Of = Gt.define(),
	BD = 200,
	FD = [];
function _D(n) {
	var {
		...
		[v, D] = I.useState(),
		[P, $] = I.useState(),
		A = I.useState(() => ({ current: null }))[0],
		R = I.useState(() => ({ current: null }))[0],
		z = X.theme({
			'&': {
				height: c,
				minHeight: h,
		...
		N = X.updateListener.of((M) => {
			if (
				M.docChanged &&
				typeof i == 'function' &&
				!M.transactions.some((Q) => Q.annotation(Of))
			) {
				A.current
					? A.current.reset()
					: ((A.current = new MD(() => {
		...
		te = [N, z, ...q];
	return (
		o && typeof o == 'function' && te.push(X.updateListener.of(o)),
		(te = te.concat(l)),
		I.useLayoutEffect(() => {
			if (E && !P) {
				var M = { doc: e, selection: t, extensions: te },
					V = C ? fe.fromJSON(C.json, M, C.fields) : fe.create(M);
				if (($(V), !v)) {
					var se = new X({ state: V, parent: E, root: x });
					(D(se), s && s(se, V));
				}
			}
			return () => {
		...
		I.useEffect(() => {
			n.container && B(n.container);
		}, [n.container]),
		I.useEffect(
			() => () => {
				(v && (v.destroy(), D(void 0)),
					A.current && (A.current.cancel(), (A.current = null)));
			},
			[v],
		),
		I.useEffect(() => {
		...
		I.useEffect(() => {
			v && v.dispatch({ effects: re.reconfigure.of(te) });
		}, [u, l, c, h, f, d, p, O, m, g, S, w, k, i, o]),
		I.useEffect(() => {
			if (e !== void 0) {
				var M = v ? v.state.doc.toString() : '';
				if (v && e !== M) {
					var V = A.current && !A.current.isDone,
						se = () => {
							v &&
								e !== v.state.doc.toString() &&
								v.dispatch({
									changes: {
										from: 0,
										to: v.state.doc.toString().length,
										insert: e || '',
									},
									annotations: [Of.of(!0)],
								});
...
var XD = [
	...
	rm = I.forwardRef((n, e) => {
		...
		I.useImperativeHandle(e, () => ({ editor: D.current, state: P, view: $ }), [
			D,
			A,
			P,
			$,
		...
		var N = typeof h == 'string' ? 'cm-theme-' + h : 'cm-theme';
		return b.jsx(
			'div',
			Cm({ ref: z, className: '' + N + (t ? ' ' + t : '') }, v),
		);
	});
rm.displayName = 'CodeMirror';
var mf = {};
class Mo {
	constructor(e, t, i, r, s, o, l, a, u, c = 0, h) {
		((this.p = e),
			(this.stack = t),
			(this.state = i),
			(this.reducePos = r),
	...
	reduce(e) {
		...
		c >= 2e3 &&
			...
			(u == this.p.lastBigReductionStart
				? (this.p.bigReductionCount++, (this.p.lastBigReductionSize = c))
				: this.p.lastBigReductionSize < c &&
					((this.p.bigReductionCount = 1),
					(this.p.lastBigReductionStart = u),
					(this.p.lastBigReductionSize = c)));
		let h = a ? this.stack[a - 1] : 0,
			f = this.bufferBase + this.buffer.length - h;
	...
	shift(e, t, i, r) {
		if (e & 131072) this.pushState(e & 65535, this.pos);
			...
			(!l && (r > i || t <= o.maxNode) && (this.reducePos = r),
				this.pushState(s, l ? i : Math.min(i, this.reducePos)),
	...
	updateContext(e) {
		if (e != this.curContext.context) {
			let t = new gf(this.curContext.tracker, e);
			(t.hash != this.curContext.hash && this.emitContext(),
				(this.curContext = t));
		}
	}
	setLookAhead(e) {
		return e <= this.lookAhead
			? !1
			: (this.emitLookAhead(), (this.lookAhead = e), !0);
	}
	close() {
...
class Ro {
	...
	static create(e, t = e.bufferBase + e.buffer.length) {
		return new Ro(e, t, t - e.bufferBase);
	}
	maybeNext() {
	...
	fork() {
		return new Ro(this.stack, this.pos, this.index);
	}
}
function cr(n, e = Uint16Array) {
...
class pu {
	constructor(e, t, i) {
		((this.precTable = t),
			(this.elseToken = i),
			(this.data = typeof e == 'string' ? cr(e) : e));
	}
	token(e, t) {
		let i = e.pos,
			r = 0;
		for (;;) {
			...
			if (
				(sm(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1)
			)
				break;
...
pu.prototype.contextual = Rn.prototype.fallback = Rn.prototype.extend = !1;
class Vr {
	constructor(e, t = {}) {
		((this.token = e),
...
function zD(n, e, t, i) {
	let r = xf(t, i, e);
	return r < 0 || xf(t, i, n) < r;
}
const ut = typeof process < 'u' && mf && /\bparse\b/.test(mf.LOG);
let aa = null;
function bf(n, e, t) {
	let i = n.cursor(Qe.IncludeAnonymous);
	for (i.moveTo(e); ; )
		...
		if (e) {
			for (
				this.safeFrom = e.openStart
					? bf(e.tree, e.from + e.offset, 1) - e.offset
					: e.from,
					this.safeTo = e.openEnd
						? bf(e.tree, e.to + e.offset, -1) - e.offset
						: e.to;
				this.trees.length;
			)
...
class ID {
	constructor(e, t) {
		((this.stream = t),
			...
			(this.mainToken = null),
			(this.actions = []),
			(this.tokens = e.tokenizers.map((i) => new so())));
	}
	getActions(e) {
		let t = 0,
			i = null,
		...
		for (let u = 0; u < s.length; u++) {
			...
			if (
				!(i && !c.fallback) &&
				((c.contextual || h.start != e.pos || h.mask != o || h.context != l) &&
					(this.updateCachedToken(h, c, e), (h.mask = o), (h.context = l)),
	...
	addActions(e, t, i, r) {
		...
		for (let a = 0; a < 2; a++)
			for (let u = o.stateSlot(s, a ? 2 : 1); ; u += 3) {
				if (l[u] == 65535)
					if (l[u + 1] == 1) u = si(l, u + 2);
					else {
						r == 0 &&
							l[u + 1] == 2 &&
							(r = this.putAction(si(l, u + 2), t, i, r));
						break;
					}
				l[u] == t && (r = this.putAction(si(l, u + 1), t, i, r));
			}
		return r;
	}
}
class qD {
	constructor(e, t, i, r) {
		((this.parser = e),
			...
			(this.stream = new LD(t, r)),
			(this.tokens = new ID(e, this.stream)),
			(this.topTerm = e.top[1]));
		let { from: s } = r[0];
		((this.stacks = [Mo.start(this, e.top[0], s)]),
			(this.fragments =
	...
	advance() {
		...
		if (!i.length) {
			...
			if (o)
				return (
					ut && console.log('Finish with ' + this.stackID(o)),
					this.stackToTree(o)
				);
		...
		if (this.recovering && r) {
			...
			if (o)
				return (
					ut && console.log('Force-finish ' + this.stackID(o)),
		...
		if (this.recovering) {
			...
			e: for (let o = 0; o < i.length - 1; o++) {
				...
				for (let a = o + 1; a < i.length; a++) {
					...
					if (
						l.sameState(u) ||
						(l.buffer.length > 500 && u.buffer.length > 500)
					)
			...
			i.length > 12 &&
				(i.sort((o, l) => l.score - o.score), i.splice(12, i.length - 12));
		}
	...
	advanceStack(e, t, i) {
		...
		if (this.fragments) {
			let u = e.curContext && e.curContext.tracker.strict,
				c = u ? e.curContext.hash : 0;
			for (let h = this.fragments.nodeAt(r); h; ) {
				let f =
					this.parser.nodeSet.types[h.type.id] == h.type
						? s.getGoto(e.state, h.type.id)
						: -1;
				if (f > -1 && h.length && (!u || (h.prop(ue.contextHash) || 0) == c))
					return (
						e.useNode(h, f),
						ut &&
							console.log(
								o + this.stackID(e) + ` (via reuse of ${s.getName(h.type.id)})`,
							),
						!0
					);
				if (!(h instanceof Te) || h.children.length == 0 || h.positions[0] > 0)
					break;
				let d = h.children[0];
				if (d instanceof Te && h.positions[0] == 0) h = d;
				else break;
			}
		}
		...
		for (let u = 0; u < a.length; ) {
			...
			if (
				(p.apply(c, h, O ? O.start : p.pos, f),
				ut &&
					console.log(
						o +
							this.stackID(p) +
							` (via ${(c & 65536) == 0 ? 'shift' : `reduce of ${s.getName(c & 65535)}`} for ${s.getName(h)} @ ${r}${p == e ? '' : ', split'})`,
					),
				d)
			)
				return !0;
		...
		for (let o = 0; o < e.length; o++) {
			...
			if (
				...
				(s ||
					((s = !0),
					l.restart(),
					ut && console.log(c + this.stackID(l) + ' (restarted)'),
			...
			for (
				...
				d < 10 &&
				h.forceReduce() &&
				(ut && console.log(f + this.stackID(h) + ' (via force-reduce)'),
				!this.advanceFully(h, i));
				d++
			)
				ut && (f = this.stackID(h) + ' -> ');
			for (let d of l.recoverByInsert(a))
				(ut && console.log(c + this.stackID(d) + ' (via recover-insert)'),
	...
	stackID(e) {
		let t = (aa || (aa = new WeakMap())).get(e);
		return (
			t || aa.set(e, (t = String.fromCodePoint(this.nextStackID++))),
			t + e
		);
	}
}
...
class YD {
	constructor(e) {
		((this.start = e.start),
			(this.shift = e.shift || ua),
			(this.reduce = e.reduce || ua),
			(this.reuse = e.reuse || ua),
			(this.hash = e.hash || (() => 0)),
...
class Bo extends Pp {
	constructor(e) {
		...
		((this.nodeSet = new Wu(
			...
			(this.strict = !1),
			(this.bufferLength = Qp));
		let o = cr(e.tokenData);
		((this.context = e.context),
			(this.specializerSpecs = e.specialized || []),
			(this.specialized = new Uint16Array(this.specializerSpecs.length)));
		for (let l = 0; l < this.specializerSpecs.length; l++)
			this.specialized[l] = this.specializerSpecs[l].term;
		((this.specializers = this.specializerSpecs.map(Df)),
			(this.states = cr(e.states, Uint32Array)),
			(this.data = cr(e.stateData)),
			(this.goto = cr(e.goto)),
			(this.maxTerm = e.maxTerm),
			(this.tokenizers = e.tokenizers.map((l) =>
				typeof l == 'number' ? new Rn(o, l) : l,
			)),
	...
	hasAction(e, t) {
		...
		for (let r = 0; r < 2; r++)
			for (let s = this.stateSlot(e, r ? 2 : 1), o; ; s += 3) {
				if ((o = i[s]) == 65535)
					if (i[s + 1] == 1) o = i[(s = si(i, s + 2))];
					else {
						if (i[s + 1] == 2) return si(i, s + 2);
						break;
					}
				if (o == t || o == 0) return si(i, s + 1);
			}
		return 0;
	}
	stateSlot(e, t) {
	...
	allActions(e, t) {
		...
		for (let s = this.stateSlot(e, 1); r == null; s += 3) {
			if (this.data[s] == 65535)
				if (this.data[s + 1] == 1) s = si(this.data, s + 2);
				else break;
			r = t(si(this.data, s + 1));
		}
		return r;
	}
	nextStates(e) {
		...
		for (let i = this.stateSlot(e, 1); ; i += 3) {
			if (this.data[i] == 65535)
				if (this.data[i + 1] == 1) i = si(this.data, i + 2);
				else break;
	...
	configure(e) {
		let t = Object.assign(Object.create(Bo.prototype), this);
		...
		return (
			...
			e.specializers &&
				...
				(t.specializerSpecs = this.specializerSpecs.map((i, r) => {
					...
					return ((t.specializers[r] = Df(o)), o);
				}))),
...
const GD = 316,
	...
	mw = new Vr(
		(n, e) => {
			let { next: t } = n;
			(t == om || t == -1 || e.context) && n.acceptToken(ew);
		},
	...
	gw = new Vr(
		(n, e) => {
			let { next: t } = n,
				i;
			Ou.indexOf(t) > -1 ||
				(t == mu && ((i = n.peek(1)) == mu || i == lw)) ||
				(t != om && t != ow && t != -1 && !e.context && n.acceptToken(GD));
		},
		{ contextual: !0 },
	),
	yw = new Vr(
		(n, e) => {
			n.next == pw && !e.context && n.acceptToken(UD);
		},
		{ contextual: !0 },
	),
	xw = new Vr(
		(n, e) => {
			...
			if (t == aw || t == uw) {
				if ((n.advance(), t == n.next)) {
					n.advance();
					let i = !e.context && e.canShift(wf);
					n.acceptToken(i ? wf : HD);
				}
			} else
				t == fw &&
					n.peek(1) == dw &&
					(n.advance(),
					n.advance(),
					(n.next < 48 || n.next > 57) && n.acceptToken(KD));
		},
		{ contextual: !0 },
	);
function ca(n, e) {
...
const bw = new Vr((n, e) => {
		if (n.next != cw || !e.dialectEnabled(sw) || (n.advance(), n.next == mu))
			return;
		let t = 0;
		for (; Ou.indexOf(n.next) > -1; ) (n.advance(), t++);
		if (ca(n.next, !0)) {
			for (n.advance(), t++; ca(n.next, !1); ) (n.advance(), t++);
			for (; Ou.indexOf(n.next) > -1; ) (n.advance(), t++);
			if (n.next == hw) return;
			for (let i = 0; ; i++) {
				if (i == 7) {
					if (!ca(n.next, !0)) return;
					break;
				}
	...
	Sw = $p({
		...
		'FunctionDeclaration/VariableDefinition': y.function(
	...
	Qw = Bo.deserialize({
		...
		tokenizers: [
			...
			new pu('j~RQYZXz{^~^O(Q~~aP!P!Qd~iO(R~~', 25, 323),
		],
		topRules: {
			Script: [0, 7],
		...
		specialized: [
			{ term: 327, get: (n) => Dw[n] || -1 },
			{ term: 343, get: (n) => ww[n] || -1 },
			{ term: 95, get: (n) => vw[n] || -1 },
		],
		tokenPrec: 15201,
	}),
	Cw = So.define({
		...
		parser: Qw.configure({
			props: [
				Mp.add({
					IfStatement: Ul({ except: /^\s*({|else\b)/ }),
					TryStatement: Ul({ except: /^\s*({|catch\b|finally\b)/ }),
					LabeledStatement: ox,
					SwitchBody: (n) => {
						let e = n.textAfter,
							t = /^\s*\}/.test(e),
					...
					'Statement Property': Ul({ except: /^\s*{/ }),
					JSXElement(n) {
				...
				_p.add({
					...
					'JSXSelfClosingTag JSXOpenTag'(n) {
						var e;
						let t =
								(e = n.firstChild) === null || e === void 0
									? void 0
									: e.nextSibling,
							i = n.lastChild;
						return !t || t.type.isError
							? null
							: { from: t.to, to: i.type.isError ? n.to : i.from };
					},
				}),
			],
		}),
...
var kw = /[\u1680\u2000-\u200A\u202F\u205F\u3000]/,
	...
	ha = { Space_Separator: kw, ID_Start: Aw, ID_Continue: Pw },
	$e = {
		isSpaceSeparator(n) {
			return typeof n == 'string' && ha.Space_Separator.test(n);
		},
		isIdStartChar(n) {
			return (
				typeof n == 'string' &&
...
var $w = function (e, t) {
	...
	do ((Fe = Ew()), Mw[Ke]());
	while (Fe.type !== 'eof');
	return typeof t == 'function' ? yu({ '': br }, '', t) : br;
};
function yu(n, e, t) {
	const i = n[e];
...
function ci() {
	if (gu[Fo]) return String.fromCodePoint(gu.codePointAt(Fo));
}
function Z() {
	const n = ci();
	return (
...
`:
	...
	comment() {
		switch (he) {
			case '*':
				(Z(), (oe = 'multiLineComment'));
				return;
			case '/':
				(Z(), (oe = 'singleLineComment'));
				return;
		}
		throw we(Z());
	},
...
`:
	...
	value() {
		switch (he) {
			case '{':
			case '[':
				return De('punctuator', Z());
			case 'n':
				return (Z(), Ri('ull'), De('null', null));
			case 't':
				return (Z(), Ri('rue'), De('boolean', !0));
			case 'f':
				return (Z(), Ri('alse'), De('boolean', !1));
			case '-':
			case '+':
				(Z() === '-' && (ri = -1), (oe = 'sign'));
				return;
			case '.':
				((ne = Z()), (oe = 'decimalPointLeading'));
				return;
			case '0':
				((ne = Z()), (oe = 'zero'));
				return;
			...
			case '8':
			case '9':
				((ne = Z()), (oe = 'decimalInteger'));
				return;
			case 'I':
				return (Z(), Ri('nfinity'), De('numeric', 1 / 0));
			case 'N':
				return (Z(), Ri('aN'), De('numeric', NaN));
			case '"':
			case "'":
				((hr = Z() === '"'), (ne = ''), (oe = 'string'));
				return;
	...
	identifierNameStartEscape() {
		...
		switch (n) {
			...
			case '_':
				break;
			default:
				if (!$e.isIdStartChar(n)) throw vf();
				break;
		}
		((ne += n), (oe = 'identifierName'));
	},
	identifierName() {
		switch (he) {
			case '$':
			...
			case '‍':
				...
				return;
			case '\\':
				(Z(), (oe = 'identifierNameEscape'));
				return;
		}
		if ($e.isIdContinueChar(he)) {
			ne += Z();
			return;
		}
		return De('identifier', ne);
	},
	identifierNameEscape() {
		...
		switch (n) {
			...
			case '‍':
				break;
			default:
				if (!$e.isIdContinueChar(n)) throw vf();
				break;
		}
		((ne += n), (oe = 'identifierName'));
	},
	sign() {
		switch (he) {
			...
			case '9':
				...
				return;
			case 'I':
				return (Z(), Ri('nfinity'), De('numeric', ri * (1 / 0)));
			case 'N':
				return (Z(), Ri('aN'), De('numeric', NaN));
		}
		throw we(Z());
	...
	zero() {
		switch (he) {
			case '.':
				((ne += Z()), (oe = 'decimalPoint'));
				return;
			case 'e':
			case 'E':
				((ne += Z()), (oe = 'decimalExponent'));
				return;
			case 'x':
			case 'X':
				((ne += Z()), (oe = 'hexadecimal'));
	...
	decimalInteger() {
		...
		return De('numeric', ri * Number(ne));
	},
	decimalPointLeading() {
		if ($e.isDigit(he)) {
			((ne += Z()), (oe = 'decimalFraction'));
			return;
		}
		throw we(Z());
	},
	...
	decimalExponent() {
		switch (he) {
			case '+':
			case '-':
				((ne += Z()), (oe = 'decimalExponentSign'));
				return;
		}
		if ($e.isDigit(he)) {
			((ne += Z()), (oe = 'decimalExponentInteger'));
			return;
		}
		throw we(Z());
	},
...
`:
	...
	beforePropertyName() {
		switch (he) {
			case '$':
			case '_':
				((ne = Z()), (oe = 'identifierName'));
				return;
			case '\\':
				(Z(), (oe = 'identifierNameStartEscape'));
				return;
			case '}':
				return De('punctuator', Z());
			case '"':
...
function De(n, e) {
	return { type: n, value: e, line: $i, column: Zt };
}
function Ri(n) {
	for (const e of n) {
		if (ci() !== e) throw we(Z());
...
function Zw() {
	let n = '',
		e = ci();
	if (!$e.isHexDigit(e) || ((n += Z()), (e = ci()), !$e.isHexDigit(e)))
		throw we(Z());
...
const Mw = {
	...
	beforePropertyName() {
		switch (Fe.type) {
			case 'identifier':
			case 'string':
				((lc = Fe.value), (Ke = 'afterPropertyName'));
				return;
			case 'punctuator':
				Ns();
				return;
	...
	beforeArrayValue() {
		if (Fe.type === 'eof') throw Bi();
		if (Fe.type === 'punctuator' && Fe.value === ']') {
			Ns();
			return;
		}
		fa();
...
function fa() {
	...
	if (n !== null && typeof n == 'object')
		...
		e == null
			...
			: Array.isArray(e)
				? (Ke = 'afterArrayValue')
				: (Ke = 'afterPropertyValue');
	}
}
function Ns() {
	li.pop();
	const n = li[li.length - 1];
	n == null
		? (Ke = 'end')
		: Array.isArray(n)
			? (Ke = 'afterArrayValue')
...
function we(n) {
	return _o(
		n === void 0
			? `JSON5: invalid end of input at ${$i}:${Zt}`
			: `JSON5: invalid character '${am(n)}' at ${$i}:${Zt}`,
	);
}
function Bi() {
	return _o(`JSON5: invalid end of input at ${$i}:${Zt}`);
}
function vf() {
	return ((Zt -= 5), _o(`JSON5: invalid identifier character at ${$i}:${Zt}`));
}
function Rw(n) {
	console.warn(
		`JSON5: '${am(n)}' in strings is not valid ECMAScript; consider escaping`,
	);
}
function am(n) {
	const e = {
...
function _o(n) {
	...
	return ((e.lineNumber = $i), (e.columnNumber = Zt), e);
}
var Bw = function (e, t, i) {
	const r = [];
	let s = '',
		o,
		l,
	...
	return (
		...
		typeof i == 'number'
			? i > 0 &&
				((i = Math.min(10, Math.floor(i))), (a = '          '.substr(0, i)))
	...
	function h(O) {
		...
		for (let k = 0; k < O.length; k++) {
			...
			if (x < ' ') {
				let C = x.charCodeAt(0).toString(16);
				S += '\\x' + ('00' + C).substring(C.length);
				continue;
			}
			S += x;
		}
		const w = u || Object.keys(m).reduce((k, x) => (m[k] < m[x] ? k : x));
		return ((S = S.replace(new RegExp(w, 'g'), g[w])), w + S + w);
	}
	function f(O) {
		if (r.indexOf(O) >= 0)
...
` +
	...
	function d(O) {
		if (O.length === 0) return h(O);
		const m = String.fromCodePoint(O.codePointAt(0));
		if (!$e.isIdStartChar(m)) return h(O);
		for (let g = m.length; g < O.length; g++)
			if (!$e.isIdContinueChar(String.fromCodePoint(O.codePointAt(g))))
				return h(O);
		return O;
	}
	function p(O) {
...
function il() {
	return (
		Qf ||
			...
			(Qt.excelBOM =
				Qt.defaultCsv2JsonOptions =
				Qt.defaultJson2CsvOptions =
				Qt.errors =
					void 0),
			(Qt.errors = {
...
function ac() {
	...
	((Cf = 1),
		...
		(_i.setPath = _i.evaluatePath = void 0));
	function n(s, o) {
		if (!s) return null;
		const { dotIndex: l, key: a, remaining: u } = i(o),
			c = typeof s == 'object' && o in s ? s[o] : void 0,
			h = typeof s == 'object' && a in s ? s[a] : void 0;
		if (l >= 0 && typeof s == 'object' && !(o in s)) {
			const { key: f } = i(u),
				d = parseInt(f);
			return Array.isArray(h) && isNaN(d) ? h.map((p) => n(p, u)) : n(h, u);
		} else if (Array.isArray(s)) {
			const f = parseInt(a);
			return o === a && l === -1 && !isNaN(f) ? h : s.map((d) => n(d, o));
		} else {
			if (l >= 0 && o !== a && typeof s == 'object' && a in s) return n(h, u);
			if (l === -1 && typeof s == 'object' && a in s && !(o in s)) return h;
		}
		return c;
	}
	_i.evaluatePath = n;
	...
	_i.setPath = e;
	function t(s, o, l) {
		const { dotIndex: a, key: u, remaining: c } = i(o);
		if (
			o.startsWith('__proto__') ||
			o.startsWith('constructor') ||
			o.startsWith('prototype')
		)
			return s;
		if (a >= 0) {
			const h = parseInt(u);
			...
			const h = parseInt(u);
			return o === u && a === -1 && !isNaN(h)
				? ((s[u] = l), s)
				: (s.forEach((f) => t(f, c, l)), s);
		} else s[u] = l;
		return s;
	}
	function i(s) {
...
function Xw() {
	...
	((kf = 1),
		...
		(ni.isDocumentToRecurOn = ni.flatten = ni.unique = void 0));
	function n(i) {
		return [...new Set(i)];
	}
	ni.unique = n;
	...
	return ((ni.isDocumentToRecurOn = t), ni);
}
var da = {},
	Af;
function jw() {
	return (
		Af || ((Af = 1), Object.defineProperty(da, '__esModule', { value: !0 })),
		da
	);
}
var Pf;
...
function uc() {
	...
	(($f = 1),
		...
		(ie.isInvalid =
			...
			ie.unwind =
			ie.getNCharacters =
			ie.removeEmptyFields =
			ie.isEmptyField =
			ie.computeSchemaDifferences =
			ie.isDateRepresentation =
			ie.isStringRepresentation =
			ie.deepCopy =
			ie.validate =
			ie.buildC2JOptions =
			ie.buildJ2COptions =
	...
	function r(D) {
		return {
			...
			...D,
			delimiter: {
				field: D?.delimiter?.field ?? e.defaultJson2CsvOptions.delimiter.field,
				wrap: D?.delimiter?.wrap || e.defaultJson2CsvOptions.delimiter.wrap,
				eol: D?.delimiter?.eol || e.defaultJson2CsvOptions.delimiter.eol,
			},
			fieldTitleMap: D?.fieldTitleMap || Object.create({}),
		};
	}
	ie.buildJ2COptions = r;
	function s(D) {
		return {
			...e.defaultCsv2JsonOptions,
			...D,
			delimiter: {
				field: D?.delimiter?.field ?? e.defaultCsv2JsonOptions.delimiter.field,
				wrap: D?.delimiter?.wrap || e.defaultCsv2JsonOptions.delimiter.wrap,
				eol: D?.delimiter?.eol || e.defaultCsv2JsonOptions.delimiter.eol,
			},
		};
	}
	ie.buildC2JOptions = s;
	function o(D, P, $) {
		if (!D) throw new Error(`${$.cannotCallOn} ${D}.`);
		if (!P(D)) throw new Error($.dataCheckFailure);
		return !0;
	}
	ie.validate = o;
	function l(D) {
	...
	function a(D, P) {
		const $ = D[0],
			A = D.length - 1,
			R = D[A];
		return $ === P.delimiter.wrap && R === P.delimiter.wrap;
	}
	ie.isStringRepresentation = a;
	function u(D) {
		return t.test(D);
	}
	ie.isDateRepresentation = u;
	function c(D, P) {
		return C(D, P).concat(C(P, D));
	}
	ie.computeSchemaDifferences = c;
	function h(D) {
		return k(D) || w(D) || D === '';
	}
	ie.isEmptyField = h;
	function f(D) {
		return D.filter((P) => !h(P));
	}
	ie.removeEmptyFields = f;
	function d(D, P, $) {
		return D.substring(P, P + $);
	}
	ie.getNCharacters = d;
	function p(D, P, $) {
		const A = (0, n.evaluatePath)(P, $);
		let R = l(P);
		Array.isArray(A) && A.length
			? A.forEach((z) => {
					((R = l(P)), D.push((0, n.setPath)(R, $, z)));
				})
			: (Array.isArray(A) && A.length === 0 && (0, n.setPath)(R, $, ''),
				D.push(R));
	}
	function O(D, P) {
		const $ = [];
	...
	ie.isUndefined = k;
	function x(D) {
		return Object.prototype.toString.call(D) === '[object Error]';
	}
	ie.isError = x;
	function C(D, P) {
		return D.filter(($) => !P.includes($));
	}
	ie.arrayDifference = C;
	function E(D) {
		return [...new Set(D)];
	}
	ie.unique = E;
	function B(D) {
		if (D.flat) return D.flat();
		if (D.length > i) {
			let P = [];
			for (let $ = 0; $ < D.length; $ += i) P = P.concat(...D.slice($, $ + i));
			return P;
		}
		return D.reduce((P, $) => P.concat($), []);
	}
	ie.flatten = B;
	function v(D) {
		return D === 1 / 0 || D === -1 / 0;
	}
	return ((ie.isInvalid = v), ie);
}
var Ef;
function zw() {
	if (Ef) return Ct;
	...
	var n =
			...
			(Object.create
				? function (a, u, c, h) {
						...
						((!f ||
							('get' in f ? !u.__esModule : f.writable || f.configurable)) &&
							(f = {
								enumerable: !0,
								get: function () {
									return u[c];
							...
							Object.defineProperty(a, h, f));
					}
				: function (a, u, c, h) {
						(h === void 0 && (h = c), (a[h] = u[c]));
					}),
		e =
	...
	const i = ac(),
		...
		l = function (a) {
			const u = new RegExp(a.delimiter.wrap, 'g'),
				c = /\r?\n|\r/,
				h =
					a.parseValue && typeof a.parseValue == 'function'
						? a.parseValue
						: null,
			...
			function p(Q) {
				return (0, r.deepKeysFromList)(Q, d);
			}
			function O(Q) {
				return Q.length === 0
					? []
					: a.checkSchemaDifferences
						? m(Q)
						: o.unique(o.flatten(Q));
			}
			function m(Q) {
				const F = Q[0],
					Y = Q.slice(1);
				if (g(F, Y)) throw new Error(s.errors.json2csv.notSameSchema);
				return F;
			}
			function g(Q, F) {
				return F.reduce(
					(Y, G) => (o.computeSchemaDifferences(Q, G).length > 0 ? Y + 1 : Y),
					0,
				);
			}
			function S(Q) {
				return a.excludeKeys
					? Q.filter((F) => {
							for (const Y of a.excludeKeys) {
								const G = Y instanceof RegExp ? Y : new RegExp(`^${Y}`);
								if (Y === F || F.match(G)) return !1;
							}
							return !0;
						})
					: Q;
			...
			function k(Q) {
				return (
					a.trimHeaderFields &&
						(Q.headerFields = Q.headerFields.map((F) =>
							F.split('.')
								.map((Y) => Y.trim())
								.join('.'),
						)),
			...
			function x(Q) {
				return (
					a.prependHeader &&
						(Q.headerFields = Q.headerFields.map(function (F) {
							return te(F);
						})),
					Q
				);
			...
			function C(Q) {
				const F = Object.keys(a.fieldTitleMap);
				return (
					(Q.header = Q.headerFields
						.map(function (Y) {
							let G = Y;
							return (
								F.includes(Y)
									? (G = a.fieldTitleMap[Y])
									: a.escapeHeaderNestedDots || (G = G.replace(/\\\./g, '.')),
								G
							);
						})
			...
			function E() {
				return a.keys
					? a.keys.map((Q) =>
							typeof Q == 'object' && 'field' in Q
								? ((a.fieldTitleMap[Q.field] = Q.title ?? Q.field), Q.field)
								: Q,
						)
					: [];
			}
			function B() {
				return a.keys
					? a.keys.flatMap((Q) =>
							typeof Q == 'string' ? [] : Q?.wildcardMatch ? Q.field : [],
						)
					: [];
			}
			function v(Q) {
				...
				if (a.keys) {
					a.keys = Y;
					const J = Y.flatMap((ee) => {
						if (!F.includes(ee)) return ee;
						const Me = [],
							We = new RegExp(`^${ee}`);
						for (const be of K) (ee === be || be.match(We)) && Me.push(be);
						return Me;
					});
					if (!a.unwindArrays) {
						const ee = S(J);
			...
			function D(Q) {
				for (const F of Q.records)
					for (const Y of Q.headerFields) {
						const G = (0, i.evaluatePath)(F, Y);
			...
			function P(Q, F = !1) {
				if (a.unwindArrays) {
					if (
						(Q.headerFields.forEach((Y) => {
							Q.records = o.unwind(Q.records, Y);
						}),
						(Q.headerFields = v(Q.records)),
						D(Q))
					)
						return P(Q, F);
					if (!F) return P(Q, !0);
			...
			function $(Q) {
				return (
					(Q.recordString = Q.records
						.map((F) => {
							const Y = R(F, Q.headerFields),
								G = Y.map((K) => {
									((K = N(K)), (K = q(K)));
									let le = h ? h(K, z) : z(K);
									return ((le = te(le)), le);
			...
			function A(Q) {
				const F = o.removeEmptyFields(Q);
				return !Q.length || !F.length
					? a.emptyFieldValue || ''
					: F.length === 1
						? F[0]
						: Q;
			...
			function R(Q, F) {
				...
				return (
					F.forEach((G) => {
						let K = (0, i.evaluatePath)(Q, G);
						(!o.isUndefined(a.emptyFieldValue) && o.isEmptyField(K)
							? (K = a.emptyFieldValue)
							: a.expandArrayObjects && Array.isArray(K) && (K = A(K)),
							Y.push(K));
					}),
					Y
				);
			...
			function z(Q) {
				const F = Q instanceof Date;
				return Q === null || Array.isArray(Q) || (typeof Q == 'object' && !F)
					? JSON.stringify(Q)
					: typeof Q > 'u'
						? 'undefined'
						: F && a.useDateIso8601Format
							? Q.toISOString()
							: a.useLocaleFormat
								? Q.toLocaleString()
								: Q.toString();
			...
			function q(Q) {
				return a.preventCsvInjection
					? Array.isArray(Q)
						? Q.map(q)
						: typeof Q == 'string' && !o.isNumber(Q)
							? Q.replace(/^[=+\-@\t\r]+/g, '')
							: Q
					: Q;
			}
			function te(Q) {
				const F = a.delimiter.wrap;
				return (
					Q.includes(a.delimiter.wrap) && (Q = Q.replace(u, F + F)),
					(Q.includes(a.delimiter.field) ||
						Q.includes(a.delimiter.wrap) ||
						Q.match(c) ||
						(a.wrapBooleans && (Q === 'true' || Q === 'false'))) &&
						(Q = F + Q + F),
					Q
				);
			}
			function M(Q) {
				return Q.join(a.delimiter.field);
			}
			function V(Q) {
				const F = Q.header,
					Y = Q.recordString;
				return (
					(a.excelBOM ? s.excelBOM : '') +
					(a.prependHeader ? F + a.delimiter.eol : '') +
					Y
				);
			}
			function se(Q) {
	...
	var n =
			...
			(Object.create
				? function (l, a, u, c) {
						...
						((!h ||
							('get' in h ? !a.__esModule : h.writable || h.configurable)) &&
							(h = {
								enumerable: !0,
								get: function () {
									return a[u];
	...
	const i = ac(),
		...
		o = function (l) {
			const a = new RegExp(l.delimiter.wrap + l.delimiter.wrap, 'g'),
				...
				c =
					l.parseValue && typeof l.parseValue == 'function'
						? l.parseValue
						: JSON.parse;
			function h(v) {
				return (
			...
			function f(v) {
				let D = [];
				if (l.headerFields)
					D = l.headerFields.map((P, $) => ({ value: h(P), index: $ }));
				else if (
					((D = v[0].map(($, A) => ({ value: h($), index: A }))), l.keys)
				) {
					const $ = l.keys;
					D = D.filter((A) => $.includes(A.value));
				}
				return { lines: v, headerFields: D, recordLines: [] };
			}
			function d(v) {
				return l.excelBOM ? v.replace(u, '') : v;
			}
			function p(v) {
				const D = [],
					P = v.length - 1,
					$ = l.delimiter.eol.length,
					A = {
				...
				for (; M < v.length; ) {
					if (
						...
						(N = M ? v[M - 1] : ''),
						(q = M < P ? v[M + 1] : ''),
						(te = s.getNCharacters(v, M, $)),
						((te === l.delimiter.eol && !A.insideWrapDelimiter) || M === P) &&
							N === l.delimiter.field)
					)
						((te === l.delimiter.eol && A.startIndex === M) ||
						z === l.delimiter.field
							? R.push('')
							: R.push(v.substring(A.startIndex)),
							R.push(''),
							D.push(R),
							(R = []),
							(A.startIndex = M + $),
							(A.parsingValue = !0),
							(A.insideWrapDelimiter = q === l.delimiter.wrap));
					else if (M === P && z === l.delimiter.field) {
						const V = v.substring(A.startIndex, M);
						(R.push(V), R.push(''), D.push(R));
					} else if (
						M === P ||
						(te === l.delimiter.eol &&
							(!A.insideWrapDelimiter ||
								(A.insideWrapDelimiter &&
									N === l.delimiter.wrap &&
									!A.justParsedDoubleQuote)))
					) {
						const V = M !== P || N === l.delimiter.wrap ? M : void 0;
						(R.push(v.substring(A.startIndex, V)),
							D.push(R),
							(R = []),
							(A.startIndex = M + $),
							(A.parsingValue = !0),
						...
						((A.startIndex = M),
							(A.insideWrapDelimiter = !0),
							(A.parsingValue = !0),
							s.getNCharacters(v, M + 1, $) === l.delimiter.eol &&
								(M += l.delimiter.eol.length + 1));
					else if (
						N === l.delimiter.field &&
						z === l.delimiter.wrap &&
						q === l.delimiter.eol
					)
						(R.push(v.substring(A.startIndex, M - 1)),
							(A.startIndex = M),
							(A.parsingValue = !0),
							(A.insideWrapDelimiter = !0),
							(A.justParsedDoubleQuote = !0),
							(M += 1));
					else if (
						(N !== l.delimiter.wrap ||
							(A.justParsedDoubleQuote && N === l.delimiter.wrap)) &&
						z === l.delimiter.wrap &&
						s.getNCharacters(v, M + 1, $) === l.delimiter.eol
					)
						((A.insideWrapDelimiter = !1), (A.parsingValue = !1));
					else if (
						z === l.delimiter.wrap &&
						(M === 0 ||
							(s.getNCharacters(v, M - $, $) === l.delimiter.eol &&
								!A.insideWrapDelimiter))
					)
						((A.insideWrapDelimiter = !0),
							(A.parsingValue = !0),
						...
						!A.insideWrapDelimiter &&
						A.parsingValue
							? (R.push(v.substring(A.startIndex, M)), (A.startIndex = M + 1))
							: z === l.delimiter.field &&
								N === l.delimiter.wrap &&
								q !== l.delimiter.wrap &&
								!A.parsingValue &&
			...
			function O(v) {
				return (
					l.headerFields
						? (v.recordLines = v.lines)
						: (v.recordLines = v.lines.splice(1)),
					v
				);
			}
			function m(v, D) {
			...
			function g(v) {
				const D = E(v);
				return !s.isError(D) && !s.isInvalid(D)
					? D
					: v === 'undefined'
						? void 0
						: v;
			...
			function S(v) {
				return l.trimFieldValues && v !== null ? v.trim() : v;
			}
			function w(v, D) {
				return v.reduce((P, $) => {
					const A = m($, D);
					try {
						return (0, i.setPath)(P, $.value, A);
					} catch {
						return P;
					}
				}, {});
			...
			function k(v) {
				const D = v[0],
					P = v.length - 1,
					$ = v[P];
				return D === l.delimiter.wrap && $ === l.delimiter.wrap
					? v.length <= 2
						? ''
						: v.substring(1, P)
					: v;
			...
			function x(v) {
				return v.replace(a, l.delimiter.wrap);
			}
			function C(v) {
				return v.recordLines.reduce((D, P) => {
					P = P.map((A) => ((A = k(A)), (A = x(A)), (A = S(A)), A));
					const $ = w(v.headerFields, P);
					return D.concat($);
				}, []);
			}
			function E(v) {
				try {
					if (s.isStringRepresentation(v, l) && !s.isDateRepresentation(v))
						return v;
					const D = c(v);
					return Array.isArray(D) ? D.map(S) : D;
				} catch (D) {
					return D;
				}
			}
...
function Iw() {
	...
	((Zf = 1),
		...
		(Fi.csv2json = Fi.json2csv = void 0));
	const n = il(),
		e = zw(),
		t = Ww(),
		i = uc();
	function r(o, l) {
		...
		return (
			(0, i.validate)(o, i.isObject, n.errors.json2csv),
			(0, e.Json2Csv)(a).convert(o)
		);
	}
	Fi.json2csv = r;
	function s(o, l) {
		...
		return (
			(0, i.validate)(o, i.isString, n.errors.csv2json),
			(0, t.Csv2Json)(a).convert(o)
		);
	}
	return ((Fi.csv2json = s), Fi);
}
var qw = Iw(),
	pa,
	Mf;
function Vw() {
	...
	class n {
		...
		_set(t, i) {
			if ((this.cache.set(t, i), this._size++, this._size >= this.maxSize)) {
				if (((this._size = 0), typeof this.onEviction == 'function'))
					for (const [r, s] of this.oldCache.entries()) this.onEviction(r, s);
		...
		get(t) {
			...
			if (this.oldCache.has(t)) {
				const i = this.oldCache.get(t);
				return (this.oldCache.delete(t), this._set(t, i), i);
			}
		}
		set(t, i) {
			return (this.cache.has(t) ? this.cache.set(t, i) : this._set(t, i), this);
		}
		has(t) {
		...
		delete(t) {
			const i = this.cache.delete(t);
			return (i && this._size--, this.oldCache.delete(t) || i);
		}
		clear() {
		...
		*[Symbol.iterator]() {
			...
			for (const t of this.oldCache) {
				const [i] = t;
				this.cache.has(i) || (yield t);
			}
		}
		get size() {
			let t = 0;
			for (const i of this.oldCache.keys()) this.cache.has(i) || t++;
...
function cm(n) {
	...
	return (
		e[3] !== t
			? ((o = t ? b.jsx(Tm, { muted: !0, size: 4 }) : null),
				(e[3] = t),
				(e[4] = o))
			: (o = e[4]),
		o
...
const Gw = [
	...
	hp(),
	Uo(Yp, { fallback: !0 }),
	zr.of([{ key: 'Mod-Enter', run: () => !0 }, ZO, sO].flat().filter(Boolean)),
];
function Uw(n) {
	const e = Ae.c(7);
	let t;
	e[0] !== n ? ((t = Hw(n)), (e[0] = n), (e[1] = t)) : (t = e[1]);
	const i = t;
	let r;
	e[2] !== n ? ((r = Uo(Kw(n))), (e[2] = n), (e[3] = r)) : (r = e[3]);
	const s = r;
	let o;
	return (
		e[4] !== s || e[5] !== i
			? ((o = [i, s]), (e[4] = s), (e[5] = i), (e[6] = o))
			: (o = e[6]),
		o
	);
}
function Hw(n) {
	const { color: e, fonts: t } = n.sanity,
		i = e.card.enabled,
		r = gc.blue[e.dark ? 400 : 500].hex,
		s = gc.gray[n.sanity.color.dark ? 900 : 100].hex;
	return X.theme(
		{
			...
			'.cm-editor': {
				...
				fontSize: Pt(t.code.sizes[1].fontSize),
				lineHeight: 'inherit',
			},
...
const Jw = xe.div`
  ...
  & .cm-line {
    padding-left: ${({ theme: n }) => Pt(n.sanity.space[3])};
  }

  & .cm-content {
    border-right-width: ${({ theme: n }) => Pt(n.sanity.space[4])} !important;
    padding-top: ${({ theme: n }) => Pt(n.sanity.space[5])};
  }
`,
	cc = I.forwardRef((n, e) => {
		const t = Ae.c(7),
			[i] = I.useState(n.initialValue),
			r = Lm(),
			s = Uw(r),
			o = I.useRef(null);
		let l;
		...
		(t[1] === Symbol.for('react.memo_cache_sentinel')
			? ((u = () => ({ resetEditorContent: a })),
				(c = [a]),
				(t[1] = u),
				(t[2] = c))
			: ((u = t[1]), (c = t[2])),
			I.useImperativeHandle(e, u, c));
		let h;
		return (
...
cc.displayName = 'VisionCodeMirror';
const hm = ['pinnedRelease', 'scheduledDrafts', 'raw', 'published', 'drafts'],
	ev = ['pinnedRelease', 'scheduledDrafts'];
function Oa(n) {
	return hm.includes(n);
}
function Rf(n) {
	return typeof n == 'string' && ev.includes(n);
}
function Bf({ selectedPerspectiveName: n }) {
	return typeof n < 'u';
}
function ma({
	visionPerspective: n,
	perspectiveStack: e,
	scheduledDraftsStack: t,
}) {
	return n === 'pinnedRelease' ? e : n === 'scheduledDrafts' ? t : n;
}
function ga(n, e = {}, t = {}) {
...
function iv() {
	if (fm)
		for (let n = 0; n < localStorage.length; n++) {
			...
			e?.startsWith(dm) && localStorage.removeItem(e);
		}
}
function nv(n) {
	const e = `${dm}${n}`;
	...
	function i(a, u) {
		const c = o();
		return typeof c[a] > 'u' ? u : c[a];
	}
	function r(a, u) {
		const c = o();
		return ((c[a] = u), localStorage.setItem(e, JSON.stringify(t)), u);
	}
	function s(a) {
		const u = { ...o(), ...a };
...
function ya(n) {
	...
	return (
		...
		(e === 'X' ||
			e === '1' ||
			(/^\d{4}-\d{2}-\d{2}$/.test(e) && !isNaN(Date.parse(e))))
	);
}
function lv(n, e) {
	try {
		const t = n ? _w.parse(n) : {};
...
const gv = xe(ft)`
  height: 100%;
  min-height: ${({ theme: n }) => Pt(n.sanity.space[3] * 2 + n.sanity.fonts.text.sizes[2].lineHeight - n.sanity.fonts.text.sizes[2].ascenderHeight - n.sanity.fonts.text.sizes[2].descenderHeight)};
`,
	yv = xe(Ze)`
  position: relative;
`,
  ...
  > span {
    display: flex !important;
    gap: ${({ theme: n }) => Pt(n.sanity.space[3])};
    align-items: center;
  }
`,
	bv = xe(pe)`
...
function Dv(n) {
	...
	const a = l;
	let u;
	e[2] !== a ? ((u = jm(a, 333)), (e[2] = a), (e[3] = u)) : (u = e[3]);
	const c = u,
		h = r ? 'default' : 'critical';
	let f;
	e[4] !== o ? ((f = o('params.label')), (e[4] = o), (e[5] = f)) : (f = e[5]);
	let d;
	e[6] !== f
		? ((d = b.jsx(ai, { muted: !0, children: f })), (e[6] = f), (e[7] = d))
		: (d = e[7]);
	let p;
	e[8] !== i
		? ((p =
				...
				b.jsx(Dr, {
					...
					placement: 'top',
					portal: !0,
					content: b.jsx(dt, { size: 1, children: i }),
					children: b.jsx(pe, {
						padding: 1,
						marginX: 2,
						children: b.jsx(dt, { children: b.jsx(zm, {}) }),
					}),
				})),
			(e[8] = i),
			(e[9] = p))
	...
	let O;
	e[10] !== d || e[11] !== p
		? ((O = b.jsx(mm, { children: b.jsxs(ft, { children: [d, p] }) })),
			(e[10] = d),
			(e[11] = p),
			(e[12] = O))
		: (O = e[12]);
	const m = n.value || Sv;
	let g;
	e[13] !== s || e[14] !== c || e[15] !== m
		? ((g = b.jsx(cc, { ref: s, initialValue: m, onChange: c })),
			(e[13] = s),
			(e[14] = c),
			(e[15] = m),
			(e[16] = g))
...
const wv = 'studio.vision-tool.saved-queries',
	bu = { queries: [] },
	Gs = wv;
function vv() {
	const n = Ae.c(27),
	...
	n[0] === Symbol.for('react.memo_cache_sentinel')
		? ((o = []), (n[0] = o))
		: (o = n[0]);
	const [l, a] = I.useState(o),
		[u, c] = I.useState(),
		[h, f] = I.useState(),
		[d, p] = I.useState();
	let O;
	n[1] !== e ? ((O = e.getKey(Gs)), (n[1] = e), (n[2] = O)) : (O = n[2]);
	const m = O;
	let g;
	n[3] !== m
		? ((g = () => {
	...
	n[8] !== e || n[9] !== t.queries
		? ((w = async (D) => {
				(s(!0), c(void 0));
				try {
					const P = [{ ...D, _key: og() }, ...t.queries];
					(i({ queries: P }), await e.setKey(Gs, { queries: P }));
				} catch (P) {
					c(P);
				}
				s(!1);
	...
	const k = w;
	let x;
	n[11] !== e || n[12] !== t.queries
		? ((x = async (D) => {
				(s(!0), c(void 0));
				try {
					const P = t.queries.map(($) =>
						$._key === D._key ? { ...$, ...D } : $,
					);
					(i({ queries: P }), await e.setKey(Gs, { queries: P }));
				} catch (P) {
	...
	const C = x;
	let E;
	n[14] !== e || n[15] !== t.queries
		? ((E = async (D) => {
				(a((P) => [...P, D]), f(void 0));
				try {
					const P = t.queries.filter(($) => $._key !== D);
					(i({ queries: P }), await e.setKey(Gs, { queries: P }));
				} catch (P) {
					f(P);
				}
...
const Cv = xe(ht)`
  position: sticky;
  top: 0;
  background: ${({ theme: n }) => n.sanity.color.base.bg};
  z-index: 1;
`,
	kv = xe(pe)`
  height: 100%;
  ...
  &::-webkit-scrollbar-thumb {
    background: ${({ theme: n }) => n.sanity.color.base.border};
    border-radius: 4px;
  }
`;
function Av(n) {
	...
	e[11] !== a
		? ((A = async () => {
				...
				if (
					h?.some((le) => {
						const J = i(le.url);
						return J && J.query === s && er(J.params, o);
					})
				) {
					const le = h?.find((J) => {
						const ee = i(J.url);
						return ee && ee.query === s && er(ee.params, o);
					});
					a.push({
						closable: !0,
						status: 'warning',
						title: O('save-query.already-saved'),
						description: `${le?.title} - ${g.format(new Date(le?.savedAt || ''))}`,
					});
					return;
				}
				(K &&
					...
					p
						? a.push({
								closable: !0,
								status: 'error',
								title: O('save-query.error'),
								description: p.message,
							})
						: a.push({
								closable: !0,
								status: 'success',
								title: O('save-query.success'),
							}));
			}),
			(e[2] = o),
			(e[3] = s),
	...
	const R = A;
	let z;
	e[13] !== O || e[14] !== a || e[15] !== c
		? ((z = async (K, le) => {
				(w(null), B((J) => ({ ...J, [K._key]: le })));
				try {
					(await c({ ...K, title: le }),
						B((J) => {
							const ee = { ...J };
							return (delete ee[K._key], ee);
						}));
				} catch (J) {
					const ee = J;
					(B((Me) => {
						const We = { ...Me };
						return (delete We[K._key], We);
					}),
						a.push({
							closable: !0,
							status: 'error',
	...
	e[25] !== c
		? ((q = async (K) => {
				...
				if (
					h?.some((J) => {
						if (J._key === K._key) return !1;
						const ee = i(J.url);
						return ee && ee.query === s && er(ee.params, o);
					})
				) {
					const J = h?.find((ee) => {
						if (ee._key === K._key) return !1;
						const Me = i(ee.url);
						return Me && Me.query === s && er(Me.params, o);
					});
					a.push({
						closable: !0,
						status: 'warning',
						title: O('save-query.already-saved'),
						description: `${J?.title} - ${g.format(new Date(J?.savedAt || ''))}`,
					});
					return;
				}
				try {
					(await c({ ...K, url: le, savedAt: new Date().toISOString() }),
						$(le),
						a.push({
							closable: !0,
							status: 'success',
	...
	if (
		...
		const K = h?.filter((de) =>
			de?.title?.toLowerCase().includes(v.toLowerCase()),
		);
		V = kv;
		let le;
		e[49] === Symbol.for('react.memo_cache_sentinel')
			? ((le = { textTransform: 'capitalize' }), (e[49] = le))
			: (le = e[49]);
		let J;
		e[50] !== O
			? ((J = O('label.saved-queries')), (e[50] = O), (e[51] = J))
			: (J = e[51]);
		let ee;
		e[52] !== J
			? ((ee = b.jsx(dt, {
		...
		let Me;
		e[54] !== O
			? ((Me = O('action.save-query')), (e[54] = O), (e[55] = Me))
			: (Me = e[55]);
		let We;
		e[56] !== R || e[57] !== d || e[58] !== Me
			? ((We = b.jsx(Nt, {
					label: Me,
					icon: lg,
					disabled: d,
		...
		let Kt;
		e[63] !== O
			? ((Kt = O('label.search-queries')), (e[63] = O), (e[64] = Kt))
			: (Kt = e[64]);
		let mi;
		e[65] === Symbol.for('react.memo_cache_sentinel')
			? ((mi = (de) => D(de.currentTarget.value)), (e[65] = mi))
			: (mi = e[65]);
		let Jt;
		(e[66] !== v || e[67] !== Kt
			? ((Jt = b.jsx(pe, {
			...
			: (Jt = e[68]),
			e[69] !== be || e[70] !== Jt
				? ((F = b.jsxs(Cv, { space: 3, children: [be, Jt] })),
					(e[69] = be),
					(e[70] = Jt),
					(e[71] = F))
				: (F = e[71]),
			...
			(Q = K?.map((de) => {
				const ae = i(de.url),
					Ji = P === de.url,
					Yn = ae && s === ae.query && er(o, ae.params),
					Ti = Ji && !Yn;
				return b.jsx(
					Ze,
					{
						...
						children: b.jsxs(ht, {
							...
							children: [
										...
										b.jsxs(ft, {
											...
											children: [
												S === de._key
													? b.jsx(oo, {
															value: k,
															onChange: (Ne) => x(Ne.currentTarget.value),
															onKeyDown: (Ne) => {
																Ne.key === 'Enter'
																	? N(de, k)
																	: Ne.key === 'Escape' && w(null);
															},
															onBlur: () => N(de, k),
															autoFocus: !0,
										...
										b.jsx(Gm, {
											...
											menu: b.jsx(Um, {
												children: b.jsx(Hm, {
													...
													padding: 3,
													icon: Km,
													text: O('action.delete'),
													onClick: (Ne) => {
														(Ne.stopPropagation(), f(de._key));
													},
												}),
											}),
											popover: {
								...
								b.jsx(Xo, { muted: !0, children: ae?.query.split('{')[0] }),
								b.jsx(ft, {
									align: 'center',
									gap: 1,
									children: b.jsx(dt, {
										size: 1,
										muted: !0,
										children: g.format(new Date(de.savedAt || '')),
									}),
								}),
								Ti &&
									b.jsx(Nt, {
										...
										text: O('action.update'),
										onClick: (Ne) => {
											(Ne.stopPropagation(), te(de));
										},
									}),
							],
						}),
			...
			(e[47] = Q),
			(e[48] = F));
	} else ((M = e[44]), (V = e[45]), (se = e[46]), (Q = e[47]), (F = e[48]));
	let Y;
	e[72] !== M || e[73] !== se || e[74] !== Q
		? ((Y = b.jsx(M, { paddingY: se, children: Q })),
			(e[72] = M),
			(e[73] = se),
			(e[74] = Q),
			(e[75] = Y))
	...
	let G;
	return (
		e[76] !== V || e[77] !== F || e[78] !== Y
			? ((G = b.jsxs(V, { children: [F, Y] })),
				(e[76] = V),
				(e[77] = F),
				(e[78] = Y),
				(e[79] = G))
...
function Pv(n) {
	...
	return (
		e[3] !== i || e[4] !== s
			? ((u = { paneSizeOptions: s, isNarrowBreakpoint: i }),
				(e[3] = i),
				(e[4] = s),
				(e[5] = u))
			: (u = e[5]),
...
function Tv(n) {
	...
	let a;
	e[0] !== l
		? ((a = l('params.error.params-invalid-json')), (e[0] = l), (e[1] = a))
		: (a = e[1]);
	let u;
	e[2] !== a
		? ((u = b.jsx(Ze, {
				radius: 4,
				children: b.jsx(dt, { size: 1, muted: !0, children: a }),
			})),
			(e[2] = a),
			(e[3] = u))
		: (u = e[3]);
	...
	e[4] === Symbol.for('react.memo_cache_sentinel')
		? ((c = b.jsx(Ze, {
				radius: 4,
				children: b.jsx(Wm, { keys: ['Ctrl', 'Enter'] }),
			})),
			(e[4] = c))
		: (c = e[4]);
	const h = r ? pc : Oc,
	...
	e[5] !== r || e[6] !== l
		...
		: (p = e[7]);
	let O;
	e[8] !== s || e[9] !== h || e[10] !== f || e[11] !== d || e[12] !== p
		? ((O = b.jsx(pe, {
				flex: 1,
				children: b.jsx(Dr, {
					content: c,
	...
	e[14] !== i || e[15] !== l
		...
		: (g = e[16]);
	const S = !t,
		w = i ? 'positive' : 'default';
	let k;
	e[17] !== o || e[18] !== g || e[19] !== S || e[20] !== w || e[21] !== m
		? ((k = b.jsx(pe, {
				flex: 1,
				marginLeft: 3,
				children: b.jsx(Nt, {
	...
	let x;
	e[23] !== k || e[24] !== O
		? ((x = b.jsxs(ft, { justify: 'space-evenly', children: [O, k] })),
			(e[23] = k),
			(e[24] = O),
			(e[25] = x))
		: (x = e[25]);
...
function Bv() {
	...
	let c;
	n[3] !== l
		? ((c = l('settings.perspectives.title')), (n[3] = l), (n[4] = c))
		: (c = n[4]);
	let h;
	n[5] !== c
		? ((h = b.jsx(qf, {
				space: 2,
				children: b.jsx(dt, { weight: 'medium', children: c }),
			})),
			(n[5] = c),
			(n[6] = h))
		: (h = n[6]);
	let f;
	n[7] !== l
		? ((f = l('settings.perspectives.description')), (n[7] = l), (n[8] = f))
		: (f = n[8]);
	let d;
	n[9] !== f
		? ((d = b.jsx(Ze, { children: b.jsx(dt, { muted: !0, children: f }) })),
			(n[9] = f),
			(n[10] = d))
		: (d = n[10]);
	let p;
	...
	n[13] !== p
		? ((O = b.jsx(pe, {
				children: b.jsx(fg, { tone: 'primary', children: p }),
			})),
			(n[13] = p),
			(n[14] = O))
		: (O = n[14]);
	...
	n[17] !== O || n[18] !== m
		? ((g = b.jsx(Ze, {
				children: b.jsxs(ht, { space: 2, children: [O, m] }),
			})),
			(n[17] = O),
			(n[18] = m),
			(n[19] = g))
	...
	let w;
	n[22] !== l
		? ((w = l('settings.perspectives.action.docs-link')),
			(n[22] = l),
			(n[23] = w))
		: (w = n[23]);
	let k;
	n[24] !== w
		...
		: (k = n[25]);
	let x;
	n[26] !== g || n[27] !== S || n[28] !== k || n[29] !== h || n[30] !== d
		? ((x = b.jsx(Zv, {
				children: b.jsxs(ht, { space: 4, children: [h, d, g, S, k] }),
			})),
			(n[26] = g),
			(n[27] = S),
			(n[28] = k),
	...
	n[32] === Symbol.for('react.memo_cache_sentinel')
		? ((C = b.jsx(Rv, { $tone: 'primary' })), (n[32] = C))
		: (C = n[32]);
	let E;
	n[33] !== e
		? ((E = b.jsx(Nt, {
...
const _v = (n) => {
	...
	let l;
	e[3] !== o || e[4] !== r
		? ((l = [r, o].filter(zv)), (e[3] = o), (e[4] = r), (e[5] = l))
		: (l = e[5]);
	const a = l.join(' ');
	let u;
	e[6] !== t ? ((u = Bf(t)), (e[6] = t), (e[7] = u)) : (u = e[7]);
	const c = !u;
	let h;
	return (
		e[8] !== c || e[9] !== a
...
function Xv(n) {
	const e = Ae.c(65),
		{
			...
			isValidApiVersion: c,
			onChangePerspective: h,
			url: f,
			perspective: d,
			isScheduledDraftsEnabled: p,
		} = n,
		O = Wf(),
		{ t: m } = pi(Oi),
		g = I.useRef(null);
	...
	e[0] === Symbol.for('react.memo_cache_sentinel')
		? ((S = () => {
				...
				if (ee)
					try {
						(ee.select(), document.execCommand('copy'));
					} catch {
	...
	let x;
	e[2] !== m
		? ((x = m('settings.dataset-label')), (e[2] = m), (e[3] = x))
		: (x = e[3]);
	let C;
	e[4] !== x
		? ((C = b.jsx(Ze, {
				paddingTop: 2,
				paddingBottom: 3,
				children: b.jsx(ai, { children: x }),
			})),
			(e[4] = x),
			(e[5] = C))
		: (C = e[5]);
	let E;
	e[6] !== l ? ((E = l.map(Lv)), (e[6] = l), (e[7] = E)) : (E = e[7]);
	let B;
	e[8] !== i || e[9] !== t || e[10] !== E
		? ((B = b.jsx(kl, { value: i, onChange: t, children: E })),
			(e[8] = i),
			(e[9] = t),
			(e[10] = E),
			(e[11] = B))
	...
	e[12] !== C || e[13] !== B
		? ((v = b.jsx(pe, {
				padding: 1,
				column: 2,
				children: b.jsxs(ht, { children: [C, B] }),
			})),
			(e[12] = C),
			(e[13] = B),
			(e[14] = v))
	...
	let D;
	e[15] !== m
		? ((D = m('settings.api-version-label')), (e[15] = m), (e[16] = D))
		: (D = e[16]);
	let P;
	e[17] !== D
		? ((P = b.jsx(Ze, {
	...
	let R;
	e[20] !== m
		? ((R = m('settings.other-api-version-label')), (e[20] = m), (e[21] = R))
		: (R = e[21]);
	let z;
	e[22] !== R
		? ((z = b.jsx('option', { value: 'other', children: R }, 'other')),
			(e[22] = R),
			(e[23] = z))
		: (z = e[23]);
	let N;
	...
	e[28] !== N || e[29] !== P
		? ((q = b.jsx(pe, {
				padding: 1,
				column: 2,
				children: b.jsxs(ht, { children: [P, N] }),
			})),
			(e[28] = N),
			(e[29] = P),
			(e[30] = q))
		: (q = e[30]);
	let te;
	e[31] !== r || e[32] !== a || e[33] !== c || e[34] !== u || e[35] !== m
		? ((te =
				r !== !1 &&
				b.jsx(pe, {
					padding: 1,
					...
					children: b.jsxs(ht, {
						children: [
							b.jsx(Ze, {
								...
								children: b.jsx(ai, {
									textOverflow: 'ellipsis',
									children: m('settings.custom-api-version-label'),
								}),
							}),
							b.jsx(oo, {
								ref: a,
								...
								customValidity: c
									? void 0
									: m('settings.error.invalid-api-version'),
								maxLength: 11,
							}),
						],
					}),
	...
	let M;
	e[37] !== m
		? ((M = m('settings.perspective-label')), (e[37] = m), (e[38] = M))
		: (M = e[38]);
	let V;
	e[39] !== M
		? ((V = b.jsx(pe, { children: b.jsx(ai, { children: M }) })),
			(e[39] = M),
			(e[40] = V))
		: (V = e[40]);
	let se;
	e[41] === Symbol.for('react.memo_cache_sentinel')
		? ((se = b.jsx(pe, { children: b.jsx(Bv, {}) })), (e[41] = se))
		: (se = e[41]);
	let Q;
	e[42] !== V
		? ((Q = b.jsx(Ze, {
				paddingBottom: 1,
				children: b.jsxs(qf, { space: 1, children: [V, se] }),
			})),
			(e[42] = V),
			(e[43] = Q))
		: (Q = e[43]);
	...
	e[44] !== p || e[45] !== O || e[46] !== m
		? ((Y = hm.map((ee) =>
				ee === 'pinnedRelease'
					? b.jsxs(
							...
							{
								children: [
									b.jsx(_v, { pinnedPerspective: O, t: m }),
									b.jsx(
										'option',
										{
											value: 'default',
											children: m('settings.perspectives.default'),
										},
										'default',
									),
									b.jsx('hr', {}),
						...
						? p
							? b.jsx(
									'option',
									{
										...
										children: m('settings.perspectives.scheduled-drafts'),
									},
									'scheduledDrafts',
								)
							: null
						: b.jsx('option', { children: ee }, ee),
			)),
			(e[44] = p),
			(e[45] = O),
			(e[46] = m),
		...
		: (Y = e[47]);
	let G;
	e[48] !== h || e[49] !== F || e[50] !== Y
		? ((G = b.jsx(kl, { value: F, onChange: h, children: Y })),
			(e[48] = h),
			(e[49] = F),
			(e[50] = Y),
			(e[51] = G))
	...
	e[52] !== Q || e[53] !== G
		? ((K = b.jsx(pe, {
				padding: 1,
				column: 2,
				children: b.jsxs(ht, { children: [Q, G] }),
			})),
			(e[52] = Q),
			(e[53] = G),
			(e[54] = K))
								...
								children: [
										...
										children: b.jsxs(ai, {
											children: [
												...
												b.jsxs(cv, {
													...
													children: [
														'[',
														m('action.copy-url-to-clipboard'),
														']',
													],
												}),
											],
									...
									b.jsxs(ft, {
										...
										children: [
											...
											b.jsx(Dr, {
												content: m('action.copy-url-to-clipboard'),
												children: b.jsx(Nt, {
													'aria-label': m('action.copy-url-to-clipboard'),
													type: 'button',
													mode: 'ghost',
													icon: Vm,
													onClick: w,
	...
	let J;
	return (
		e[59] !== q || e[60] !== te || e[61] !== K || e[62] !== le || e[63] !== v
			? ((J = b.jsx(av, {
					paddingX: 3,
					paddingY: 2,
					children: b.jsxs(Ym, { columns: k, children: [v, q, te, K, le] }),
				})),
				(e[59] = q),
				(e[60] = te),
				(e[61] = K),
...
function jv(n) {
	return b.jsx('option', { children: n }, n);
}
function Lv(n) {
	return b.jsx('option', { children: n }, n);
}
	...
	return (() => {
		...
		return (r) => {
			...
			if (!(typeof s != 'string' || s === ''))
				return (
					s === i || ((i = s), t && URL.revokeObjectURL(t), (t = Wv(s, n))),
					t
				);
		};
	})();
}
const Iv = ym('application/json', (n) => JSON.stringify(n, null, 2)),
	qv = ym('text/csv', (n) => qw.json2csv(Array.isArray(n) ? n : [n]).trim()),
	Su = xe(Xo)`
...
function Vv(n) {
	...
	if (e[0] !== t.details) {
		...
		e: {
			if (((o = { ...r, ...Yv(t.details) }), !o.line)) {
				c = null;
				break e;
			}
			((s = Su), (u = 1), (l = o.line), (a = Nv(o.column, o.columnEnd)));
		}
		((e[0] = t.details),
			(e[1] = s),
			(e[2] = o),
		...
		((s = e[1]), (o = e[2]), (l = e[3]), (a = e[4]), (u = e[5]), (c = e[6]));
	if (c !== Symbol.for('react.early_return_sentinel')) return c;
	const h = `${l}
${a}`;
	let f;
	e[7] !== s || e[8] !== u || e[9] !== h
		? ((f = b.jsx(s, { size: u, children: h })),
			(e[7] = s),
			(e[8] = u),
			(e[9] = h),
			(e[10] = f))
	...
	let d;
	e[11] !== i
		? ((d = i('query.error.line')), (e[11] = i), (e[12] = d))
		: (d = e[12]);
	const p = o.lineNumber;
	let O;
	e[13] !== i
		? ((O = i('query.error.column')), (e[13] = i), (e[14] = O))
		: (O = e[14]);
	const m = `${d}:   ${p}
${O}: ${o.column}`;
	let g;
	e[15] !== m
		? ((g = b.jsx(pe, {
				marginTop: 4,
				children: b.jsx(Su, { size: 1, children: m }),
			})),
			(e[15] = m),
			(e[16] = g))
		: (g = e[16]);
...
function Gv(n) {
	...
	let t;
	e[0] !== n.error.message
		? ((t = b.jsx(Su, { size: 1, children: n.error.message })),
			(e[0] = n.error.message),
			(e[1] = t))
		: (t = e[1]);
	let i;
	e[2] !== n.error
		? ((i = b.jsx(Vv, { error: n.error })), (e[2] = n.error), (e[3] = i))
		: (i = e[3]);
	let r;
	return (
		e[4] !== t || e[5] !== i
			? ((r = b.jsxs(ht, { space: 5, marginTop: 2, children: [t, i] })),
				(e[4] = t),
				(e[5] = i),
				(e[6] = r))
			: (r = e[6]),
...
const Uv = xe.div(({ theme: n }) => {
  ...
  `;
	...
	Du = new Nw({ maxSize: 5e4 });
function Xf(n) {
	const e = Ae.c(7),
		{ data: t, datasetName: i } = n,
		r = eg();
	if (xm(t) || Array.isArray(t)) {
		const l = r === i ? Hv : void 0;
		let a;
		return (
			e[0] !== t || e[1] !== l
				? ((a = b.jsx(Uv, {
	...
	return (
		e[5] !== s
			? ((o = b.jsx(Xo, { language: 'json', children: s })),
				(e[5] = s),
				(e[6] = o))
			: (o = e[6]),
		o
...
function Hv(n) {
	const e = Ae.c(5);
	if (n.isKey || (!n.keypath.endsWith('_id') && !n.keypath.endsWith('_ref')))
		return null;
	let t;
	e[0] !== n.value
		? ((t = { id: n.value }), (e[0] = n.value), (e[1] = t))
		: (t = e[1]);
	let i;
	...
	return (
		e[3] !== t
			? ((r = b.jsx(ng, { intent: 'edit', params: t, children: i })),
				(e[3] = t),
				(e[4] = r))
			: (r = e[4]),
		r
...
const e2 = /^\d+$/;
function t2(n, e = 10) {
	return e2.test(n) && parseInt(n, 10) > e;
}
function i2(n) {
...
function s2(n) {
	...
	let f;
	e[0] !== h || e[1] !== r
		? ((f = h ? Iv(r) : ''), (e[0] = h), (e[1] = r), (e[2] = f))
		: (f = e[2]);
	const d = f;
	let p;
	e[3] !== h || e[4] !== r
		? ((p = h ? qv(r) : ''), (e[3] = h), (e[4] = r), (e[5] = p))
		: (p = e[5]);
	const O = p,
		m = t ? 'critical' : 'default',
		g = !!t;
	let S;
	e[6] !== c ? ((S = c('result.label')), (e[6] = c), (e[7] = S)) : (S = e[7]);
	let w;
	e[8] !== S
		? ((w = b.jsx(Om, {
				children: b.jsx(pe, {
					marginLeft: 3,
					children: b.jsx(ai, { muted: !0, children: S }),
				}),
			})),
			(e[8] = S),
			(e[9] = w))
	...
	e[10] !== s || e[11] !== o || e[12] !== i
		? ((k =
				(i || (s && o.length === 0)) &&
				b.jsx(pe, { marginTop: 3, children: b.jsx(cm, {}) })),
			(e[10] = s),
			(e[11] = o),
			(e[12] = i),
			(e[13] = k))
	...
	let x;
	e[14] !== t
		? ((x = t && b.jsx(Gv, { error: t })), (e[14] = t), (e[15] = x))
		: (x = e[15]);
	let C;
	e[16] !== l || e[17] !== h || e[18] !== r
		? ((C = h && b.jsx(Xf, { data: r, datasetName: l })),
			(e[16] = l),
			(e[17] = h),
			(e[18] = r),
			(e[19] = C))
	...
	e[20] !== l || e[21] !== s || e[22] !== o
		? ((E = s && o.length > 0 && b.jsx(Xf, { data: o, datasetName: l })),
			(e[20] = l),
			(e[21] = s),
			(e[22] = o),
			(e[23] = E))
		: (E = e[23]);
	let B;
	e[24] !== E || e[25] !== k || e[26] !== x || e[27] !== C
		? ((B = b.jsxs(pe, { padding: 3, paddingTop: 5, children: [k, x, C, E] })),
			(e[24] = E),
			(e[25] = k),
			(e[26] = x),
			(e[27] = C),
	...
	let v;
	e[29] !== B || e[30] !== w
		? ((v = b.jsxs(pv, { overflow: 'auto', children: [w, B] })),
			(e[29] = B),
			(e[30] = w),
			(e[31] = v))
		: (v = e[31]);
	let D;
	e[32] !== v || e[33] !== m || e[34] !== g
		? ((D = b.jsx(fv, {
				flex: 1,
				children: b.jsx(dv, {
					flex: 1,
	...
	e[36] === Symbol.for('react.memo_cache_sentinel')
		? ((P = ['column', 'column', 'row']), (e[36] = P))
		: (P = e[36]);
	let $;
	e[37] !== c
		? (($ = c('result.execution-time-label')), (e[37] = c), (e[38] = $))
		: ($ = e[38]);
	let A;
	e[39] !== a || e[40] !== c
		? ((A =
				typeof a == 'number' ? `${a}ms` : c('result.timing-not-applicable')),
			(e[39] = a),
			(e[40] = c),
			(e[41] = A))
		: (A = e[41]);
	...
	e[42] !== $ || e[43] !== A
		? ((R = b.jsx(pe, {
				children: b.jsxs(dt, { muted: !0, children: [$, ':', ' ', A] }),
			})),
			(e[42] = $),
			(e[43] = A),
			(e[44] = R))
	...
	let z;
	e[45] !== c
		? ((z = c('result.end-to-end-time-label')), (e[45] = c), (e[46] = z))
		: (z = e[46]);
	let N;
	e[47] !== u || e[48] !== c
		? ((N =
				typeof u == 'number' ? `${u}ms` : c('result.timing-not-applicable')),
			(e[47] = u),
			(e[48] = c),
			(e[49] = N))
		: (N = e[49]);
	...
	e[50] !== z || e[51] !== N
		? ((q = b.jsx(pe, {
				marginLeft: 4,
				children: b.jsxs(dt, { muted: !0, children: [z, ':', ' ', N] }),
			})),
			(e[50] = z),
			(e[51] = N),
			(e[52] = q))
	...
	e[53] !== R || e[54] !== q
		? ((te = b.jsx(mv, {
				...
				paddingY: 3,
				sizing: 'border',
				children: b.jsxs(gv, { align: 'center', children: [R, q] }),
			})),
			(e[53] = R),
			(e[54] = q),
			(e[55] = te))
...
const l2 =
	...
	a2 = (n) => mc('ctrl+enter', n) || mc('mod+enter', n);
function u2(n) {
	const e = Ae.c(210),
		{ datasets: t, config: i, projectId: r, defaultDataset: s } = n,
		o = zf(),
		{ t: l } = pi(Oi),
		{ perspectiveStack: a } = Wf(),
		u = Zm(),
		{ data: c } = Mm();
	let h;
	e[0] !== c
		? ((h = c === void 0 ? [] : c), (e[0] = c), (e[1] = h))
		: (h = e[1]);
	const f = h,
		d = Rm().document.drafts.enabled,
		p = I.useRef(null),
		O = I.useRef(null),
		m = I.useRef(null),
		g = I.useRef(null),
	...
	let k;
	e[2] !== r
		? ((k = () => nv(r || 'default')), (e[2] = r), (e[3] = k))
		: (k = e[3]);
	const [x] = I.useState(k);
	let C;
	e[4] !== s || e[5] !== x
		? ((C = x.get('dataset', s)), (e[4] = s), (e[5] = x), (e[6] = C))
		: (C = e[6]);
	const E = C;
	let B;
	e[7] !== i.defaultApiVersion || e[8] !== x
		? ((B = x.get('apiVersion', ov(`${i.defaultApiVersion}`))),
			(e[7] = i.defaultApiVersion),
			(e[8] = x),
			(e[9] = B))
		: (B = e[9]);
	const v = B;
	...
	let R;
	e[14] !== x
		? ((R = x.get('perspective', void 0)), (e[14] = x), (e[15] = R))
		: (R = e[15]);
	const z = R;
	let N;
	e[16] !== t || e[17] !== s || e[18] !== E
		? ((N = () => (t.includes(E) ? E : t.includes(s) ? s : t[0])),
			(e[16] = t),
			(e[17] = s),
			(e[18] = E),
			(e[19] = N))
		: (N = e[19]);
	const [q, te] = I.useState(N);
	let M;
	e[20] !== v
		? ((M = () => (Sr.includes(v) ? v : um)), (e[20] = v), (e[21] = M))
		: (M = e[21]);
	const [V, se] = I.useState(M);
	let Q;
	e[22] !== v
		? ((Q = () => (Sr.includes(v) ? !1 : v)), (e[22] = v), (e[23] = Q))
		: (Q = e[23]);
	const [F, Y] = I.useState(Q),
		[G, K] = I.useState(z || 'raw');
	let le;
	e[24] !== F
		? ((le = F ? ya(F) : !0), (e[24] = F), (e[25] = le))
		: (le = e[25]);
	const J = le,
		[ee, Me] = I.useState(void 0);
	let We;
	e[26] !== P
		? ((We = () => (typeof P == 'string' ? P : '')), (e[26] = P), (e[27] = We))
		: (We = e[27]);
	const [be, Kt] = I.useState(We),
		[mi, Jt] = I.useState(A);
	let de;
	e[28] !== mi || e[29] !== l
		? ((de = _f(mi, l)), (e[28] = mi), (e[29] = l), (e[30] = de))
		: (de = e[30]);
	const ae = de,
		[Ji, Yn] = I.useState(void 0);
	let Ti;
	e[31] === Symbol.for('react.memo_cache_sentinel')
		? ((Ti = []), (e[31] = Ti))
		: (Ti = e[31]);
	const [Ne, nl] = I.useState(Ti),
		[rl, Nn] = I.useState(void 0),
		[sl, ol] = I.useState(void 0),
		[ll, al] = I.useState(void 0),
		[ei, Gn] = I.useState(!1),
		[ti, Yr] = I.useState(!1),
		[Zi, bm] = I.useState(!1);
	let Nr;
	e[32] === Symbol.for('react.memo_cache_sentinel')
		? ((Nr = { visionRootRef: m }), (e[32] = Nr))
		: (Nr = e[32]);
	const { paneSizeOptions: Ot, isNarrowBreakpoint: ul } = Pv(Nr);
	let cl;
	e: {
		if (!u) {
			cl = void 0;
		...
		if (e[33] !== d || e[34] !== f) {
			...
			let vt;
			e[36] !== d
				? ((vt = d ? ['drafts'] : ['published']), (e[36] = d), (e[37] = vt))
				: (vt = e[37]);
			const Jn = vt;
			((W = [...Ge, ...Jn]), (e[33] = d), (e[34] = f), (e[35] = W));
		} else W = e[35];
		cl = W;
	}
	const ii = cl,
	...
	let Gr;
	e[38] !== hl
		? ((Gr = { apiVersion: hl }), (e[38] = hl), (e[39] = Gr))
		: (Gr = e[39]);
	const fl = wu(Gr);
	let Ur;
	e[40] !== fl ||
	...
	e[49] === Symbol.for('react.memo_cache_sentinel')
		? ((Hr = () => {
				S.current && (S.current.unsubscribe(), (S.current = void 0));
			}),
			(e[49] = Hr))
		: (Hr = e[49]);
	const Kr = Hr;
	...
	e[50] === Symbol.for('react.memo_cache_sentinel')
		? ((Jr = () => {
				w.current && (w.current.unsubscribe(), (w.current = void 0));
			}),
			(e[50] = Jr))
		: (Jr = e[50]);
	const Un = Jr;
	...
	e[63] !== l
		? ((es = (W) => {
				...
				const H = {
					query: W?.query || be,
					dataset: W?.dataset || q,
					params: _f(JSON.stringify(W?.params || ae.parsed, null, 2), l),
					perspective: ma({
						visionPerspective: W && 'perspective' in W ? W.perspective : G,
						perspectiveStack: a,
						scheduledDraftsStack: ii,
					}),
					apiVersion: W?.apiVersion || (F && J ? F : V),
				};
				if (
					(x.set('query', H.query),
					x.set('params', H.params.raw),
					Un(),
					Gn(!H.params.error && !!H.query),
					Yr(!1),
					nl([]),
					Nn(H.params.error ? new Error(H.params.error) : void 0),
					Yn(void 0),
					ol(void 0),
					al(void 0),
					H.params.error)
					...
					return;
				const Ge = { perspective: H.perspective ?? [] },
					vt = wt.withConfig({
					...
					Jn = vt.getUrl(
						vt.getDataUrl('query', ga(H.query, H.params.parsed, Ge)),
					);
				Me(Jn);
				const Ql = Date.now();
				S.current = vt.observable
					.fetch(H.query, H.params.parsed, {
						filterResponse: !1,
						tag: 'vision',
					})
					.subscribe({
	...
	e[65] !== Pe || e[66] !== x
		? ((ts = (W) => {
				(W !== void 0 && !Oa(W)) ||
					(K(W), x.set('perspective', W), Pe({ perspective: W }));
			}),
			(e[65] = Pe),
			(e[66] = x),
			(e[67] = ts))
	...
	e[68] !== Pe || e[69] !== x
		? ((is = (W) => {
				...
				(x.set('dataset', H), te(H), Pe({ dataset: H }));
			}),
			(e[68] = Pe),
			(e[69] = x),
			(e[70] = is))
	...
	e[71] !== Pe || e[72] !== x
		? ((ns = (W) => {
				const H = W.target.value;
				if (H?.toLowerCase() === 'other') {
					(Y('v'), g.current?.focus());
					return;
				}
				(se(H), Y(!1), x.set('apiVersion', H), Pe({ apiVersion: H }));
			}),
			(e[71] = Pe),
			(e[72] = x),
			(e[73] = ns))
	...
	e[74] !== Pe || e[75] !== x
		? ((rs = (W) => {
				const H = W.target.value || '';
				(Y(H || 'v'),
					ya(H) && (se(H), x.set('apiVersion', H), Pe({ apiVersion: H })));
			}),
			(e[74] = Pe),
			(e[75] = x),
			(e[76] = rs))
	...
	e[79] === Symbol.for('react.memo_cache_sentinel')
		? ((os = (W) => {
				W.type === 'mutation' &&
					nl((H) => (H.length === 50 ? [W, ...H.slice(0, 49)] : [W, ...H]));
			}),
			(e[79] = os))
		: (os = e[79]);
	const Sm = os;
	...
	e[86] !== be
		? ((ls = () => {
				...
				const W = wt.getDataUrl('listen', ga(be, ae.parsed, {})),
					H = !ae.error && be.trim().length > 0;
				(x.set('query', be),
					x.set('params', ae.raw),
					Kr(),
					Me(W),
					...
					Yn(void 0),
					Yr(H),
					Nn(ae.error ? new Error(ae.error) : void 0),
					ol(void 0),
					al(void 0),
					H &&
						(w.current = wt
	...
	const yl = as;
	let us;
	e[90] !== V || e[91] !== q || e[92] !== t || e[93] !== G || e[94] !== o
		? ((us = (W) => {
				const H = W.match(l2);
				if (!H) return null;
				const [, Ge, vt, Jn] = H,
					Ql = new URLSearchParams(Jn),
					et = sv(Ql);
				if (!et) return null;
				let fc, Cl;
				ya(Ge) && (Sr.includes(Ge) ? ((fc = Ge), (Cl = !1)) : (Cl = Ge));
				const dc =
					Oa(et.options.perspective) && !Rf(et.options.perspective)
						? et.options.perspective
						: void 0;
				return (
					dc &&
						(!Oa(et.options.perspective) || Rf(et.options.perspective)) &&
						o.push({
							...
							status: 'warning',
							title:
								'Perspective in pasted url is currently not supported. Falling back to "raw"',
						}),
					{
						query: et.query,
						params: et.params,
						rawParams: JSON.stringify(et.params, null, 2),
						dataset: t.includes(vt) ? vt : q,
						apiVersion: fc || V,
						customApiVersion: Cl,
						perspective: dc || G,
						url: W,
	...
	e[96] !== Pe || e[97] !== x
		? ((cs = (W) => {
				(te(W.dataset),
					...
					Jt(W.rawParams),
					se(W.apiVersion),
					W.customApiVersion && Y(W.customApiVersion),
					K(W.perspective),
					Me(W.url),
					p.current?.resetEditorContent(W.query),
					O.current?.resetEditorContent(W.rawParams),
					x.merge({
						query: W.query,
						params: W.rawParams,
						dataset: W.dataset,
						apiVersion: W.customApiVersion || W.apiVersion,
	...
	const Hn = hs;
	let fs;
	e[103] !== Pe || e[104] !== ae.valid
		? ((fs = (W) => {
				const H = m.current && o2(m.current, W.target);
				a2(W) &&
					H &&
					ae.valid &&
	...
	(e[106] !== Kn || e[107] !== Hn
		? ((ds = () => (
				window.document.addEventListener('paste', Hn),
				window.document.addEventListener('keydown', Kn),
				() => {
					(window.document.removeEventListener('paste', Hn),
						window.document.removeEventListener('keydown', Kn));
				}
			)),
			(ps = [Kn, Hn]),
			(e[106] = Kn),
	...
	e[114] !== xl || e[115] !== a
		...
		: (ys = e[116]);
	let xs;
	(e[117] !== a ? ((xs = [a]), (e[117] = a), (e[118] = xs)) : (xs = e[118]),
		I.useEffect(ys, xs));
	let bs;
	e[119] !== wt || e[120] !== G || e[121] !== a || e[122] !== ii
		? ((bs = (W, H) => {
				const Ge = {
					perspective:
						ma({
				...
				return wt.getUrl(wt.getDataUrl('query', ga(W, H, Ge)));
			}),
			(e[119] = wt),
			(e[120] = G),
			(e[121] = a),
	...
	e[135] !== ee
		? ((rn = b.jsx(Xv, {
				...
				datasets: t,
				onChangeDataset: dl,
				onChangeApiVersion: pl,
				customApiVersionElementRef: g,
				onCustomApiVersionChange: Ol,
				isValidApiVersion: J,
				onChangePerspective: ml,
				url: ee,
				perspective: G,
				isScheduledDraftsEnabled: u,
			})),
			(e[124] = V),
			(e[125] = F),
			(e[126] = q),
			...
			(e[136] = rn))
		: (rn = e[136]);
	const Sl = Zi ? window.innerWidth : window.innerWidth - 275,
		Dl = ul ? 'vertical' : 'horizontal',
		wl = ul ? Ot.defaultSize : Ot.minSize,
		Dm = Ot.size,
		wm = Ot.allowResize,
		vl = ul ? Ot.minSize : 100,
		vm = Ot.maxSize;
	let sn;
	e[137] !== l
		? ((sn = l('query.label')), (e[137] = l), (e[138] = sn))
		: (sn = e[138]);
	let on;
	e[139] !== sn
		? ((on = b.jsx(mm, {
				children: b.jsx(ft, {
					children: b.jsx(ai, { muted: !0, children: sn }),
				}),
			})),
			(e[139] = sn),
			(e[140] = on))
	...
	let ln;
	e[141] !== be
		? ((ln = b.jsx(cc, { initialValue: be, onChange: Kt, ref: p })),
			(e[141] = be),
			(e[142] = ln))
		: (ln = e[142]);
	let an;
	e[143] !== on || e[144] !== ln
		? ((an = b.jsx(Ff, {
				...
				children: b.jsxs(pe, { flex: 1, children: [on, ln] }),
			})),
			(e[143] = on),
			(e[144] = ln),
			(e[145] = an))
	...
	e[149] !== ae.valid
		? ((un = b.jsx(Dv, {
				value: ae.raw,
				onChange: yl,
				paramsError: ae.error,
				hasValidParams: ae.valid,
				editorRef: O,
			})),
			(e[146] = yl),
			(e[147] = ae.error),
	...
	let hn;
	e[157] !== un || e[158] !== cn
		? ((hn = b.jsxs(Ff, { display: 'flex', children: [un, cn] })),
			(e[157] = un),
			(e[158] = cn),
			(e[159] = hn))
		: (hn = e[159]);
	let fn;
	e[160] !== Ot.allowResize ||
	e[161] !== Ot.maxSize ||
	e[162] !== Ot.size ||
	e[163] !== wl ||
	e[164] !== vl ||
	...
	e[177] !== Dl || e[178] !== fn || e[179] !== dn
		...
		: (pn = e[180]);
	let Ss;
	e[181] === Symbol.for('react.memo_cache_sentinel')
		? ((Ss = { position: 'relative', height: '100%' }), (e[181] = Ss))
		: (Ss = e[181]);
	let Ds;
	e[182] === Symbol.for('react.memo_cache_sentinel')
		? ((Ds = {
				position: 'absolute',
				left: -32,
				top: '50%',
	...
	let On;
	e[183] !== Zi
		? ((On = () => bm(!Zi)), (e[183] = Zi), (e[184] = On))
		: (On = e[184]);
	let ws;
	e[185] === Symbol.for('react.memo_cache_sentinel')
		? ((ws = { display: 'flex', alignItems: 'center', height: '100%' }),
			(e[185] = ws))
		: (ws = e[185]);
	let mn;
	e[186] !== Zi
	...
	let yn;
	e[191] !== ae.parsed
		? ((yn = ae.parsed || {}), (e[191] = ae.parsed), (e[192] = yn))
		: (yn = e[192]);
	let xn;
	e[193] !== bl ||
	e[194] !== tn ||
	...
	let bn;
	e[200] !== gn || e[201] !== xn
		? ((bn = b.jsxs(pe, { style: Ss, children: [gn, xn] })),
			(e[200] = gn),
			(e[201] = xn),
			(e[202] = bn))
		: (bn = e[202]);
	let Sn;
	e[203] !== Sl || e[204] !== pn || e[205] !== bn
		? ((Sn = b.jsx(uv, {
				flex: 'auto',
				children: b.jsxs(Pl, {
					minSize: 800,
...
function h2(n) {
	return _m(n) && n.state === 'scheduled';
}
function f2(n) {
	const e = Ae.c(7),
		{ client: t, datasets: i } = n;
	let r;
	e: {
		if (Array.isArray(i)) {
			let o;
			(e[0] !== i ? ((o = jf(i)), (e[0] = i), (e[1] = o)) : (o = e[1]),
				(r = o));
			break e;
		}
		let s;
		if (e[2] !== t.observable.datasets || e[3] !== i) {
			let o;
			(e[5] !== i
				? ((o = (l) => (typeof i == 'function' ? i(l).map(O2) : l.map(p2))),
					(e[5] = i),
					(e[6] = o))
				: (o = e[6]),
				(s = t.observable.datasets.list().pipe(Lf(o), $m(d2))),
				(e[2] = t.observable.datasets),
				(e[3] = i),
				(e[4] = s));
		} else s = e[4];
		r = s;
...
function m2(n) {
	...
	let t;
	e[0] === Symbol.for('react.memo_cache_sentinel')
		? ((t = { apiVersion: 'v2025-06-27' }), (e[0] = t))
		: (t = e[0]);
	const i = wu(t);
	let r;
	e[1] !== i || e[2] !== n.config.datasets
		? ((r = { client: i, datasets: n.config.datasets }),
			(e[1] = i),
			(e[2] = n.config.datasets),
			(e[3] = r))
		: (r = e[3]);
	const s = f2(r);
	if (!s) {
	...
	e[5] !== s || e[6] !== n.client
		? ((o =
				s instanceof Error ? [n.client.config().dataset || 'production'] : s),
			(e[5] = s),
			(e[6] = n.client),
			(e[7] = o))
		: (o = e[7]);
	...
	let a;
	e[8] !== n.client
		? ((a = n.client.config()), (e[8] = n.client), (e[9] = a))
		: (a = e[9]);
	const u = a.projectId;
	let c;
	e[10] !== l || e[11] !== n.client || e[12] !== n.config.defaultDataset
		? ((c = n.config.defaultDataset || n.client.config().dataset || l[0]),
			(e[10] = l),
			(e[11] = n.client),
			(e[12] = n.config.defaultDataset),
			(e[13] = c))
		: (c = e[13]);
	const h = c;
	let f;
	return (
		e[14] !== l || e[15] !== h || e[16] !== u || e[17] !== n
			? ((f = b.jsx(
					u2,
					{ ...n, datasets: l, projectId: u, defaultDataset: h },
					u,
				)),
				(e[14] = l),
				(e[15] = h),
...
class g2 extends I.Component {
	constructor(e) {
		(super(e), (this.state = { error: null, numRetries: 0 }));
	}
	static getDerivedStateFromError(e) {
		return { error: e instanceof Error ? e.message : `${e}` };
	}
	handleRetryRender = () =>
		this.setState((e) => ({ error: null, numRetries: e.numRetries + 1 }));
	handleRetryWithCacheClear = () => {
		(iv(), this.handleRetryRender());
	};
	render() {
		if (!this.state.error) return this.props.children;
		const e = this.state.error,
			t = this.state.numRetries > 0;
		return b.jsx(Ze, {
			height: 'fill',
			overflow: 'auto',
			paddingY: [4, 5, 6, 7],
				...
				children: b.jsxs(ht, {
					...
					children: [
						b.jsx('div', {
							children: b.jsx(Nt, {
								onClick: t
									? this.handleRetryWithCacheClear
									: this.handleRetryRender,
								text: t ? 'Clear cache and retry' : 'Retry',
								tone: 'default',
							}),
						}),
						b.jsx(Pm, { children: 'An error occurred' }),
						b.jsx(Ze, {
							border: !0,
							radius: 2,
							overflow: 'auto',
							...
							children: b.jsx(ht, {
								...
								children:
									...
									b.jsx(Xo, {
										size: 1,
										children: b.jsxs('strong', { children: ['Error: ', e] }),
									}),
							}),
						}),
					],
...
function S2(n) {
	...
	let r;
	e[1] !== n.tool.options
		? ((r = { defaultApiVersion: um, ...n.tool.options }),
			(e[1] = n.tool.options),
			(e[2] = r))
		: (r = e[2]);
	const s = r;
	...
	return (
		e[3] !== i || e[4] !== s
			? ((o = b.jsx(g2, { children: b.jsx(m2, { client: i, config: s }) })),
				(e[3] = i),
				(e[4] = s),
				(e[5] = o))
			: (o = e[5]),
