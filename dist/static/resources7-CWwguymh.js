import { a as e } from './sanity-Bacdz4Bt.js';
const n = e('structure', {
	...
	'action.discard-changes.disabled.no-change':
		'This document has no unpublished changes',
	...
	'action.restore.disabled.cannot-restore-initial':
		"You can't restore to the initial revision",
	...
	'banners.archived-scheduled-draft.description':
		'This scheduled draft is archived',
	...
	'banners.release.navigate-to-edit-description':
		'The document only exists in the',
	...
	'banners.release.navigate-to-edit-description-none':
		'This document is not part of any release',
	'banners.release.navigate-to-edit-description-single':
		'This document is part of the <VersionBadge/> release',
	'banners.release.not-in-release':
		'Not in the <VersionBadge>{{title}}</VersionBadge> release.',
	...
	'buttons.focus-pane-button.aria-label.focus':
		'Enter focus mode (hide navigation)',
	...
	'canvas.banner.editable.linked-text':
		'This document can be edited in Canvas.',
	...
	'compare-version.error.invalidNextDocumentParam':
		'The next document parameter is invalid.',
	...
	'confirm-delete-dialog.cdr-summary.document-count_other':
		'{{count}} documents',
	...
	'confirm-delete-dialog.cdr-summary.subtitle_unavailable_one':
		'Unavailable dataset',
	'confirm-delete-dialog.cdr-summary.subtitle_unavailable_other':
		'Unavailable datasets',
	'confirm-delete-dialog.cdr-summary.title_one':
		'{{documentCount}} in another dataset',
	'confirm-delete-dialog.cdr-summary.title_other':
		'{{documentCount}} in {{count}} datasets',
	...
	'confirm-delete-dialog.cdr-table.id-copied-toast.title-failed':
		'Failed to copy document ID',
	'confirm-delete-dialog.cdr-table.project-id.label': 'Project ID',
	'confirm-delete-dialog.confirm-anyway-button.text_delete':
		'Delete all versions anyway',
	...
	'confirm-delete-dialog.other-reference-count.title_one':
		'1 other reference not show',
	'confirm-delete-dialog.other-reference-count.title_other':
		'{{count}} other references not shown',
	'confirm-delete-dialog.other-reference-count.tooltip':
		"We can't display metadata for these references due to a missing access token for the related datasets.",
	'confirm-delete-dialog.preview-item.preview-unavailable.subtitle':
		'ID: {{documentId}}',
	...
	'events.inspect.release':
		'Inspect <VersionBadge>{{releaseTitle}}</VersionBadge> document',
	'events.open.draft': 'Open <VersionBadge>draft</VersionBadge> document',
	'events.open.release':
		'Open <VersionBadge>{{releaseTitle}}</VersionBadge> release',
	...
	'pane-item.missing-schema-type.subtitle':
		'Document: <Code>{{documentId}}</Code>',
	'pane-item.missing-schema-type.title':
		'No schema found for type <Code>{{documentType}}</Code>',
	'pane-item.published-status.has-published.tooltip':
	...
	'panes.document-list-pane.error.text':
	...
	'panes.document-list-pane.max-items.text':
		'Displaying a maximum of {{limit}} documents',
